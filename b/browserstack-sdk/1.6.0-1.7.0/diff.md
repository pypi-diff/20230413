# Comparing `tmp/browserstack_sdk-1.6.0.tar.gz` & `tmp/browserstack_sdk-1.7.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "browserstack_sdk-1.6.0.tar", last modified: Tue Mar 14 13:00:16 2023, max compression
+gzip compressed data, was "browserstack_sdk-1.7.0.tar", last modified: Thu Apr 13 08:50:39 2023, max compression
```

## Comparing `browserstack_sdk-1.6.0.tar` & `browserstack_sdk-1.7.0.tar`

### file list

```diff
@@ -1,20 +1,20 @@
-drwxr-xr-x   0 francis    (503) wheel        (0)        0 2023-03-14 13:00:16.502250 browserstack_sdk-1.6.0/
--rw-r--r--   0 francis    (503) wheel        (0)     4335 2023-03-14 12:59:10.000000 browserstack_sdk-1.6.0/LICENSE.txt
--rw-r--r--   0 francis    (503) wheel        (0)     5046 2023-03-14 13:00:16.502135 browserstack_sdk-1.6.0/PKG-INFO
--rw-r--r--   0 francis    (503) wheel        (0)      815 2023-03-14 12:59:10.000000 browserstack_sdk-1.6.0/README.md
-drwxr-xr-x   0 francis    (503) wheel        (0)        0 2023-03-14 13:00:16.501255 browserstack_sdk-1.6.0/browserstack_sdk/
--rw-r--r--   0 francis    (503) wheel        (0)   177245 2023-03-14 12:59:10.000000 browserstack_sdk-1.6.0/browserstack_sdk/__init__.py
--rw-r--r--   0 francis    (503) wheel        (0)       22 2023-03-14 12:59:10.000000 browserstack_sdk-1.6.0/browserstack_sdk/_version.py
--rw-r--r--   0 francis    (503) wheel        (0)     3891 2023-03-14 12:59:10.000000 browserstack_sdk-1.6.0/browserstack_sdk/browserstack.framework.yml.sample
--rw-r--r--   0 francis    (503) wheel        (0)     3125 2023-03-14 12:59:10.000000 browserstack_sdk-1.6.0/browserstack_sdk/browserstack.generic.yml.sample
-drwxr-xr-x   0 francis    (503) wheel        (0)        0 2023-03-14 13:00:16.501858 browserstack_sdk-1.6.0/browserstack_sdk.egg-info/
--rw-r--r--   0 francis    (503) wheel        (0)     5046 2023-03-14 13:00:16.000000 browserstack_sdk-1.6.0/browserstack_sdk.egg-info/PKG-INFO
--rw-r--r--   0 francis    (503) wheel        (0)      466 2023-03-14 13:00:16.000000 browserstack_sdk-1.6.0/browserstack_sdk.egg-info/SOURCES.txt
--rw-r--r--   0 francis    (503) wheel        (0)        1 2023-03-14 13:00:16.000000 browserstack_sdk-1.6.0/browserstack_sdk.egg-info/dependency_links.txt
--rw-r--r--   0 francis    (503) wheel        (0)      139 2023-03-14 13:00:16.000000 browserstack_sdk-1.6.0/browserstack_sdk.egg-info/entry_points.txt
--rw-r--r--   0 francis    (503) wheel        (0)       70 2023-03-14 13:00:16.000000 browserstack_sdk-1.6.0/browserstack_sdk.egg-info/requires.txt
--rw-r--r--   0 francis    (503) wheel        (0)       43 2023-03-14 13:00:16.000000 browserstack_sdk-1.6.0/browserstack_sdk.egg-info/top_level.txt
-drwxr-xr-x   0 francis    (503) wheel        (0)        0 2023-03-14 13:00:16.501966 browserstack_sdk-1.6.0/pytest_browserstackplugin/
--rw-r--r--   0 francis    (503) wheel        (0)    10898 2023-03-14 12:59:10.000000 browserstack_sdk-1.6.0/pytest_browserstackplugin/plugin.py
--rw-r--r--   0 francis    (503) wheel        (0)       38 2023-03-14 13:00:16.502281 browserstack_sdk-1.6.0/setup.cfg
--rw-r--r--   0 francis    (503) wheel        (0)     1343 2023-03-14 12:59:10.000000 browserstack_sdk-1.6.0/setup.py
...
### Comparing `browserstack_sdk-1.6.0/LICENSE.txt` & `browserstack_sdk-1.7.0/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `browserstack_sdk-1.6.0/PKG-INFO` & `browserstack_sdk-1.7.0/PKG-INFO`
...
### Comparing `browserstack_sdk-1.6.0/README.md` & `browserstack_sdk-1.7.0/README.md`

 * *Files identical despite different names*

### Comparing `browserstack_sdk-1.6.0/browserstack_sdk/__init__.py` & `browserstack_sdk-1.7.0/browserstack_sdk/__init__.py`
...
-bstack111_opy_ = 2048
-bstack1_opy_ = 7
-def bstack1l1l_opy_ (bstack1l_opy_):
-    global bstack1ll_opy_
-    stringNr = ord (bstack1l_opy_ [-1])
-    bstackl_opy_ = bstack1l_opy_ [:-1]
-    bstack1lll_opy_ = stringNr % len (bstackl_opy_)
-    bstack1ll1_opy_ = bstackl_opy_ [:bstack1lll_opy_] + bstackl_opy_ [bstack1lll_opy_:]
...
+    bstack1ll1_opy_ = bstack1ll_opy_ [:bstack11_opy_] + bstack1ll_opy_ [bstack11_opy_:]
     if bstack11l_opy_:
-        bstack11_opy_ = unicode () .join ([unichr (ord (char) - bstack111_opy_ - (bstack1l1_opy_ + stringNr) % bstack1_opy_) for bstack1l1_opy_, char in enumerate (bstack1ll1_opy_)])
...
-        bstack11_opy_ = str () .join ([chr (ord (char) - bstack111_opy_ - (bstack1l1_opy_ + stringNr) % bstack1_opy_) for bstack1l1_opy_, char in enumerate (bstack1ll1_opy_)])
...
-  bstack1l1l_opy_ (u"ࠧࡶࡲ࡯ࡳࡦࡪࡍࡦࡦ࡬ࡥࠬࢫ"),
-  bstack1l1l_opy_ (u"ࠨࡷࡶࡩࡷࡔࡡ࡮ࡧࠪࢬ"),
-  bstack1l1l_opy_ (u"ࠩࡤࡧࡨ࡫ࡳࡴࡍࡨࡽࠬࢭ"),
-  bstack1l1l_opy_ (u"ࠪࡷࡪࡹࡳࡪࡱࡱࡒࡦࡳࡥࠨࢮ"),
-  bstack1l1l_opy_ (u"ࠫࡹ࡫ࡳࡵࡒࡵ࡭ࡴࡸࡩࡵࡻࠪࢯ"),
-  bstack1l1l_opy_ (u"ࠬࡨࡵࡪ࡮ࡧࡒࡦࡳࡥࠨࢰ"),
-  bstack1l1l_opy_ (u"࠭ࡢࡶ࡫࡯ࡨ࡙ࡧࡧࠨࢱ"),
-  bstack1l1l_opy_ (u"ࠧࡱࡴࡲ࡮ࡪࡩࡴࡏࡣࡰࡩࠬࢲ"),
-  bstack1l1l_opy_ (u"ࠨࡵࡨࡰࡪࡴࡩࡶ࡯࡙ࡩࡷࡹࡩࡰࡰࠪࢳ"),
-  bstack1l1l_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴ�
-  bstack1l1l_opy_ (u"ࠨ࡮ࡲ࡫࡫࡯࡬ࡦࠩि"): bstack1l1l_opy_ (u"ࠩ࡯ࡳ࡬࡬ࡩ࡭ࡧࠪी"),
-  bstack1l1l_opy_ (u"ࠪࡰࡴࡩࡡ࡭࡫ࡧࡩࡳࡺࡩࡧ࡫ࡨࡶࠬु"): bstack1l1l_opy_ (u"ࠫࡱࡵࡣࡢ࡮ࡌࡨࡪࡴࡴࡪࡨ࡬ࡩࡷ࠭ू"),
+bstack11111111_opy_ = {
...
-bstack1ll111l_opy_ = bstack1l1l_opy_ (u"ࠬ࡮ࡴࡵࡲࡶ࠾࠴࠵ࡨࡶࡤ࠱ࡦࡷࡵࡷࡴࡧࡵࡷࡹࡧࡣ࡬࠰ࡦࡳࡲ࠵ࡷࡥ࠱࡫ࡹࡧ࠭ृ")
-bstack11llll_opy_ = bstack1l1l_opy_ (u"࠭ࡨࡵࡶࡳ࠾࠴࠵ࡨࡶࡤ࠱ࡦࡷࡵࡷࡴࡧࡵࡷࡹࡧࡣ࡬࠰ࡦࡳࡲࡀ࠸࠱࠱ࡺࡨ࠴࡮ࡵࡣࠩॄ")
-bstack1ll1ll1ll_opy_ = {
-  bstack1l1l_opy_ (u"ࠧࡤࡴ࡬ࡸ࡮ࡩࡡ࡭ࠩॅ"): 50,
-  bstack1l1l_opy_ (u"ࠨࡧࡵࡶࡴࡸࠧॆ"): 40,
-  bstack1l1l_opy_ (u"ࠩࡺࡥࡷࡴࡩ࡯ࡩࠪे"): 30,
-  bstack1l1l_opy_ (u"ࠪ࡭ࡳ࡬࡯ࠨै"): 20,
-  bstack1l1l_opy_ (u"ࠫࡩ࡫ࡢࡶࡩࠪॉ"): 10
...
-DEFAULT_LOG_LEVEL = bstack1ll1ll1ll_opy_[bstack1l1l_opy_ (u"ࠬ࡯࡮ࡧࡱࠪॊ")]
-bstack111lll1_opy_ = bstack1l1l_opy_ (u"࠭ࡰࡺࡶ࡫ࡳࡳ࠳ࡰࡺࡶ࡫ࡳࡳࡧࡧࡦࡰࡷ࠳ࠬो")
-bstack11l1lll_opy_ = bstack1l1l_opy_ (u"ࠧࡳࡱࡥࡳࡹ࠳ࡰࡺࡶ࡫ࡳࡳࡧࡧࡦࡰࡷ࠳ࠬौ")
-bstack11lll1_opy_ = bstack1l1l_opy_ (u"ࠨࡤࡨ࡬ࡦࡼࡥ࠮ࡲࡼࡸ࡭ࡵ࡮ࡢࡩࡨࡲࡹ࠵्ࠧ")
-bstack11111l11_opy_ = bstack1l1l_opy_ (u"ࠩࡳࡽࡹ࡫ࡳࡵ࠯ࡳࡽࡹ࡮࡯࡯ࡣࡪࡩࡳࡺ࠯ࠨॎ")
-bstack1llll_opy_ = [bstack1l1l_opy_ (u"ࠪࡆࡗࡕࡗࡔࡇࡕࡗ࡙ࡇࡃࡌࡡࡘࡗࡊࡘࡎࡂࡏࡈࠫॏ"), bstack1l1l_opy_ (u"ࠫ࡞ࡕࡕࡓࡡࡘࡗࡊࡘࡎࡂࡏࡈࠫॐ")]
-  bstack1l1l_opy_ (u"ࠧ࡮ࡱࡽ࠾࡫࡯ࡲࡦࡨࡲࡼࡔࡶࡴࡪࡱࡱࡷࠬ৻"),
-  bstack1l1l_opy_ (u"ࠨ࡯ࡶ࠾ࡪࡪࡧࡦࡑࡳࡸ࡮ࡵ࡮ࡴࠩৼ"),
-  bstack1l1l_opy_ (u"ࠩࡶࡩ࠿࡯ࡥࡐࡲࡷ࡭ࡴࡴࡳࠨ৽"),
-  bstack1l1l_opy_ (u"ࠪࡷࡦ࡬ࡡࡳ࡫࠱ࡳࡵࡺࡩࡰࡰࡶࠫ৾"),
...
-bstack1lll11lll_opy_ = bstack111111l1_opy_ + bstack1lll1l11l_opy_ + bstack1lll1l11_opy_
-bstack1lllllll_opy_ = [
-  bstack1l1l_opy_ (u"ࠫࡣࡲ࡯ࡤࡣ࡯࡬ࡴࡹࡴࠥࠩ৿"),
-  bstack1l1l_opy_ (u"ࠬࡤࡢࡴ࠯࡯ࡳࡨࡧ࡬࠯ࡥࡲࡱࠩ࠭਀"),
-  bstack1l1l_opy_ (u"࠭࡞࠲࠴࠺࠲ࠬਁ"),
-  bstack1l1l_opy_ (u"ࠧ࡟࠳࠳࠲ࠬਂ"),
-  bstack1l1l_opy_ (u"ࠨࡠ࠴࠻࠷࠴࠱࡜࠸࠰࠽ࡢ࠴ࠧਃ"),
-  bstack1l1l_opy_ (u"ࠩࡡ࠵࠼࠸࠮࠳࡝࠳࠱࠾ࡣ࠮ࠨ਄"),
-  bstack1l1l_opy_ (u"ࠪࡢ࠶࠽࠲࠯࠵࡞࠴࠲࠷࡝࠯ࠩਅ"),
-  bstack1l1l_opy_ (u"ࠫࡣ࠷࠹࠳࠰࠴࠺࠽࠴ࠧਆ")
...
-bstack1ll1111_opy_ = bstack1l1l_opy_ (u"ࠬ࡮ࡴࡵࡲࡶ࠾࠴࠵ࡡࡱ࡫࠱ࡦࡷࡵࡷࡴࡧࡵࡷࡹࡧࡣ࡬࠰ࡦࡳࡲ࠵ࡻࡾࠩਇ")
-bstack1l1l1l1l_opy_ = bstack1l1l_opy_ (u"࠭ࡳࡥ࡭࠲ࡺ࠶࠵ࡥࡷࡧࡱࡸࠬਈ")
-bstack1l111ll1_opy_ = [ bstack1l1l_opy_ (u"ࠧࡢࡷࡷࡳࡲࡧࡴࡦࠩਉ") ]
-bstack1l1l111_opy_ = [ bstack1l1l_opy_ (u"ࠨࡣࡳࡴ࠲ࡧࡵࡵࡱࡰࡥࡹ࡫ࠧਊ") ]
-bstack1l11ll_opy_ = [ bstack1l1l_opy_ (u"ࠩࡲࡦࡸ࡫ࡲࡷࡣࡥ࡭ࡱ࡯ࡴࡺࠩ਋") ]
-bstack1ll1111l1_opy_ = bstack1l1l_opy_ (u"ࠪࡗࡉࡑࡓࡦࡶࡸࡴࠬ਌")
-bstack111l1l1_opy_ = bstack1l1l_opy_ (u"ࠫࡘࡊࡋࡕࡧࡶࡸࡆࡺࡴࡦ࡯ࡳࡸࡪࡪࠧ਍")
-bstack1l11ll1l_opy_ = bstack1l1l_opy_ (u"࡙ࠬࡄࡌࡖࡨࡷࡹ࡙ࡵࡤࡥࡨࡷࡸ࡬ࡵ࡭ࠩ਎")
��ࡲࡴࡧࠫࡦࡸࡺࡡࡤ࡭ࡢࡧࡦࡶࡳࠪ࡞ࡱࠤࠥࢃࠠࡤࡣࡷࡧ࡭࠮ࡥࡹࠫࠣࡿࡡࡴࠠࠡࠢࠣࢁࡡࡴࠠࠡࡴࡨࡸࡺࡸ࡮ࠡࡣࡺࡥ࡮ࡺࠠࡪ࡯ࡳࡳࡷࡺ࡟ࡱ࡮ࡤࡽࡼࡸࡩࡨࡪࡷ࠸ࡤࡨࡳࡵࡣࡦ࡯࠳ࡩࡨࡳࡱࡰ࡭ࡺࡳ࠮ࡤࡱࡱࡲࡪࡩࡴࠩࡽ࡟ࡲࠥࠦࠠࠡࡹࡶࡉࡳࡪࡰࡰ࡫ࡱࡸ࠿ࠦࡠࡸࡵࡶ࠾࠴࠵ࡣࡥࡲ࠱ࡦࡷࡵࡷࡴࡧࡵࡷࡹࡧࡣ࡬࠰ࡦࡳࡲ࠵ࡰ࡭ࡣࡼࡻࡷ࡯ࡧࡩࡶࡂࡧࡦࡶࡳ࠾ࠦࡾࡩࡳࡩ࡯ࡥࡧࡘࡖࡎࡉ࡯࡮ࡲࡲࡲࡪࡴࡴࠩࡌࡖࡓࡓ࠴ࡳࡵࡴ࡬ࡲ࡬࡯ࡦࡺࠪࡦࡥࡵࡹࠩࠪࡿࡣ࠰ࡡࡴࠠࠡࠢࠣ࠲࠳࠴࡬ࡢࡷࡱࡧ࡭ࡕࡰࡵ࡫ࡲࡲࡸࡢ࡮ࠡࠢࢀ࠭ࡡࡴࡽ࡝ࡰ࠲࠮ࠥࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾࠿ࡀࡁࡂࡃ࠽࠾ࠢ࠭࠳ࡡࡴࠧ੉")
...
-bstack11llll1_opy_ = {}
-bstack1l1l1111l_opy_ = {}
-bstack1lll11_opy_ = None
-bstack11l1l1ll_opy_ = None
-bstack1l1lll1l1_opy_ = None
-bstack11lll_opy_ = -1
-bstack1lll1_opy_ = DEFAULT_LOG_LEVEL
-bstack1llllll11_opy_ = 1
-bstack11l1l1l1_opy_ = False
-bstack1l1ll1l1_opy_ = bstack1l1l_opy_ (u"ࠩࠪ੊")
-bstack1111llll_opy_ = bstack1l1l_opy_ (u"ࠪࠫੋ")
-bstack111l1lll_opy_ = False
-bstack1llll11ll_opy_ = True
-bstack1l1ll1ll_opy_ = bstack1l1l_opy_ (u"ࠫࠬੌ")
...
-bstack11l111l_opy_ = bstack1l1l_opy_ (u"ࠧࠨ੍")
+bstack1ll1lll_opy_ = {}
+bstack1l1l111_opy_ = {}
...
-logging.basicConfig(level=bstack1lll1_opy_,
...
-  if bstack1l1l_opy_ (u"ࠨ࡮ࡲ࡫ࡑ࡫ࡶࡦ࡮ࠪ੐") in CONFIG:
-    bstack1lll1_opy_ = bstack1ll1ll1ll_opy_[CONFIG[bstack1l1l_opy_ (u"ࠩ࡯ࡳ࡬ࡒࡥࡷࡧ࡯ࠫੑ")]]
-    logging.getLogger().setLevel(bstack1lll1_opy_)
...
-def bstack1l1ll11_opy_():
+def bstack11l111l_opy_():
   from selenium import webdriver
   return version.parse(webdriver.__version__)
-def bstack1l11l1l_opy_():
+def bstack11ll11l_opy_():
   args = sys.argv
   for i in range(len(args)):
-    if bstack1l1l_opy_ (u"ࠥ࠱࠲ࡨࡲࡰࡹࡶࡩࡷࡹࡴࡢࡥ࡮ࡧࡴࡴࡦࡪࡩࡩ࡭ࡱ࡫ࠢ੒") == args[i].lower() or bstack1l1l_opy_ (u"ࠦ࠲࠳ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯࠳ࡩ࡯࡯ࡨ࡬࡫ࠧ੓") == args[i].lower():
...
-      bstack1l1ll1ll_opy_ += bstack1l1l_opy_ (u"ࠬ࠳࠭ࡣࡴࡲࡻࡸ࡫ࡲࡴࡶࡤࡧࡰࡉ࡯࡯ࡨ࡬࡫ࡋ࡯࡬ࡦࠢࠪ੔") + path
+      global bstack1ll1l1111_opy_
+      bstack1ll1l1111_opy_ += bstack111_opy_ (u"ࠬ࠳࠭ࡣࡴࡲࡻࡸ࡫ࡲࡴࡶࡤࡧࡰࡉ࡯࡯ࡨ࡬࡫ࡋ࡯࡬ࡦࠢࠪ੔") + path
       return path
   return None
-def bstack11l1ll1l_opy_():
-  bstack1l11ll1_opy_ = bstack1l11l1l_opy_()
-  if bstack1l11ll1_opy_ and os.path.exists(os.path.abspath(bstack1l11ll1_opy_)):
-    fileName = bstack1l11ll1_opy_
-  if bstack1l1l_opy_ (u"࠭ࡂࡓࡑ࡚ࡗࡊࡘࡓࡕࡃࡆࡏࡤࡉࡏࡏࡈࡌࡋࡤࡌࡉࡍࡇࠪ੕") in os.environ and os.path.exists(os.path.abspath(os.environ[bstack1l1l_opy_ (u"ࠧࡃࡔࡒ࡛ࡘࡋࡒࡔࡖࡄࡇࡐࡥࡃࡐࡐࡉࡍࡌࡥࡆࡊࡎࡈࠫ੖")])) and not bstack1l1l_opy_ (u"ࠨࡨ࡬ࡰࡪࡔࡡ࡮ࡧࠪ੗") in locals():
-    fileName = os.environ[bstack1l1l_opy_ (u"ࠩࡅࡖࡔ࡝ࡓࡆࡔࡖࡘࡆࡉࡋࡠࡅࡒࡒࡋࡏࡇࡠࡈࡌࡐࡊ࠭੘")]
-  if bstack1l1l_opy_ (u"ࠪࡪ࡮ࡲࡥࡏࡣࡰࡩࠬਖ਼") in locals():
-    bstack111ll1l1_opy_ = os.path.abspath(fileName)
...
-    bstack111ll1l1_opy_ = bstack1l1l_opy_ (u"ࠫࠬਗ਼")
-  bstack1l1ll1_opy_ = os.getcwd()
-  bstack1l1l1l_opy_ = bstack1l1l_opy_ (u"ࠬࡨࡲࡰࡹࡶࡩࡷࡹࡴࡢࡥ࡮࠲ࡾࡳ࡬ࠨਜ਼")
-  bstack1l1ll11l1_opy_ = bstack1l1l_opy_ (u"࠭ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯࠳ࡿࡡ࡮࡮ࠪੜ")
-  while (not os.path.exists(bstack111ll1l1_opy_)) and bstack1l1ll1_opy_ != bstack1l1l_opy_ (u"ࠢࠣ੝"):
-    bstack111ll1l1_opy_ = os.path.join(bstack1l1ll1_opy_, bstack1l1l1l_opy_)
-    if not os.path.exists(bstack111ll1l1_opy_):
-      bstack111ll1l1_opy_ = os.path.join(bstack1l1ll1_opy_, bstack1l1ll11l1_opy_)
-    if bstack1l1ll1_opy_ != os.path.dirname(bstack1l1ll1_opy_):
-      bstack1l1ll1_opy_ = os.path.dirname(bstack1l1ll1_opy_)
...
-      bstack1l1ll1_opy_ = bstack1l1l_opy_ (u"ࠣࠤਫ਼")
-  if not os.path.exists(bstack111ll1l1_opy_):
-    bstack1llll1_opy_(
-      bstack1llll1ll_opy_.format(os.getcwd()))
-  with open(bstack111ll1l1_opy_, bstack1l1l_opy_ (u"ࠩࡵࠫ੟")) as stream:
...
-      bstack1llll1_opy_(bstack1l1l11l_opy_.format(str(exc)))
-def bstack11111_opy_(config):
-  bstack111l11ll_opy_ = bstack1llll1l_opy_(config)
-  for option in list(bstack111l11ll_opy_):
-    if option.lower() in bstack11l1_opy_ and option != bstack11l1_opy_[option.lower()]:
-      bstack111l11ll_opy_[bstack11l1_opy_[option.lower()]] = bstack111l11ll_opy_[option]
-      del bstack111l11ll_opy_[option]
...
-  for key, bstack1lll1111l_opy_ in bstack1l1l1l1l1_opy_.items():
-    if isinstance(bstack1lll1111l_opy_, list):
-      for var in bstack1lll1111l_opy_:
...
+          bstack1l1l111_opy_[key] = os.environ[var]
           break
-    elif bstack1lll1111l_opy_ in os.environ:
-      bstack1l1l1111l_opy_[key] = os.environ[bstack1lll1111l_opy_]
-  if bstack1l1l_opy_ (u"ࠪࡆࡗࡕࡗࡔࡇࡕࡗ࡙ࡇࡃࡌࡡࡏࡓࡈࡇࡌࡠࡋࡇࡉࡓ࡚ࡉࡇࡋࡈࡖࠬ੠") in os.environ:
-    bstack1l1l1111l_opy_[bstack1l1l_opy_ (u"ࠫࡧࡸ࡯ࡸࡵࡨࡶࡘࡺࡡࡤ࡭ࡏࡳࡨࡧ࡬ࡐࡲࡷ࡭ࡴࡴࡳࠨ੡")] = {}
-    bstack1l1l1111l_opy_[bstack1l1l_opy_ (u"ࠬࡨࡲࡰࡹࡶࡩࡷ࡙ࡴࡢࡥ࡮ࡐࡴࡩࡡ࡭ࡑࡳࡸ࡮ࡵ࡮ࡴࠩ੢")][bstack1l1l_opy_ (u"࠭࡬ࡰࡥࡤࡰࡎࡪࡥ࡯ࡶ࡬ࡪ࡮࡫ࡲࠨ੣")] = os.environ[bstack1l1l_opy_ (u"ࠧࡃࡔࡒ࡛ࡘࡋࡒࡔࡖࡄࡇࡐࡥࡌࡐࡅࡄࡐࡤࡏࡄࡆࡐࡗࡍࡋࡏࡅࡓࠩ੤")]
...
-    if idx<len(sys.argv) and bstack1l1l_opy_ (u"ࠨ࠯࠰ࡦࡷࡵࡷࡴࡧࡵࡷࡹࡧࡣ࡬࠰࡯ࡳࡨࡧ࡬ࡊࡦࡨࡲࡹ࡯ࡦࡪࡧࡵࠫ੥").lower() == val.lower():
-      bstack11llll1_opy_[bstack1l1l_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡖࡸࡦࡩ࡫ࡍࡱࡦࡥࡱࡕࡰࡵ࡫ࡲࡲࡸ࠭੦")] = {}
-      bstack11llll1_opy_[bstack1l1l_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵࡗࡹࡧࡣ࡬ࡎࡲࡧࡦࡲࡏࡱࡶ࡬ࡳࡳࡹࠧ੧")][bstack1l1l_opy_ (u"ࠫࡱࡵࡣࡢ࡮ࡌࡨࡪࡴࡴࡪࡨ࡬ࡩࡷ࠭੨")] = sys.argv[idx+1]
...
+      bstack1ll1lll_opy_[bstack111_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵࡗࡹࡧࡣ࡬ࡎࡲࡧࡦࡲࡏࡱࡶ࡬ࡳࡳࡹࠧ੧")][bstack111_opy_ (u"ࠫࡱࡵࡣࡢ࡮ࡌࡨࡪࡴࡴࡪࡨ࡬ࡩࡷ࠭੨")] = sys.argv[idx+1]
       ...
       break
-  for key, bstack1ll111lll_opy_ in bstack1l1ll1l_opy_.items():
-    if isinstance(bstack1ll111lll_opy_, list):
+  for key, bstack1l1l11ll1_opy_ in bstack1l1llllll_opy_.items():
+    if isinstance(bstack1l1l11ll1_opy_, list):
       for idx, val in enumerate(sys.argv):
-        for var in bstack1ll111lll_opy_:
-          if idx<len(sys.argv) and bstack1l1l_opy_ (u"ࠬ࠳࠭ࠨ੩") + var.lower() == val.lower() and not key in bstack11llll1_opy_:
-            bstack11llll1_opy_[key] = sys.argv[idx+1]
-            bstack1l1ll1ll_opy_ += bstack1l1l_opy_ (u"࠭ࠠ࠮࠯ࠪ੪") + var + bstack1l1l_opy_ (u"ࠧࠡࠩ੫") + sys.argv[idx+1]
...
+            bstack1ll1l1111_opy_ += bstack111_opy_ (u"࠭ࠠ࠮࠯ࠪ੪") + var + bstack111_opy_ (u"ࠧࠡࠩ੫") + sys.argv[idx+1]
       ...
       for idx, val in enumerate(sys.argv):
-        if idx<len(sys.argv) and bstack1l1l_opy_ (u"ࠨ࠯࠰ࠫ੬") + bstack1ll111lll_opy_.lower() == val.lower() and not key in bstack11llll1_opy_:
-          bstack11llll1_opy_[key] = sys.argv[idx+1]
-          bstack1l1ll1ll_opy_ += bstack1l1l_opy_ (u"ࠩࠣ࠱࠲࠭੭") + bstack1ll111lll_opy_ + bstack1l1l_opy_ (u"ࠪࠤࠬ੮") + sys.argv[idx+1]
...
-  bstack1llllll1l_opy_ = config.keys()
-  for bstack1lll11ll_opy_, bstack111ll11_opy_ in bstack1ll1111l_opy_.items():
-    if bstack111ll11_opy_ in bstack1llllll1l_opy_:
-      config[bstack1lll11ll_opy_] = config[bstack111ll11_opy_]
...
-  for bstack1lll11ll_opy_, bstack111ll11_opy_ in bstack1lllll1_opy_.items():
+  for bstack111111l_opy_, bstack111ll11_opy_ in bstack1lll1111_opy_.items():
     if isinstance(bstack111ll11_opy_, list):
-      for bstack11111ll1_opy_ in bstack111ll11_opy_:
-        if bstack11111ll1_opy_ in bstack1llllll1l_opy_:
-          config[bstack1lll11ll_opy_] = config[bstack11111ll1_opy_]
-          del config[bstack11111ll1_opy_]
...
+          del config[bstack111l11_opy_]
           break
-    elif bstack111ll11_opy_ in bstack1llllll1l_opy_:
-        config[bstack1lll11ll_opy_] = config[bstack111ll11_opy_]
+    elif bstack111ll11_opy_ in bstack1l1lllll_opy_:
+        config[bstack111111l_opy_] = config[bstack111ll11_opy_]
         del config[bstack111ll11_opy_]
-  for bstack11111ll1_opy_ in list(config):
-    for bstack1lll1lll1_opy_ in bstack1lll11lll_opy_:
-      if bstack11111ll1_opy_.lower() == bstack1lll1lll1_opy_.lower() and bstack11111ll1_opy_ != bstack1lll1lll1_opy_:
-        config[bstack1lll1lll1_opy_] = config[bstack11111ll1_opy_]
-        del config[bstack11111ll1_opy_]
-  bstack1111lll_opy_ = []
-  if bstack1l1l_opy_ (u"ࠫࡵࡲࡡࡵࡨࡲࡶࡲࡹࠧ੯") in config:
-    bstack1111lll_opy_ = config[bstack1l1l_opy_ (u"ࠬࡶ࡬ࡢࡶࡩࡳࡷࡳࡳࠨੰ")]
-  for platform in bstack1111lll_opy_:
-    for bstack11111ll1_opy_ in list(platform):
-      for bstack1lll1lll1_opy_ in bstack1lll11lll_opy_:
-        if bstack11111ll1_opy_.lower() == bstack1lll1lll1_opy_.lower() and bstack11111ll1_opy_ != bstack1lll1lll1_opy_:
-          platform[bstack1lll1lll1_opy_] = platform[bstack11111ll1_opy_]
-          del platform[bstack11111ll1_opy_]
-  for bstack1lll11ll_opy_, bstack111ll11_opy_ in bstack1lllll1_opy_.items():
-    for platform in bstack1111lll_opy_:
...
+    for platform in bstack1111l1l1_opy_:
       if isinstance(bstack111ll11_opy_, list):
-        for bstack11111ll1_opy_ in bstack111ll11_opy_:
-          if bstack11111ll1_opy_ in platform:
-            platform[bstack1lll11ll_opy_] = platform[bstack11111ll1_opy_]
-            del platform[bstack11111ll1_opy_]
+        for bstack111l11_opy_ in bstack111ll11_opy_:
...
-        platform[bstack1lll11ll_opy_] = platform[bstack111ll11_opy_]
+        platform[bstack111111l_opy_] = platform[bstack111ll11_opy_]
         del platform[bstack111ll11_opy_]
-  for bstack11l1111_opy_ in bstack1111l11_opy_:
-    if bstack11l1111_opy_ in config:
-      if not bstack1111l11_opy_[bstack11l1111_opy_] in config:
-        config[bstack1111l11_opy_[bstack11l1111_opy_]] = {}
-      config[bstack1111l11_opy_[bstack11l1111_opy_]].update(config[bstack11l1111_opy_])
-      del config[bstack11l1111_opy_]
-  for platform in bstack1111lll_opy_:
-    for bstack11l1111_opy_ in bstack1111l11_opy_:
-      if bstack11l1111_opy_ in list(platform):
-        if not bstack1111l11_opy_[bstack11l1111_opy_] in platform:
-          platform[bstack1111l11_opy_[bstack11l1111_opy_]] = {}
-        platform[bstack1111l11_opy_[bstack11l1111_opy_]].update(platform[bstack11l1111_opy_])
-        del platform[bstack11l1111_opy_]
-  config = bstack11111_opy_(config)
...
-  if bstack1l1l_opy_ (u"࠭ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯ࡑࡵࡣࡢ࡮ࠪੱ") in config and str(config[bstack1l1l_opy_ (u"ࠧࡣࡴࡲࡻࡸ࡫ࡲࡴࡶࡤࡧࡰࡒ࡯ࡤࡣ࡯ࠫੲ")]).lower() != bstack1l1l_opy_ (u"ࠨࡨࡤࡰࡸ࡫ࠧੳ"):
-    if not bstack1l1l_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡖࡸࡦࡩ࡫ࡍࡱࡦࡥࡱࡕࡰࡵ࡫ࡲࡲࡸ࠭ੴ") in config:
-      config[bstack1l1l_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵࡗࡹࡧࡣ࡬ࡎࡲࡧࡦࡲࡏࡱࡶ࡬ࡳࡳࡹࠧੵ")] = {}
...
-      bstack1lllll1ll_opy_ = current_time.strftime(bstack1l1l_opy_ (u"࠭ࠥࡥࡡࠨࡦࡤࠫࡈࠦࡏࠪ੸"))
+      bstack11lll111_opy_ = current_time.strftime(bstack111_opy_ (u"࠭ࠥࡥࡡࠨࡦࡤࠫࡈࠦࡏࠪ੸"))
       hostname = socket.gethostname()
-      bstack1ll11llll_opy_ = bstack1l1l_opy_ (u"ࠧࠨ੹").join(random.choices(string.ascii_lowercase + string.digits, k=4))
-      identifier = bstack1l1l_opy_ (u"ࠨࡽࢀࡣࢀࢃ࡟ࡼࡿࠪ੺").format(bstack1lllll1ll_opy_, hostname, bstack1ll11llll_opy_)
-      config[bstack1l1l_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡖࡸࡦࡩ࡫ࡍࡱࡦࡥࡱࡕࡰࡵ࡫ࡲࡲࡸ࠭੻")][bstack1l1l_opy_ (u"ࠪࡰࡴࡩࡡ࡭ࡋࡧࡩࡳࡺࡩࡧ࡫ࡨࡶࠬ੼")] = identifier
-    bstack1111llll_opy_ = config[bstack1l1l_opy_ (u"ࠫࡧࡸ࡯ࡸࡵࡨࡶࡘࡺࡡࡤ࡭ࡏࡳࡨࡧ࡬ࡐࡲࡷ࡭ࡴࡴࡳࠨ੽")][bstack1l1l_opy_ (u"ࠬࡲ࡯ࡤࡣ࡯ࡍࡩ࡫࡮ࡵ࡫ࡩ࡭ࡪࡸࠧ੾")]
...
+def bstack11l1l111_opy_():
   if (
-    isinstance(os.getenv(bstack1l1l_opy_ (u"࠭ࡊࡆࡐࡎࡍࡓ࡙࡟ࡖࡔࡏࠫ੿")), str) and len(os.getenv(bstack1l1l_opy_ (u"ࠧࡋࡇࡑࡏࡎࡔࡓࡠࡗࡕࡐࠬ઀"))) > 0
+    isinstance(os.getenv(bstack111_opy_ (u"࠭ࡊࡆࡐࡎࡍࡓ࡙࡟ࡖࡔࡏࠫ੿")), str) and len(os.getenv(bstack111_opy_ (u"ࠧࡋࡇࡑࡏࡎࡔࡓࡠࡗࡕࡐࠬ઀"))) > 0
   ) or (
-    isinstance(os.getenv(bstack1l1l_opy_ (u"ࠨࡌࡈࡒࡐࡏࡎࡔࡡࡋࡓࡒࡋࠧઁ")), str) and len(os.getenv(bstack1l1l_opy_ (u"ࠩࡍࡉࡓࡑࡉࡏࡕࡢࡌࡔࡓࡅࠨં"))) > 0
+    isinstance(os.getenv(bstack111_opy_ (u"ࠨࡌࡈࡒࡐࡏࡎࡔࡡࡋࡓࡒࡋࠧઁ")), str) and len(os.getenv(bstack111_opy_ (u"ࠩࡍࡉࡓࡑࡉࡏࡕࡢࡌࡔࡓࡅࠨં"))) > 0
   ):
-    return os.getenv(bstack1l1l_opy_ (u"ࠪࡆ࡚ࡏࡌࡅࡡࡑ࡙ࡒࡈࡅࡓࠩઃ"), 0)
-  if str(os.getenv(bstack1l1l_opy_ (u"ࠫࡈࡏࠧ઄"))).lower() == bstack1l1l_opy_ (u"ࠬࡺࡲࡶࡧࠪઅ") and str(os.getenv(bstack1l1l_opy_ (u"࠭ࡃࡊࡔࡆࡐࡊࡉࡉࠨઆ"))).lower() == bstack1l1l_opy_ (u"ࠧࡵࡴࡸࡩࠬઇ"):
-    return os.getenv(bstack1l1l_opy_ (u"ࠨࡅࡌࡖࡈࡒࡅࡠࡄࡘࡍࡑࡊ࡟ࡏࡗࡐࠫઈ"), 0)
-  if str(os.getenv(bstack1l1l_opy_ (u"ࠩࡆࡍࠬઉ"))).lower() == bstack1l1l_opy_ (u"ࠪࡸࡷࡻࡥࠨઊ") and str(os.getenv(bstack1l1l_opy_ (u"࡙ࠫࡘࡁࡗࡋࡖࠫઋ"))).lower() == bstack1l1l_opy_ (u"ࠬࡺࡲࡶࡧࠪઌ"):
-    return os.getenv(bstack1l1l_opy_ (u"࠭ࡔࡓࡃ࡙ࡍࡘࡥࡂࡖࡋࡏࡈࡤࡔࡕࡎࡄࡈࡖࠬઍ"), 0)
-  if str(os.getenv(bstack1l1l_opy_ (u"ࠧࡄࡋࠪ઎"))).lower() == bstack1l1l_opy_ (u"ࠨࡶࡵࡹࡪ࠭એ") and str(os.getenv(bstack1l1l_opy_ (u"ࠩࡆࡍࡤࡔࡁࡎࡇࠪઐ"))).lower() == bstack1l1l_opy_ (u"ࠪࡧࡴࡪࡥࡴࡪ࡬ࡴࠬઑ"):
-    return 0 # bstack1l1111_opy_ bstack11l111_opy_ not set build number env
-  if os.getenv(bstack1l1l_opy_ (u"ࠫࡇࡏࡔࡃࡗࡆࡏࡊ࡚࡟ࡃࡔࡄࡒࡈࡎࠧ઒")) and os.getenv(bstack1l1l_opy_ (u"ࠬࡈࡉࡕࡄࡘࡇࡐࡋࡔࡠࡅࡒࡑࡒࡏࡔࠨઓ")):
-    return os.getenv(bstack1l1l_opy_ (u"࠭ࡂࡊࡖࡅ࡙ࡈࡑࡅࡕࡡࡅ࡙ࡎࡒࡄࡠࡐࡘࡑࡇࡋࡒࠨઔ"), 0)
-  if str(os.getenv(bstack1l1l_opy_ (u"ࠧࡄࡋࠪક"))).lower() == bstack1l1l_opy_ (u"ࠨࡶࡵࡹࡪ࠭ખ") and str(os.getenv(bstack1l1l_opy_ (u"ࠩࡇࡖࡔࡔࡅࠨગ"))).lower() == bstack1l1l_opy_ (u"ࠪࡸࡷࡻࡥࠨઘ"):
-    return os.getenv(bstack1l1l_opy_ (u"ࠫࡉࡘࡏࡏࡇࡢࡆ࡚ࡏࡌࡅࡡࡑ࡙ࡒࡈࡅࡓࠩઙ"), 0)
-  if str(os.getenv(bstack1l1l_opy_ (u"ࠬࡉࡉࠨચ"))).lower() == bstack1l1l_opy_ (u"࠭ࡴࡳࡷࡨࠫછ") and str(os.getenv(bstack1l1l_opy_ (u"ࠧࡔࡇࡐࡅࡕࡎࡏࡓࡇࠪજ"))).lower() == bstack1l1l_opy_ (u"ࠨࡶࡵࡹࡪ࠭ઝ"):
-    return os.getenv(bstack1l1l_opy_ (u"ࠩࡖࡉࡒࡇࡐࡉࡑࡕࡉࡤࡐࡏࡃࡡࡌࡈࠬઞ"), 0)
-  if str(os.getenv(bstack1l1l_opy_ (u"ࠪࡇࡎ࠭ટ"))).lower() == bstack1l1l_opy_ (u"ࠫࡹࡸࡵࡦࠩઠ") and str(os.getenv(bstack1l1l_opy_ (u"ࠬࡍࡉࡕࡎࡄࡆࡤࡉࡉࠨડ"))).lower() == bstack1l1l_opy_ (u"࠭ࡴࡳࡷࡨࠫઢ"):
-    return os.getenv(bstack1l1l_opy_ (u"ࠧࡄࡋࡢࡎࡔࡈ࡟ࡊࡆࠪણ"), 0)
-  if str(os.getenv(bstack1l1l_opy_ (u"ࠨࡅࡌࠫત"))).lower() == bstack1l1l_opy_ (u"ࠩࡷࡶࡺ࡫ࠧથ") and str(os.getenv(bstack1l1l_opy_ (u"ࠪࡆ࡚ࡏࡌࡅࡍࡌࡘࡊ࠭દ"))).lower() == bstack1l1l_opy_ (u"ࠫࡹࡸࡵࡦࠩધ"):
-    return os.getenv(bstack1l1l_opy_ (u"ࠬࡈࡕࡊࡎࡇࡏࡎ࡚ࡅࡠࡄࡘࡍࡑࡊ࡟ࡏࡗࡐࡆࡊࡘࠧન"), 0)
-  if str(os.getenv(bstack1l1l_opy_ (u"࠭ࡔࡇࡡࡅ࡙ࡎࡒࡄࠨ઩"))).lower() == bstack1l1l_opy_ (u"ࠧࡵࡴࡸࡩࠬપ"):
-    return os.getenv(bstack1l1l_opy_ (u"ࠨࡄࡘࡍࡑࡊ࡟ࡃࡗࡌࡐࡉࡏࡄࠨફ"), 0)
...
+    return os.getenv(bstack111_opy_ (u"ࠨࡄࡘࡍࡑࡊ࡟ࡃࡗࡌࡐࡉࡏࡄࠨફ"), 0)
   return -1
-def bstack111l111l_opy_(bstack1ll11l111_opy_):
+def bstack1ll111ll1_opy_(bstack1l11ll1_opy_):
   global CONFIG
-  if not bstack1l1l_opy_ (u"ࠩࠧࡿࡇ࡛ࡉࡍࡆࡢࡒ࡚ࡓࡂࡆࡔࢀࠫબ") in CONFIG[bstack1l1l_opy_ (u"ࠪࡦࡺ࡯࡬ࡥࡋࡧࡩࡳࡺࡩࡧ࡫ࡨࡶࠬભ")]:
+  if not bstack111_opy_ (u"ࠩࠧࡿࡇ࡛ࡉࡍࡆࡢࡒ࡚ࡓࡂࡆࡔࢀࠫબ") in CONFIG[bstack111_opy_ (u"ࠪࡦࡺ࡯࡬ࡥࡋࡧࡩࡳࡺࡩࡧ࡫ࡨࡶࠬભ")]:
     return
-  CONFIG[bstack1l1l_opy_ (u"ࠫࡧࡻࡩ࡭ࡦࡌࡨࡪࡴࡴࡪࡨ࡬ࡩࡷ࠭મ")] = CONFIG[bstack1l1l_opy_ (u"ࠬࡨࡵࡪ࡮ࡧࡍࡩ࡫࡮ࡵ࡫ࡩ࡭ࡪࡸࠧય")].replace(
-    bstack1l1l_opy_ (u"࠭ࠤࡼࡄࡘࡍࡑࡊ࡟ࡏࡗࡐࡆࡊࡘࡽࠨર"),
...
+def bstack11ll1l11_opy_():
   global CONFIG
-  if not bstack1l1l_opy_ (u"ࠧࠥࡽࡇࡅ࡙ࡋ࡟ࡕࡋࡐࡉࢂ࠭઱") in CONFIG[bstack1l1l_opy_ (u"ࠨࡤࡸ࡭ࡱࡪࡉࡥࡧࡱࡸ࡮࡬ࡩࡦࡴࠪલ")]:
+  if not bstack111_opy_ (u"ࠧࠥࡽࡇࡅ࡙ࡋ࡟ࡕࡋࡐࡉࢂ࠭઱") in CONFIG[bstack111_opy_ (u"ࠨࡤࡸ࡭ࡱࡪࡉࡥࡧࡱࡸ࡮࡬ࡩࡦࡴࠪલ")]:
     return
   current_time = datetime.datetime.now()
-  bstack1lllll1ll_opy_ = current_time.strftime(bstack1l1l_opy_ (u"ࠩࠨࡨ࠲ࠫࡢ࠮ࠧࡋ࠾ࠪࡓࠧળ"))
-  CONFIG[bstack1l1l_opy_ (u"ࠪࡦࡺ࡯࡬ࡥࡋࡧࡩࡳࡺࡩࡧ࡫ࡨࡶࠬ઴")] = CONFIG[bstack1l1l_opy_ (u"ࠫࡧࡻࡩ࡭ࡦࡌࡨࡪࡴࡴࡪࡨ࡬ࡩࡷ࠭વ")].replace(
-    bstack1l1l_opy_ (u"ࠬࠪࡻࡅࡃࡗࡉࡤ࡚ࡉࡎࡇࢀࠫશ"),
...
+def bstack1lllllll_opy_():
   global CONFIG
-  if bstack1l1l_opy_ (u"࠭ࡢࡶ࡫࡯ࡨࡎࡪࡥ࡯ࡶ࡬ࡪ࡮࡫ࡲࠨષ") in CONFIG and not bool(CONFIG[bstack1l1l_opy_ (u"ࠧࡣࡷ࡬ࡰࡩࡏࡤࡦࡰࡷ࡭࡫࡯ࡥࡳࠩસ")]):
-    del CONFIG[bstack1l1l_opy_ (u"ࠨࡤࡸ࡭ࡱࡪࡉࡥࡧࡱࡸ࡮࡬ࡩࡦࡴࠪહ")]
...
+    del CONFIG[bstack111_opy_ (u"ࠨࡤࡸ࡭ࡱࡪࡉࡥࡧࡱࡸ࡮࡬ࡩࡦࡴࠪહ")]
     return
-  if not bstack1l1l_opy_ (u"ࠩࡥࡹ࡮ࡲࡤࡊࡦࡨࡲࡹ࡯ࡦࡪࡧࡵࠫ઺") in CONFIG:
-    CONFIG[bstack1l1l_opy_ (u"ࠪࡦࡺ࡯࡬ࡥࡋࡧࡩࡳࡺࡩࡧ࡫ࡨࡶࠬ઻")] = bstack1l1l_opy_ (u"ࠫࠨࠪࡻࡃࡗࡌࡐࡉࡥࡎࡖࡏࡅࡉࡗࢃ઼ࠧ")
-  if bstack1l1l_opy_ (u"ࠬࠪࡻࡅࡃࡗࡉࡤ࡚ࡉࡎࡇࢀࠫઽ") in CONFIG[bstack1l1l_opy_ (u"࠭ࡢࡶ࡫࡯ࡨࡎࡪࡥ࡯ࡶ࡬ࡪ࡮࡫ࡲࠨા")]:
-    bstack1l1l1llll_opy_()
-    os.environ[bstack1l1l_opy_ (u"ࠧࡃࡕࡗࡅࡈࡑ࡟ࡄࡑࡐࡆࡎࡔࡅࡅࡡࡅ࡙ࡎࡒࡄࡠࡋࡇࠫિ")] = CONFIG[bstack1l1l_opy_ (u"ࠨࡤࡸ࡭ࡱࡪࡉࡥࡧࡱࡸ࡮࡬ࡩࡦࡴࠪી")]
-  if not bstack1l1l_opy_ (u"ࠩࠧࡿࡇ࡛ࡉࡍࡆࡢࡒ࡚ࡓࡂࡆࡔࢀࠫુ") in CONFIG[bstack1l1l_opy_ (u"ࠪࡦࡺ࡯࡬ࡥࡋࡧࡩࡳࡺࡩࡧ࡫ࡨࡶࠬૂ")]:
...
+  if not bstack111_opy_ (u"ࠩࠧࡿࡇ࡛ࡉࡍࡆࡢࡒ࡚ࡓࡂࡆࡔࢀࠫુ") in CONFIG[bstack111_opy_ (u"ࠪࡦࡺ࡯࡬ࡥࡋࡧࡩࡳࡺࡩࡧ࡫ࡨࡶࠬૂ")]:
     return
-  bstack1ll11l111_opy_ = bstack1l1l_opy_ (u"ࠫࠬૃ")
-  bstack1l1l1lll_opy_ = bstack1l11l11l_opy_()
-  if bstack1l1l1lll_opy_ != -1:
-    bstack1ll11l111_opy_ = bstack1l1l_opy_ (u"ࠬࡉࡉࠡࠩૄ") + str(bstack1l1l1lll_opy_)
-  if bstack1ll11l111_opy_ == bstack1l1l_opy_ (u"࠭ࠧૅ"):
-    bstack1lll11111_opy_ = bstack1l1l111l1_opy_(CONFIG[bstack1l1l_opy_ (u"ࠧࡣࡷ࡬ࡰࡩࡔࡡ࡮ࡧࠪ૆")])
-    if bstack1lll11111_opy_ != -1:
-      bstack1ll11l111_opy_ = str(bstack1lll11111_opy_)
-  if bstack1ll11l111_opy_:
-    bstack111l111l_opy_(bstack1ll11l111_opy_)
-    os.environ[bstack1l1l_opy_ (u"ࠨࡄࡖࡘࡆࡉࡋࡠࡅࡒࡑࡇࡏࡎࡆࡆࡢࡆ࡚ࡏࡌࡅࡡࡌࡈࠬે")] = CONFIG[bstack1l1l_opy_ (u"ࠩࡥࡹ࡮ࡲࡤࡊࡦࡨࡲࡹ࡯ࡦࡪࡧࡵࠫૈ")]
-def bstack1ll1llll1_opy_(bstack11111lll_opy_, bstack1lllllll1_opy_, path):
-  bstack1l111lll_opy_ = {
-    bstack1l1l_opy_ (u"ࠪ࡭ࡩ࡫࡮ࡵ࡫ࡩ࡭ࡪࡸࠧૉ"): bstack1lllllll1_opy_
...
-    bstack1llll1lll_opy_ = json.load(open(path, bstack1l1l_opy_ (u"ࠫࡷࡨࠧ૊")))
+    bstack1lll1ll1_opy_ = json.load(open(path, bstack111_opy_ (u"ࠫࡷࡨࠧ૊")))
   else:
-    bstack1llll1lll_opy_ = {}
-  bstack1llll1lll_opy_[bstack11111lll_opy_] = bstack1l111lll_opy_
-  with open(path, bstack1l1l_opy_ (u"ࠧࡽࠫࠣો")) as outfile:
-    json.dump(bstack1llll1lll_opy_, outfile)
-def bstack1l1l111l1_opy_(bstack11111lll_opy_):
-  bstack11111lll_opy_ = str(bstack11111lll_opy_)
-  bstack11ll111l_opy_ = os.path.join(os.path.expanduser(bstack1l1l_opy_ (u"࠭ࡾࠨૌ")), bstack1l1l_opy_ (u"ࠧ࠯ࡤࡵࡳࡼࡹࡥࡳࡵࡷࡥࡨࡱ્ࠧ"))
+    bstack1lll1ll1_opy_ = {}
...
+  bstack111llll1_opy_ = os.path.join(os.path.expanduser(bstack111_opy_ (u"࠭ࡾࠨૌ")), bstack111_opy_ (u"ࠧ࠯ࡤࡵࡳࡼࡹࡥࡳࡵࡷࡥࡨࡱ્ࠧ"))
   try:
-    if not os.path.exists(bstack11ll111l_opy_):
-      os.makedirs(bstack11ll111l_opy_)
-    file_path = os.path.join(os.path.expanduser(bstack1l1l_opy_ (u"ࠨࢀࠪ૎")), bstack1l1l_opy_ (u"ࠩ࠱ࡦࡷࡵࡷࡴࡧࡵࡷࡹࡧࡣ࡬ࠩ૏"), bstack1l1l_opy_ (u"ࠪ࠲ࡧࡻࡩ࡭ࡦ࠰ࡲࡦࡳࡥ࠮ࡥࡤࡧ࡭࡫࠮࡫ࡵࡲࡲࠬૐ"))
...
-      with open(file_path, bstack1l1l_opy_ (u"ࠫࡼ࠭૑")):
+      with open(file_path, bstack111_opy_ (u"ࠫࡼ࠭૑")):
         pass
-      with open(file_path, bstack1l1l_opy_ (u"ࠧࡽࠫࠣ૒")) as outfile:
+      with open(file_path, bstack111_opy_ (u"ࠧࡽࠫࠣ૒")) as outfile:
         json.dump({}, outfile)
-    with open(file_path, bstack1l1l_opy_ (u"࠭ࡲࠨ૓")) as bstack1l1llll1_opy_:
-      bstack1l1ll111_opy_ = json.load(bstack1l1llll1_opy_)
-    if bstack11111lll_opy_ in bstack1l1ll111_opy_:
-      bstack1ll1ll_opy_ = bstack1l1ll111_opy_[bstack11111lll_opy_][bstack1l1l_opy_ (u"ࠧࡪࡦࡨࡲࡹ࡯ࡦࡪࡧࡵࠫ૔")]
-      bstack11l11111_opy_ = int(bstack1ll1ll_opy_) + 1
-      bstack1ll1llll1_opy_(bstack11111lll_opy_, bstack11l11111_opy_, file_path)
...
-      bstack1ll1llll1_opy_(bstack11111lll_opy_, 1, file_path)
+      bstack11l1lll1_opy_(bstack1l1l1lll_opy_, 1, file_path)
       return 1
   except Exception as e:
-    logger.warn(bstack11l1l11_opy_.format(str(e)))
+    logger.warn(bstack111lll1_opy_.format(str(e)))
     return -1
-def bstack1l1lll_opy_(config):
-  if not config[bstack1l1l_opy_ (u"ࠨࡷࡶࡩࡷࡔࡡ࡮ࡧࠪ૕")] or not config[bstack1l1l_opy_ (u"ࠩࡤࡧࡨ࡫ࡳࡴࡍࡨࡽࠬ૖")]:
...
-  if bstack1l1ll11_opy_() < version.parse(bstack1l1l_opy_ (u"ࠪ࠷࠳࠺࠮࠱ࠩ૗")):
+def bstack1llllll1l_opy_(config):
+  if bstack11l111l_opy_() < version.parse(bstack111_opy_ (u"ࠪ࠷࠳࠺࠮࠱ࠩ૗")):
     return False
-  if bstack1l1ll11_opy_() >= version.parse(bstack1l1l_opy_ (u"ࠫ࠹࠴࠱࠯࠷ࠪ૘")):
+  if bstack11l111l_opy_() >= version.parse(bstack111_opy_ (u"ࠫ࠹࠴࠱࠯࠷ࠪ૘")):
     return True
-  if bstack1l1l_opy_ (u"ࠬࡻࡳࡦ࡙࠶ࡇࠬ૙") in config and config[bstack1l1l_opy_ (u"࠭ࡵࡴࡧ࡚࠷ࡈ࠭૚")] == False:
+  if bstack111_opy_ (u"ࠬࡻࡳࡦ࡙࠶ࡇࠬ૙") in config and config[bstack111_opy_ (u"࠭ࡵࡴࡧ࡚࠷ࡈ࠭૚")] == False:
     return False
   else:
     return True
-def bstack111ll11l_opy_(config, index = 0):
-  global bstack111l1lll_opy_
-  bstack1ll11_opy_ = {}
-  caps = bstack111111l1_opy_ + bstack1l1l1lll1_opy_
-  if bstack111l1lll_opy_:
-    caps += bstack1lll1l11_opy_
...
+    caps += bstack111l_opy_
   for key in config:
-    if key in caps + [bstack1l1l_opy_ (u"ࠧࡱ࡮ࡤࡸ࡫ࡵࡲ࡮ࡵࠪ૛")]:
+    if key in caps + [bstack111_opy_ (u"ࠧࡱ࡮ࡤࡸ࡫ࡵࡲ࡮ࡵࠪ૛")]:
       continue
-    bstack1ll11_opy_[key] = config[key]
-  if bstack1l1l_opy_ (u"ࠨࡲ࡯ࡥࡹ࡬࡯ࡳ࡯ࡶࠫ૜") in config:
-    for bstack1111l1_opy_ in config[bstack1l1l_opy_ (u"ࠩࡳࡰࡦࡺࡦࡰࡴࡰࡷࠬ૝")][index]:
-      if bstack1111l1_opy_ in caps + [bstack1l1l_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵࡒࡦࡳࡥࠨ૞"), bstack1l1l_opy_ (u"ࠫࡧࡸ࡯ࡸࡵࡨࡶ࡛࡫ࡲࡴ࡫ࡲࡲࠬ૟")]:
...
+      if bstack1l1llll1l_opy_ in caps + [bstack111_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵࡒࡦࡳࡥࠨ૞"), bstack111_opy_ (u"ࠫࡧࡸ࡯ࡸࡵࡨࡶ࡛࡫ࡲࡴ࡫ࡲࡲࠬ૟")]:
         continue
-      bstack1ll11_opy_[bstack1111l1_opy_] = config[bstack1l1l_opy_ (u"ࠬࡶ࡬ࡢࡶࡩࡳࡷࡳࡳࠨૠ")][index][bstack1111l1_opy_]
-  bstack1ll11_opy_[bstack1l1l_opy_ (u"࠭ࡨࡰࡵࡷࡒࡦࡳࡥࠨૡ")] = socket.gethostname()
-  if bstack1l1l_opy_ (u"ࠧࡷࡧࡵࡷ࡮ࡵ࡮ࠨૢ") in bstack1ll11_opy_:
-    del(bstack1ll11_opy_[bstack1l1l_opy_ (u"ࠨࡸࡨࡶࡸ࡯࡯࡯ࠩૣ")])
...
-def bstack1l11l111_opy_(bstack1ll11_opy_, bstack1111111l_opy_):
-  bstack11ll1l11_opy_ = {}
-  for key in bstack1ll11_opy_.keys():
-    if key in bstack1ll1111l_opy_:
-      bstack11ll1l11_opy_[bstack1ll1111l_opy_[key]] = bstack1ll11_opy_[key]
...
-      bstack11ll1l11_opy_[key] = bstack1ll11_opy_[key]
-  for key in bstack1111111l_opy_:
-    if key in bstack1ll1111l_opy_:
-      bstack11ll1l11_opy_[bstack1ll1111l_opy_[key]] = bstack1111111l_opy_[key]
...
-      bstack11ll1l11_opy_[key] = bstack1111111l_opy_[key]
...
+  global bstack1l11l_opy_
   caps = {}
-  bstack1111111l_opy_ = bstack1lll1llll_opy_(config)
-  bstack111l1l_opy_ = bstack1l1l1lll1_opy_
-  bstack111l1l_opy_ += bstack1l1lll1l_opy_
-  if bstack111l1lll_opy_:
-    bstack111l1l_opy_ += bstack1lll1l11_opy_
-  if bstack1l1l_opy_ (u"ࠩࡳࡰࡦࡺࡦࡰࡴࡰࡷࠬ૤") in config:
-    if bstack1l1l_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵࡒࡦࡳࡥࠨ૥") in config[bstack1l1l_opy_ (u"ࠫࡵࡲࡡࡵࡨࡲࡶࡲࡹࠧ૦")][index]:
-      caps[bstack1l1l_opy_ (u"ࠬࡨࡲࡰࡹࡶࡩࡷࡔࡡ࡮ࡧࠪ૧")] = config[bstack1l1l_opy_ (u"࠭ࡰ࡭ࡣࡷࡪࡴࡸ࡭ࡴࠩ૨")][index][bstack1l1l_opy_ (u"ࠧࡣࡴࡲࡻࡸ࡫ࡲࡏࡣࡰࡩࠬ૩")]
-    if bstack1l1l_opy_ (u"ࠨࡤࡵࡳࡼࡹࡥࡳࡘࡨࡶࡸ࡯࡯࡯ࠩ૪") in config[bstack1l1l_opy_ (u"ࠩࡳࡰࡦࡺࡦࡰࡴࡰࡷࠬ૫")][index]:
-      caps[bstack1l1l_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵ࡚ࡪࡸࡳࡪࡱࡱࠫ૬")] = str(config[bstack1l1l_opy_ (u"ࠫࡵࡲࡡࡵࡨࡲࡶࡲࡹࠧ૭")][index][bstack1l1l_opy_ (u"ࠬࡨࡲࡰࡹࡶࡩࡷ࡜ࡥࡳࡵ࡬ࡳࡳ࠭૮")])
-    bstack1l1l1l1_opy_ = {}
-    for bstack1l1ll1l11_opy_ in bstack111l1l_opy_:
-      if bstack1l1ll1l11_opy_ in config[bstack1l1l_opy_ (u"࠭ࡰ࡭ࡣࡷࡪࡴࡸ࡭ࡴࠩ૯")][index]:
-        if bstack1l1ll1l11_opy_ == bstack1l1l_opy_ (u"ࠧࡱ࡮ࡤࡸ࡫ࡵࡲ࡮ࡘࡨࡶࡸ࡯࡯࡯ࠩ૰"):
-          bstack1l1l1l1_opy_[bstack1l1ll1l11_opy_] = str(config[bstack1l1l_opy_ (u"ࠨࡲ࡯ࡥࡹ࡬࡯ࡳ࡯ࡶࠫ૱")][index][bstack1l1ll1l11_opy_] * 1.0)
...
-          bstack1l1l1l1_opy_[bstack1l1ll1l11_opy_] = config[bstack1l1l_opy_ (u"ࠩࡳࡰࡦࡺࡦࡰࡴࡰࡷࠬ૲")][index][bstack1l1ll1l11_opy_]
-        del(config[bstack1l1l_opy_ (u"ࠪࡴࡱࡧࡴࡧࡱࡵࡱࡸ࠭૳")][index][bstack1l1ll1l11_opy_])
-    bstack1111111l_opy_ = update(bstack1111111l_opy_, bstack1l1l1l1_opy_)
-  bstack1ll11_opy_ = bstack111ll11l_opy_(config, index)
-  for bstack11111ll1_opy_ in bstack1l1l1lll1_opy_ + [bstack1l1l_opy_ (u"ࠫࡧࡸ࡯ࡸࡵࡨࡶࡓࡧ࡭ࡦࠩ૴"), bstack1l1l_opy_ (u"ࠬࡨࡲࡰࡹࡶࡩࡷ࡜ࡥࡳࡵ࡬ࡳࡳ࠭૵")]:
-    if bstack11111ll1_opy_ in bstack1ll11_opy_:
-      bstack1111111l_opy_[bstack11111ll1_opy_] = bstack1ll11_opy_[bstack11111ll1_opy_]
-      del(bstack1ll11_opy_[bstack11111ll1_opy_])
-  if bstack1l1l1ll_opy_(config):
-    bstack1ll11_opy_[bstack1l1l_opy_ (u"࠭ࡵࡴࡧ࡚࠷ࡈ࠭૶")] = True
-    caps.update(bstack1111111l_opy_)
-    caps[bstack1l1l_opy_ (u"ࠧࡣࡵࡷࡥࡨࡱ࠺ࡰࡲࡷ࡭ࡴࡴࡳࠨ૷")] = bstack1ll11_opy_
...
-    bstack1ll11_opy_[bstack1l1l_opy_ (u"ࠨࡷࡶࡩ࡜࠹ࡃࠨ૸")] = False
-    caps.update(bstack1l11l111_opy_(bstack1ll11_opy_, bstack1111111l_opy_))
-    if bstack1l1l_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡑࡥࡲ࡫ࠧૹ") in caps:
-      caps[bstack1l1l_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵࠫૺ")] = caps[bstack1l1l_opy_ (u"ࠫࡧࡸ࡯ࡸࡵࡨࡶࡓࡧ࡭ࡦࠩૻ")]
-      del(caps[bstack1l1l_opy_ (u"ࠬࡨࡲࡰࡹࡶࡩࡷࡔࡡ࡮ࡧࠪૼ")])
-    if bstack1l1l_opy_ (u"࠭ࡢࡳࡱࡺࡷࡪࡸࡖࡦࡴࡶ࡭ࡴࡴࠧ૽") in caps:
-      caps[bstack1l1l_opy_ (u"ࠧࡣࡴࡲࡻࡸ࡫ࡲࡠࡸࡨࡶࡸ࡯࡯࡯ࠩ૾")] = caps[bstack1l1l_opy_ (u"ࠨࡤࡵࡳࡼࡹࡥࡳࡘࡨࡶࡸ࡯࡯࡯ࠩ૿")]
...
-  if bstack1l1ll11_opy_() <= version.parse(bstack1l1l_opy_ (u"ࠪ࠷࠳࠷࠳࠯࠲ࠪଁ")):
-    return bstack11llll_opy_
-  return bstack1ll111l_opy_
-def bstack11ll1ll_opy_(options):
-  return hasattr(options, bstack1l1l_opy_ (u"ࠫࡸ࡫ࡴࡠࡥࡤࡴࡦࡨࡩ࡭࡫ࡷࡽࠬଂ"))
   ...
   for k, v in u.items():
     if isinstance(v, collections.abc.Mapping):
       ...
       if isinstance(v, list):
         ...
         d[k] = v
   return d
-def bstack1ll1l111l_opy_(options, bstack1llll1111_opy_):
-  for bstack111l11l1_opy_ in bstack1llll1111_opy_:
-    if bstack111l11l1_opy_ in [bstack1l1l_opy_ (u"ࠬࡧࡲࡨࡵࠪଃ"), bstack1l1l_opy_ (u"࠭ࡥࡹࡶࡨࡲࡸ࡯࡯࡯ࡵࠪ଄")]:
...
+    if bstack111l1ll_opy_ in [bstack111_opy_ (u"ࠬࡧࡲࡨࡵࠪଃ"), bstack111_opy_ (u"࠭ࡥࡹࡶࡨࡲࡸ࡯࡯࡯ࡵࠪ଄")]:
       next
-    if bstack111l11l1_opy_ in options._experimental_options:
-      options._experimental_options[bstack111l11l1_opy_]= update(options._experimental_options[bstack111l11l1_opy_], bstack1llll1111_opy_[bstack111l11l1_opy_])
...
-      options.add_experimental_option(bstack111l11l1_opy_, bstack1llll1111_opy_[bstack111l11l1_opy_])
-  if bstack1l1l_opy_ (u"ࠧࡢࡴࡪࡷࠬଅ") in bstack1llll1111_opy_:
-    for arg in bstack1llll1111_opy_[bstack1l1l_opy_ (u"ࠨࡣࡵ࡫ࡸ࠭ଆ")]:
...
-    del(bstack1llll1111_opy_[bstack1l1l_opy_ (u"ࠩࡤࡶ࡬ࡹࠧଇ")])
-  if bstack1l1l_opy_ (u"ࠪࡩࡽࡺࡥ࡯ࡵ࡬ࡳࡳࡹࠧଈ") in bstack1llll1111_opy_:
-    for ext in bstack1llll1111_opy_[bstack1l1l_opy_ (u"ࠫࡪࡾࡴࡦࡰࡶ࡭ࡴࡴࡳࠨଉ")]:
...
-    del(bstack1llll1111_opy_[bstack1l1l_opy_ (u"ࠬ࡫ࡸࡵࡧࡱࡷ࡮ࡵ࡮ࡴࠩଊ")])
-def bstack1ll11l1ll_opy_(options, bstack1llllll1_opy_):
-  if bstack1l1l_opy_ (u"࠭ࡰࡳࡧࡩࡷࠬଋ") in bstack1llllll1_opy_:
-    for bstack1l1lllll1_opy_ in bstack1llllll1_opy_[bstack1l1l_opy_ (u"ࠧࡱࡴࡨࡪࡸ࠭ଌ")]:
-      if bstack1l1lllll1_opy_ in options._preferences:
-        options._preferences[bstack1l1lllll1_opy_] = update(options._preferences[bstack1l1lllll1_opy_], bstack1llllll1_opy_[bstack1l1l_opy_ (u"ࠨࡲࡵࡩ࡫ࡹࠧ଍")][bstack1l1lllll1_opy_])
...
-        options.set_preference(bstack1l1lllll1_opy_, bstack1llllll1_opy_[bstack1l1l_opy_ (u"ࠩࡳࡶࡪ࡬ࡳࠨ଎")][bstack1l1lllll1_opy_])
-  if bstack1l1l_opy_ (u"ࠪࡥࡷ࡭ࡳࠨଏ") in bstack1llllll1_opy_:
-    for arg in bstack1llllll1_opy_[bstack1l1l_opy_ (u"ࠫࡦࡸࡧࡴࠩଐ")]:
...
+    for arg in bstack11ll1ll1_opy_[bstack111_opy_ (u"ࠫࡦࡸࡧࡴࠩଐ")]:
       options.add_argument(arg)
-def bstack1ll11111_opy_(options, bstack1ll1l1l1_opy_):
-  if bstack1l1l_opy_ (u"ࠬࡽࡥࡣࡸ࡬ࡩࡼ࠭଑") in bstack1ll1l1l1_opy_:
-    options.use_webview(bool(bstack1ll1l1l1_opy_[bstack1l1l_opy_ (u"࠭ࡷࡦࡤࡹ࡭ࡪࡽࠧ଒")]))
-  bstack1ll1l111l_opy_(options, bstack1ll1l1l1_opy_)
-def bstack11l1l11l_opy_(options, bstack1ll11l1l1_opy_):
-  for bstack111l1l1l_opy_ in bstack1ll11l1l1_opy_:
-    if bstack111l1l1l_opy_ in [bstack1l1l_opy_ (u"ࠧࡵࡧࡦ࡬ࡳࡵ࡬ࡰࡩࡼࡔࡷ࡫ࡶࡪࡧࡺࠫଓ"), bstack1l1l_opy_ (u"ࠨࡣࡵ࡫ࡸ࠭ଔ")]:
...
+    if bstack1ll1l1l1_opy_ in [bstack111_opy_ (u"ࠧࡵࡧࡦ࡬ࡳࡵ࡬ࡰࡩࡼࡔࡷ࡫ࡶࡪࡧࡺࠫଓ"), bstack111_opy_ (u"ࠨࡣࡵ࡫ࡸ࠭ଔ")]:
       next
-    options.set_capability(bstack111l1l1l_opy_, bstack1ll11l1l1_opy_[bstack111l1l1l_opy_])
-  if bstack1l1l_opy_ (u"ࠩࡤࡶ࡬ࡹࠧକ") in bstack1ll11l1l1_opy_:
-    for arg in bstack1ll11l1l1_opy_[bstack1l1l_opy_ (u"ࠪࡥࡷ࡭ࡳࠨଖ")]:
...
+    for arg in bstack1ll1111_opy_[bstack111_opy_ (u"ࠪࡥࡷ࡭ࡳࠨଖ")]:
       options.add_argument(arg)
-  if bstack1l1l_opy_ (u"ࠫࡹ࡫ࡣࡩࡰࡲࡰࡴ࡭ࡹࡑࡴࡨࡺ࡮࡫ࡷࠨଗ") in bstack1ll11l1l1_opy_:
-    options.use_technology_preview(bool(bstack1ll11l1l1_opy_[bstack1l1l_opy_ (u"ࠬࡺࡥࡤࡪࡱࡳࡱࡵࡧࡺࡒࡵࡩࡻ࡯ࡥࡸࠩଘ")]))
-def bstack1l111_opy_(options, bstack1ll1ll1l_opy_):
-  for bstack1lll1111_opy_ in bstack1ll1ll1l_opy_:
-    if bstack1lll1111_opy_ in [bstack1l1l_opy_ (u"࠭ࡡࡥࡦ࡬ࡸ࡮ࡵ࡮ࡢ࡮ࡒࡴࡹ࡯࡯࡯ࡵࠪଙ"), bstack1l1l_opy_ (u"ࠧࡢࡴࡪࡷࠬଚ")]:
...
+    if bstack11l1l_opy_ in [bstack111_opy_ (u"࠭ࡡࡥࡦ࡬ࡸ࡮ࡵ࡮ࡢ࡮ࡒࡴࡹ࡯࡯࡯ࡵࠪଙ"), bstack111_opy_ (u"ࠧࡢࡴࡪࡷࠬଚ")]:
       next
-    options._options[bstack1lll1111_opy_] = bstack1ll1ll1l_opy_[bstack1lll1111_opy_]
-  if bstack1l1l_opy_ (u"ࠨࡣࡧࡨ࡮ࡺࡩࡰࡰࡤࡰࡔࡶࡴࡪࡱࡱࡷࠬଛ") in bstack1ll1ll1l_opy_:
-    for bstack1ll11lll1_opy_ in bstack1ll1ll1l_opy_[bstack1l1l_opy_ (u"ࠩࡤࡨࡩ࡯ࡴࡪࡱࡱࡥࡱࡕࡰࡵ࡫ࡲࡲࡸ࠭ଜ")]:
...
-          bstack1ll11lll1_opy_, bstack1ll1ll1l_opy_[bstack1l1l_opy_ (u"ࠪࡥࡩࡪࡩࡵ࡫ࡲࡲࡦࡲࡏࡱࡶ࡬ࡳࡳࡹࠧଝ")][bstack1ll11lll1_opy_])
-  if bstack1l1l_opy_ (u"ࠫࡦࡸࡧࡴࠩଞ") in bstack1ll1ll1l_opy_:
-    for arg in bstack1ll1ll1l_opy_[bstack1l1l_opy_ (u"ࠬࡧࡲࡨࡵࠪଟ")]:
...
+    for arg in bstack1l1lll11l_opy_[bstack111_opy_ (u"ࠬࡧࡲࡨࡵࠪଟ")]:
       options.add_argument(arg)
-def bstack1l1ll1ll1_opy_(options, caps):
-  if not hasattr(options, bstack1l1l_opy_ (u"࠭ࡋࡆ࡛ࠪଠ")):
+def bstack1ll11l1_opy_(options, caps):
+  if not hasattr(options, bstack111_opy_ (u"࠭ࡋࡆ࡛ࠪଠ")):
     return
-  if options.KEY == bstack1l1l_opy_ (u"ࠧࡨࡱࡲ࡫࠿ࡩࡨࡳࡱࡰࡩࡔࡶࡴࡪࡱࡱࡷࠬଡ") and options.KEY in caps:
-    bstack1ll1l111l_opy_(options, caps[bstack1l1l_opy_ (u"ࠨࡩࡲࡳ࡬ࡀࡣࡩࡴࡲࡱࡪࡕࡰࡵ࡫ࡲࡲࡸ࠭ଢ")])
-  elif options.KEY == bstack1l1l_opy_ (u"ࠩࡰࡳࡿࡀࡦࡪࡴࡨࡪࡴࡾࡏࡱࡶ࡬ࡳࡳࡹࠧଣ") and options.KEY in caps:
-    bstack1ll11l1ll_opy_(options, caps[bstack1l1l_opy_ (u"ࠪࡱࡴࢀ࠺ࡧ࡫ࡵࡩ࡫ࡵࡸࡐࡲࡷ࡭ࡴࡴࡳࠨତ")])
-  elif options.KEY == bstack1l1l_opy_ (u"ࠫࡸࡧࡦࡢࡴ࡬࠲ࡴࡶࡴࡪࡱࡱࡷࠬଥ") and options.KEY in caps:
-    bstack11l1l11l_opy_(options, caps[bstack1l1l_opy_ (u"ࠬࡹࡡࡧࡣࡵ࡭࠳ࡵࡰࡵ࡫ࡲࡲࡸ࠭ଦ")])
-  elif options.KEY == bstack1l1l_opy_ (u"࠭࡭ࡴ࠼ࡨࡨ࡬࡫ࡏࡱࡶ࡬ࡳࡳࡹࠧଧ") and options.KEY in caps:
-    bstack1ll11111_opy_(options, caps[bstack1l1l_opy_ (u"ࠧ࡮ࡵ࠽ࡩࡩ࡭ࡥࡐࡲࡷ࡭ࡴࡴࡳࠨନ")])
-  elif options.KEY == bstack1l1l_opy_ (u"ࠨࡵࡨ࠾࡮࡫ࡏࡱࡶ࡬ࡳࡳࡹࠧ଩") and options.KEY in caps:
-    bstack1l111_opy_(options, caps[bstack1l1l_opy_ (u"ࠩࡶࡩ࠿࡯ࡥࡐࡲࡷ࡭ࡴࡴࡳࠨପ")])
-def bstack1lll1ll1_opy_(caps):
-  global bstack111l1lll_opy_
-  if bstack111l1lll_opy_:
-    if bstack1l111l1_opy_() < version.parse(bstack1l1l_opy_ (u"ࠪ࠶࠳࠹࠮࠱ࠩଫ")):
...
-    browser = bstack1l1l_opy_ (u"ࠫࡨ࡮ࡲࡰ࡯ࡨࠫବ")
-    if bstack1l1l_opy_ (u"ࠬࡨࡲࡰࡹࡶࡩࡷࡔࡡ࡮ࡧࠪଭ") in caps:
-      browser = caps[bstack1l1l_opy_ (u"࠭ࡢࡳࡱࡺࡷࡪࡸࡎࡢ࡯ࡨࠫମ")]
-    elif bstack1l1l_opy_ (u"ࠧࡣࡴࡲࡻࡸ࡫ࡲࠨଯ") in caps:
-      browser = caps[bstack1l1l_opy_ (u"ࠨࡤࡵࡳࡼࡹࡥࡳࠩର")]
...
-    if browser == bstack1l1l_opy_ (u"ࠩ࡬ࡴ࡭ࡵ࡮ࡦࠩ଱") or browser == bstack1l1l_opy_ (u"ࠪ࡭ࡵࡧࡤࠨଲ"):
-      browser = bstack1l1l_opy_ (u"ࠫࡸࡧࡦࡢࡴ࡬ࠫଳ")
-    if browser == bstack1l1l_opy_ (u"ࠬࡹࡡ࡮ࡵࡸࡲ࡬࠭଴"):
-      browser = bstack1l1l_opy_ (u"࠭ࡣࡩࡴࡲࡱࡪ࠭ଵ")
-    if browser not in [bstack1l1l_opy_ (u"ࠧࡤࡪࡵࡳࡲ࡫ࠧଶ"), bstack1l1l_opy_ (u"ࠨࡧࡧ࡫ࡪ࠭ଷ"), bstack1l1l_opy_ (u"ࠩ࡬ࡩࠬସ"), bstack1l1l_opy_ (u"ࠪࡷࡦ࡬ࡡࡳ࡫ࠪହ"), bstack1l1l_opy_ (u"ࠫ࡫࡯ࡲࡦࡨࡲࡼࠬ଺")]:
...
+    if browser not in [bstack111_opy_ (u"ࠧࡤࡪࡵࡳࡲ࡫ࠧଶ"), bstack111_opy_ (u"ࠨࡧࡧ࡫ࡪ࠭ଷ"), bstack111_opy_ (u"ࠩ࡬ࡩࠬସ"), bstack111_opy_ (u"ࠪࡷࡦ࡬ࡡࡳ࡫ࠪହ"), bstack111_opy_ (u"ࠫ࡫࡯ࡲࡦࡨࡲࡼࠬ଺")]:
       return None
     try:
-      package = bstack1l1l_opy_ (u"ࠬࡹࡥ࡭ࡧࡱ࡭ࡺࡳ࠮ࡸࡧࡥࡨࡷ࡯ࡶࡦࡴ࠱ࡿࢂ࠴࡯ࡱࡶ࡬ࡳࡳࡹࠧ଻").format(browser)
-      name = bstack1l1l_opy_ (u"࠭ࡏࡱࡶ࡬ࡳࡳࡹ଼ࠧ")
...
+      if not bstack11ll_opy_(options):
         return None
-      for bstack11111ll1_opy_ in caps.keys():
-        options.set_capability(bstack11111ll1_opy_, caps[bstack11111ll1_opy_])
-      bstack1l1ll1ll1_opy_(options, caps)
...
+      bstack1ll11l1_opy_(options, caps)
       ...
       logger.debug(str(e))
       return None
-def bstack111l1ll_opy_(options, bstack111l1111_opy_):
-  if not bstack11ll1ll_opy_(options):
+def bstack1lll111ll_opy_(options, bstack1lllllll1_opy_):
+  if not bstack11ll_opy_(options):
     return
-  for bstack11111ll1_opy_ in bstack111l1111_opy_.keys():
-    if bstack11111ll1_opy_ in bstack1l1lll1l_opy_:
+  for bstack111l11_opy_ in bstack1lllllll1_opy_.keys():
+    if bstack111l11_opy_ in bstack1ll11llll_opy_:
       next
-    if bstack11111ll1_opy_ in options._caps and type(options._caps[bstack11111ll1_opy_]) in [dict, list]:
-      options._caps[bstack11111ll1_opy_] = update(options._caps[bstack11111ll1_opy_], bstack111l1111_opy_[bstack11111ll1_opy_])
...
-      options.set_capability(bstack11111ll1_opy_, bstack111l1111_opy_[bstack11111ll1_opy_])
-  bstack1l1ll1ll1_opy_(options, bstack111l1111_opy_)
-  if bstack1l1l_opy_ (u"ࠧ࡮ࡱࡽ࠾ࡩ࡫ࡢࡶࡩࡪࡩࡷࡇࡤࡥࡴࡨࡷࡸ࠭ଽ") in options._caps:
-    if options._caps[bstack1l1l_opy_ (u"ࠨࡤࡵࡳࡼࡹࡥࡳࡐࡤࡱࡪ࠭ା")] and options._caps[bstack1l1l_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡑࡥࡲ࡫ࠧି")].lower() != bstack1l1l_opy_ (u"ࠪࡪ࡮ࡸࡥࡧࡱࡻࠫୀ"):
-      del options._caps[bstack1l1l_opy_ (u"ࠫࡲࡵࡺ࠻ࡦࡨࡦࡺ࡭ࡧࡦࡴࡄࡨࡩࡸࡥࡴࡵࠪୁ")]
-def bstack1ll1lllll_opy_(proxy_config):
-  if bstack1l1l_opy_ (u"ࠬ࡮ࡴࡵࡲࡶࡔࡷࡵࡸࡺࠩୂ") in proxy_config:
-    proxy_config[bstack1l1l_opy_ (u"࠭ࡳࡴ࡮ࡓࡶࡴࡾࡹࠨୃ")] = proxy_config[bstack1l1l_opy_ (u"ࠧࡩࡶࡷࡴࡸࡖࡲࡰࡺࡼࠫୄ")]
-    del(proxy_config[bstack1l1l_opy_ (u"ࠨࡪࡷࡸࡵࡹࡐࡳࡱࡻࡽࠬ୅")])
-  if bstack1l1l_opy_ (u"ࠩࡳࡶࡴࡾࡹࡕࡻࡳࡩࠬ୆") in proxy_config and proxy_config[bstack1l1l_opy_ (u"ࠪࡴࡷࡵࡸࡺࡖࡼࡴࡪ࠭େ")].lower() != bstack1l1l_opy_ (u"ࠫࡩ࡯ࡲࡦࡥࡷࠫୈ"):
-    proxy_config[bstack1l1l_opy_ (u"ࠬࡶࡲࡰࡺࡼࡘࡾࡶࡥࠨ୉")] = bstack1l1l_opy_ (u"࠭࡭ࡢࡰࡸࡥࡱ࠭୊")
-  if bstack1l1l_opy_ (u"ࠧࡱࡴࡲࡼࡾࡇࡵࡵࡱࡦࡳࡳ࡬ࡩࡨࡗࡵࡰࠬୋ") in proxy_config:
-    proxy_config[bstack1l1l_opy_ (u"ࠨࡲࡵࡳࡽࡿࡔࡺࡲࡨࠫୌ")] = bstack1l1l_opy_ (u"ࠩࡳࡥࡨ୍࠭")
...
+    proxy_config[bstack111_opy_ (u"ࠨࡲࡵࡳࡽࡿࡔࡺࡲࡨࠫୌ")] = bstack111_opy_ (u"ࠩࡳࡥࡨ୍࠭")
   return proxy_config
-def bstack1ll111ll_opy_(config, proxy):
+def bstack1ll1ll1l_opy_(config, proxy):
   from selenium.webdriver.common.proxy import Proxy
-  if not bstack1l1l_opy_ (u"ࠪࡴࡷࡵࡸࡺࠩ୎") in config:
+  if not bstack111_opy_ (u"ࠪࡴࡷࡵࡸࡺࠩ୎") in config:
     return proxy
-  config[bstack1l1l_opy_ (u"ࠫࡵࡸ࡯ࡹࡻࠪ୏")] = bstack1ll1lllll_opy_(config[bstack1l1l_opy_ (u"ࠬࡶࡲࡰࡺࡼࠫ୐")])
+  config[bstack111_opy_ (u"ࠫࡵࡸ࡯ࡹࡻࠪ୏")] = bstack1l1ll1l1_opy_(config[bstack111_opy_ (u"ࠬࡶࡲࡰࡺࡼࠫ୐")])
   if proxy == None:
-    proxy = Proxy(config[bstack1l1l_opy_ (u"࠭ࡰࡳࡱࡻࡽࠬ୑")])
...
-  if bstack1l1l_opy_ (u"ࠧࡩࡶࡷࡴࡕࡸ࡯ࡹࡻࠪ୒") in CONFIG:
-    return CONFIG[bstack1l1l_opy_ (u"ࠨࡪࡷࡸࡵࡖࡲࡰࡺࡼࠫ୓")]
-  elif bstack1l1l_opy_ (u"ࠩ࡫ࡸࡹࡶࡳࡑࡴࡲࡼࡾ࠭୔") in CONFIG:
-    return CONFIG[bstack1l1l_opy_ (u"ࠪ࡬ࡹࡺࡰࡴࡒࡵࡳࡽࡿࠧ୕")]
...
-    return bstack1lll1ll1l_opy_(self)
-def bstack1l1l1l11l_opy_():
+    return bstack1l1ll111_opy_(self)
+def bstack1ll1l111l_opy_():
   global CONFIG
-  return bstack1l1l_opy_ (u"ࠫ࡭ࡺࡴࡱࡒࡵࡳࡽࡿࠧୖ") in CONFIG or bstack1l1l_opy_ (u"ࠬ࡮ࡴࡵࡲࡶࡔࡷࡵࡸࡺࠩୗ") in CONFIG
...
+  if not bstack1ll1l111l_opy_():
     return
-  if config.get(bstack1l1l_opy_ (u"࠭ࡨࡵࡶࡳࡔࡷࡵࡸࡺࠩ୘")):
-    return config.get(bstack1l1l_opy_ (u"ࠧࡩࡶࡷࡴࡕࡸ࡯ࡹࡻࠪ୙"))
-  if config.get(bstack1l1l_opy_ (u"ࠨࡪࡷࡸࡵࡹࡐࡳࡱࡻࡽࠬ୚")):
-    return config.get(bstack1l1l_opy_ (u"ࠩ࡫ࡸࡹࡶࡳࡑࡴࡲࡼࡾ࠭୛"))
-def bstack11ll1ll1_opy_():
-  return bstack1l1l1l11l_opy_() and bstack1l1ll11_opy_() >= version.parse(bstack1l111l1l_opy_)
-def bstack1llll1l_opy_(config):
-  if bstack1l1l_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵࡗࡹࡧࡣ࡬ࡎࡲࡧࡦࡲࡏࡱࡶ࡬ࡳࡳࡹࠧଡ଼") in config:
-    return config[bstack1l1l_opy_ (u"ࠫࡧࡸ࡯ࡸࡵࡨࡶࡘࡺࡡࡤ࡭ࡏࡳࡨࡧ࡬ࡐࡲࡷ࡭ࡴࡴࡳࠨଢ଼")]
-  if bstack1l1l_opy_ (u"ࠬࡲ࡯ࡤࡣ࡯ࡓࡵࡺࡩࡰࡰࡶࠫ୞") in config:
-    return config[bstack1l1l_opy_ (u"࠭࡬ࡰࡥࡤࡰࡔࡶࡴࡪࡱࡱࡷࠬୟ")]
...
+    return config[bstack111_opy_ (u"࠭࡬ࡰࡥࡤࡰࡔࡶࡴࡪࡱࡱࡷࠬୟ")]
   return {}
-def bstack1l111111_opy_(caps):
-  global bstack1111llll_opy_
-  if bstack1l1l_opy_ (u"ࠧࡣࡵࡷࡥࡨࡱ࠺ࡰࡲࡷ࡭ࡴࡴࡳࠨୠ") in caps:
-    caps[bstack1l1l_opy_ (u"ࠨࡤࡶࡸࡦࡩ࡫࠻ࡱࡳࡸ࡮ࡵ࡮ࡴࠩୡ")][bstack1l1l_opy_ (u"ࠩ࡯ࡳࡨࡧ࡬ࠨୢ")] = True
-    if bstack1111llll_opy_:
-      caps[bstack1l1l_opy_ (u"ࠪࡦࡸࡺࡡࡤ࡭࠽ࡳࡵࡺࡩࡰࡰࡶࠫୣ")][bstack1l1l_opy_ (u"ࠫࡱࡵࡣࡢ࡮ࡌࡨࡪࡴࡴࡪࡨ࡬ࡩࡷ࠭୤")] = bstack1111llll_opy_
...
-    caps[bstack1l1l_opy_ (u"ࠬࡨࡲࡰࡹࡶࡩࡷࡹࡴࡢࡥ࡮࠲ࡱࡵࡣࡢ࡮ࠪ୥")] = True
-    if bstack1111llll_opy_:
-      caps[bstack1l1l_opy_ (u"࠭ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯࠳ࡲ࡯ࡤࡣ࡯ࡍࡩ࡫࡮ࡵ࡫ࡩ࡭ࡪࡸࠧ୦")] = bstack1111llll_opy_
...
+def bstack1l1l1l1_opy_():
   global CONFIG
-  if CONFIG[bstack1l1l_opy_ (u"ࠧࡣࡴࡲࡻࡸ࡫ࡲࡴࡶࡤࡧࡰࡒ࡯ࡤࡣ࡯ࠫ୧")]:
-    bstack111l11ll_opy_ = bstack1llll1l_opy_(CONFIG)
-    bstack11l1111l_opy_(CONFIG[bstack1l1l_opy_ (u"ࠨࡣࡦࡧࡪࡹࡳࡌࡧࡼࠫ୨")], bstack111l11ll_opy_)
-def bstack11l1111l_opy_(key, bstack111l11ll_opy_):
...
+  logger.info(bstack1l11lll1_opy_)
   try:
-    bstack1lll11l11_opy_ = Local()
-    bstack11lll11l_opy_ = {bstack1l1l_opy_ (u"ࠩ࡮ࡩࡾ࠭୩"): key}
-    bstack11lll11l_opy_.update(bstack111l11ll_opy_)
-    logger.debug(bstack11lll1ll_opy_.format(str(bstack11lll11l_opy_)))
-    bstack1lll11l11_opy_.start(**bstack11lll11l_opy_)
-    if bstack1lll11l11_opy_.isRunning():
...
-    bstack1llll1_opy_(bstack1ll111_opy_.format(str(e)))
-def bstack1ll1ll111_opy_():
-  global bstack1lll11l11_opy_
-  if bstack1lll11l11_opy_.isRunning():
-    logger.info(bstack1l11l1_opy_)
-    bstack1lll11l11_opy_.stop()
-  bstack1lll11l11_opy_ = None
-def bstack1lll1ll_opy_():
-  global bstack11l111l_opy_
-  if bstack11l111l_opy_:
-    logger.warning(bstack111l11_opy_.format(str(bstack11l111l_opy_)))
...
-  bstack1l111l_opy_()
-def bstack1ll11l1l_opy_(self, *args):
-  logger.error(bstack1l1ll111l_opy_)
-  bstack1lll1ll_opy_()
...
+  bstack111ll_opy_()
   sys.exit(1)
-def bstack1llll1_opy_(err):
-  logger.critical(bstack1l1ll1lll_opy_.format(str(err)))
-  bstack1l111l_opy_(bstack1l1ll1lll_opy_.format(str(err)))
-  atexit.unregister(bstack1lll1ll_opy_)
...
+  atexit.unregister(bstack111ll_opy_)
   sys.exit(1)
-def bstack11l1l1l_opy_(error, message):
+def bstack1llll111l_opy_(error, message):
   logger.critical(str(error))
   logger.critical(message)
-  bstack1l111l_opy_(message)
-  atexit.unregister(bstack1lll1ll_opy_)
...
-  CONFIG = bstack11l1ll1l_opy_()
-  bstack1llll111_opy_()
-  bstack1llll111l_opy_()
-  CONFIG = bstack11l1l1_opy_(CONFIG)
-  update(CONFIG, bstack1l1l1111l_opy_)
-  update(CONFIG, bstack11llll1_opy_)
-  CONFIG = bstack1ll1l111_opy_(CONFIG)
-  if bstack1l1l_opy_ (u"ࠪࡥࡺࡺ࡯࡮ࡣࡷ࡭ࡴࡴࠧ୪") in CONFIG and str(CONFIG[bstack1l1l_opy_ (u"ࠫࡦࡻࡴࡰ࡯ࡤࡸ࡮ࡵ࡮ࠨ୫")]).lower() == bstack1l1l_opy_ (u"ࠬ࡬ࡡ࡭ࡵࡨࠫ୬"):
-    bstack1llll11ll_opy_ = False
-  if (bstack1l1l_opy_ (u"࠭ࡢࡶ࡫࡯ࡨࡓࡧ࡭ࡦࠩ୭") in CONFIG and bstack1l1l_opy_ (u"ࠧࡣࡷ࡬ࡰࡩࡔࡡ࡮ࡧࠪ୮") in bstack11llll1_opy_) or (bstack1l1l_opy_ (u"ࠨࡤࡸ࡭ࡱࡪࡎࡢ࡯ࡨࠫ୯") in CONFIG and bstack1l1l_opy_ (u"ࠩࡥࡹ࡮ࡲࡤࡏࡣࡰࡩࠬ୰") not in bstack1l1l1111l_opy_):
-    if os.getenv(bstack1l1l_opy_ (u"ࠪࡆࡘ࡚ࡁࡄࡍࡢࡇࡔࡓࡂࡊࡐࡈࡈࡤࡈࡕࡊࡎࡇࡣࡎࡊࠧୱ")):
-      CONFIG[bstack1l1l_opy_ (u"ࠫࡧࡻࡩ࡭ࡦࡌࡨࡪࡴࡴࡪࡨ࡬ࡩࡷ࠭୲")] = os.getenv(bstack1l1l_opy_ (u"ࠬࡈࡓࡕࡃࡆࡏࡤࡉࡏࡎࡄࡌࡒࡊࡊ࡟ࡃࡗࡌࡐࡉࡥࡉࡅࠩ୳"))
+  global bstack1ll1lll_opy_
+  global bstack1l1l111_opy_
...
-      bstack11l11_opy_()
-  elif (bstack1l1l_opy_ (u"࠭ࡢࡶ࡫࡯ࡨࡓࡧ࡭ࡦࠩ୴") not in CONFIG and bstack1l1l_opy_ (u"ࠧࡣࡷ࡬ࡰࡩࡏࡤࡦࡰࡷ࡭࡫࡯ࡥࡳࠩ୵") in CONFIG) or (bstack1l1l_opy_ (u"ࠨࡤࡸ࡭ࡱࡪࡎࡢ࡯ࡨࠫ୶") in bstack1l1l1111l_opy_ and bstack1l1l_opy_ (u"ࠩࡥࡹ࡮ࡲࡤࡏࡣࡰࡩࠬ୷") not in bstack11llll1_opy_):
-    del(CONFIG[bstack1l1l_opy_ (u"ࠪࡦࡺ࡯࡬ࡥࡋࡧࡩࡳࡺࡩࡧ࡫ࡨࡶࠬ୸")])
-  if bstack1l1lll_opy_(CONFIG):
-    bstack1llll1_opy_(bstack1l1l1ll1l_opy_)
-  bstack1ll1lll_opy_()
-  bstack111111l_opy_()
-  if bstack111l1lll_opy_:
-    CONFIG[bstack1l1l_opy_ (u"ࠫࡦࡶࡰࠨ୹")] = bstack1lll1l1_opy_(CONFIG)
-    logger.info(bstack11llllll_opy_.format(CONFIG[bstack1l1l_opy_ (u"ࠬࡧࡰࡱࠩ୺")]))
...
-      bstack11l1l1l_opy_(e, bstack1111l1ll_opy_)
...
-    if os.path.splitext(app)[1] in bstack11l11l1_opy_:
+    if os.path.splitext(app)[1] in bstack1lll111l_opy_:
       if os.path.exists(app):
-        bstack1l1lll1_opy_ = bstack11ll11l_opy_(config, app)
-      elif bstack11llll1l_opy_(app):
-        bstack1l1lll1_opy_ = app
+        bstack1l1lll111_opy_ = bstack1l1lll11_opy_(config, app)
+      elif bstack1ll111_opy_(app):
+        bstack1l1lll111_opy_ = app
       else:
-        bstack1llll1_opy_(bstack1111l_opy_.format(app))
+        bstack11lll1l1_opy_(bstack1l1lll1l1_opy_.format(app))
     else:
-      if bstack11llll1l_opy_(app):
-        bstack1l1lll1_opy_ = app
+      if bstack1ll111_opy_(app):
+        bstack1l1lll111_opy_ = app
       elif os.path.exists(app):
-        bstack1l1lll1_opy_ = bstack11ll11l_opy_(app)
+        bstack1l1lll111_opy_ = bstack1l1lll11_opy_(app)
       else:
-        bstack1llll1_opy_(bstack1l1l11ll_opy_)
+        bstack11lll1l1_opy_(bstack111l11ll_opy_)
   else:
     if len(app) > 2:
-      bstack1llll1_opy_(bstack111l1ll1_opy_)
+      bstack11lll1l1_opy_(bstack111ll1l1_opy_)
     elif len(app) == 2:
-      if bstack1l1l_opy_ (u"ࠩࡳࡥࡹ࡮ࠧ୾") in app and bstack1l1l_opy_ (u"ࠪࡧࡺࡹࡴࡰ࡯ࡢ࡭ࡩ࠭୿") in app:
-        if os.path.exists(app[bstack1l1l_opy_ (u"ࠫࡵࡧࡴࡩࠩ஀")]):
-          bstack1l1lll1_opy_ = bstack11ll11l_opy_(config, app[bstack1l1l_opy_ (u"ࠬࡶࡡࡵࡪࠪ஁")], app[bstack1l1l_opy_ (u"࠭ࡣࡶࡵࡷࡳࡲࡥࡩࡥࠩஂ")])
...
+        bstack11lll1l1_opy_(bstack111ll1l1_opy_)
       ...
       for key in app:
-        if key in bstack1ll1ll1_opy_:
-          if key == bstack1l1l_opy_ (u"ࠧࡱࡣࡷ࡬ࠬஃ"):
+        if key in bstack1l1ll1_opy_:
+          if key == bstack111_opy_ (u"ࠨࡲࡤࡸ࡭࠭஄"):
             if os.path.exists(app[key]):
-              bstack1l1lll1_opy_ = bstack11ll11l_opy_(config, app[key])
+              bstack1l1lll111_opy_ = bstack1l1lll11_opy_(config, app[key])
             else:
-              bstack1llll1_opy_(bstack1111l_opy_.format(app))
+              bstack11lll1l1_opy_(bstack1l1lll1l1_opy_.format(app))
           else:
-            bstack1l1lll1_opy_ = app[key]
+            bstack1l1lll111_opy_ = app[key]
         else:
-          bstack1llll1_opy_(bstack1l1llll11_opy_)
-  return bstack1l1lll1_opy_
-def bstack11llll1l_opy_(bstack1l1lll1_opy_):
+          bstack11lll1l1_opy_(bstack1lll11l1_opy_)
+  return bstack1l1lll111_opy_
+def bstack1ll111_opy_(bstack1l1lll111_opy_):
   import re
-  bstack11111l1l_opy_ = re.compile(bstack1l1l_opy_ (u"ࡳࠤࡡ࡟ࡦ࠳ࡺࡂ࠯࡝࠴࠲࠿࡜ࡠ࠰࡟࠱ࡢ࠰ࠤࠣ஄"))
-  bstack111l1_opy_ = re.compile(bstack1l1l_opy_ (u"ࡴࠥࡢࡠࡧ࠭ࡻࡃ࠰࡞࠵࠳࠹࡝ࡡ࠱ࡠ࠲ࡣࠪ࠰࡝ࡤ࠱ࡿࡇ࡛࠭࠲࠰࠽ࡡࡥ࠮࡝࠯ࡠ࠮ࠩࠨஅ"))
-  if bstack1l1l_opy_ (u"ࠪࡦࡸࡀ࠯࠰ࠩஆ") in bstack1l1lll1_opy_ or re.fullmatch(bstack11111l1l_opy_, bstack1l1lll1_opy_) or re.fullmatch(bstack111l1_opy_, bstack1l1lll1_opy_):
...
+  if bstack111_opy_ (u"ࠫࡧࡹ࠺࠰࠱ࠪஇ") in bstack1l1lll111_opy_ or re.fullmatch(bstack1l11l1l_opy_, bstack1l1lll111_opy_) or re.fullmatch(bstack1l1lll1ll_opy_, bstack1l1lll111_opy_):
     ...
     return False
-def bstack11ll11l_opy_(config, path, bstack1l11lllll_opy_=None):
+def bstack1l1lll11_opy_(config, path, bstack1111l_opy_=None):
   import requests
   from requests_toolbelt.multipart.encoder import MultipartEncoder
   import hashlib
-  md5_hash = hashlib.md5(open(os.path.abspath(path), bstack1l1l_opy_ (u"ࠫࡷࡨࠧஇ")).read()).hexdigest()
-  bstack11l11ll_opy_ = bstack1ll11lll_opy_(md5_hash)
-  bstack1l1lll1_opy_ = None
-  if bstack11l11ll_opy_:
-    logger.info(bstack1lll1ll11_opy_.format(bstack11l11ll_opy_, md5_hash))
-    return bstack11l11ll_opy_
-  bstack11l11lll_opy_ = MultipartEncoder(
...
+  bstack1lll1l111_opy_ = MultipartEncoder(
     fields={
-        bstack1l1l_opy_ (u"ࠬ࡬ࡩ࡭ࡧࠪஈ"): (os.path.basename(path), open(os.path.abspath(path), bstack1l1l_opy_ (u"࠭ࡲࡣࠩஉ")), bstack1l1l_opy_ (u"ࠧࡵࡧࡻࡸ࠴ࡶ࡬ࡢ࡫ࡱࠫஊ")),
-        bstack1l1l_opy_ (u"ࠨࡥࡸࡷࡹࡵ࡭ࡠ࡫ࡧࠫ஋"): bstack1l11lllll_opy_
...
-  response = requests.post(bstack1lll1l1l_opy_, data=bstack11l11lll_opy_,
-                         headers={bstack1l1l_opy_ (u"ࠩࡆࡳࡳࡺࡥ࡯ࡶ࠰ࡘࡾࡶࡥࠨ஌"): bstack11l11lll_opy_.content_type}, auth=(config[bstack1l1l_opy_ (u"ࠪࡹࡸ࡫ࡲࡏࡣࡰࡩࠬ஍")], config[bstack1l1l_opy_ (u"ࠫࡦࡩࡣࡦࡵࡶࡏࡪࡿࠧஎ")]))
...
-    bstack1l1lll1_opy_ = res[bstack1l1l_opy_ (u"ࠬࡧࡰࡱࡡࡸࡶࡱ࠭ஏ")]
-    logger.info(bstack111l111_opy_.format(bstack1l1lll1_opy_))
-    bstack1l1ll1111_opy_(md5_hash, bstack1l1lll1_opy_)
...
-    bstack1llll1_opy_(bstack1l11l11_opy_.format(str(err)))
-  return bstack1l1lll1_opy_
...
-  bstack1l1lll11_opy_ = 0
-  bstack1l1l1l111_opy_ = 1
-  if bstack1l1l_opy_ (u"࠭ࡰࡢࡴࡤࡰࡱ࡫࡬ࡴࡒࡨࡶࡕࡲࡡࡵࡨࡲࡶࡲ࠭ஐ") in CONFIG:
-    bstack1l1l1l111_opy_ = CONFIG[bstack1l1l_opy_ (u"ࠧࡱࡣࡵࡥࡱࡲࡥ࡭ࡵࡓࡩࡷࡖ࡬ࡢࡶࡩࡳࡷࡳࠧ஑")]
-  if bstack1l1l_opy_ (u"ࠨࡲ࡯ࡥࡹ࡬࡯ࡳ࡯ࡶࠫஒ") in CONFIG:
-    bstack1l1lll11_opy_ = len(CONFIG[bstack1l1l_opy_ (u"ࠩࡳࡰࡦࡺࡦࡰࡴࡰࡷࠬஓ")])
-  bstack1llllll11_opy_ = int(bstack1l1l1l111_opy_) * int(bstack1l1lll11_opy_)
-def bstack1ll11lll_opy_(md5_hash):
-  bstack1ll11ll1l_opy_ = os.path.join(os.path.expanduser(bstack1l1l_opy_ (u"ࠪࢂࠬஔ")), bstack1l1l_opy_ (u"ࠫ࠳ࡨࡲࡰࡹࡶࡩࡷࡹࡴࡢࡥ࡮ࠫக"), bstack1l1l_opy_ (u"ࠬࡧࡰࡱࡗࡳࡰࡴࡧࡤࡎࡆ࠸ࡌࡦࡹࡨ࠯࡬ࡶࡳࡳ࠭஖"))
-  if os.path.exists(bstack1ll11ll1l_opy_):
-    bstack1ll1lll11_opy_ = json.load(open(bstack1ll11ll1l_opy_,bstack1l1l_opy_ (u"࠭ࡲࡣࠩ஗")))
-    if md5_hash in bstack1ll1lll11_opy_:
-      bstack1l1l11lll_opy_ = bstack1ll1lll11_opy_[md5_hash]
-      bstack1l11_opy_ = datetime.datetime.now()
-      bstack1lllll11_opy_ = datetime.datetime.strptime(bstack1l1l11lll_opy_[bstack1l1l_opy_ (u"ࠧࡵ࡫ࡰࡩࡸࡺࡡ࡮ࡲࠪ஘")], bstack1l1l_opy_ (u"ࠨࠧࡧ࠳ࠪࡳ࠯࡛ࠦࠣࠩࡍࡀࠥࡎ࠼ࠨࡗࠬங"))
-      if (bstack1l11_opy_ - bstack1lllll11_opy_).days > 60:
...
+      if (bstack1l1l1l11l_opy_ - bstack1111l11_opy_).days > 60:
         return None
-      elif version.parse(str(__version__)) > version.parse(bstack1l1l11lll_opy_[bstack1l1l_opy_ (u"ࠩࡶࡨࡰࡥࡶࡦࡴࡶ࡭ࡴࡴࠧச")]):
+      elif version.parse(str(__version__)) > version.parse(bstack111ll11l_opy_[bstack111_opy_ (u"ࠪࡷࡩࡱ࡟ࡷࡧࡵࡷ࡮ࡵ࡮ࠨ஛")]):
         return None
-      return bstack1l1l11lll_opy_[bstack1l1l_opy_ (u"ࠪ࡭ࡩ࠭஛")]
+      return bstack111ll11l_opy_[bstack111_opy_ (u"ࠫ࡮ࡪࠧஜ")]
   else:
     return None
-def bstack1l1ll1111_opy_(md5_hash, bstack1l1lll1_opy_):
-  bstack11ll111l_opy_ = os.path.join(os.path.expanduser(bstack1l1l_opy_ (u"ࠫࢃ࠭ஜ")), bstack1l1l_opy_ (u"ࠬ࠴ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯ࠬ஝"))
-  if not os.path.exists(bstack11ll111l_opy_):
-    os.makedirs(bstack11ll111l_opy_)
-  bstack1ll11ll1l_opy_ = os.path.join(os.path.expanduser(bstack1l1l_opy_ (u"࠭ࡾࠨஞ")), bstack1l1l_opy_ (u"ࠧ࠯ࡤࡵࡳࡼࡹࡥࡳࡵࡷࡥࡨࡱࠧட"), bstack1l1l_opy_ (u"ࠨࡣࡳࡴ࡚ࡶ࡬ࡰࡣࡧࡑࡉ࠻ࡈࡢࡵ࡫࠲࡯ࡹ࡯࡯ࠩ஠"))
-  bstack1lll1l1ll_opy_ = {
-    bstack1l1l_opy_ (u"ࠩ࡬ࡨࠬ஡"): bstack1l1lll1_opy_,
-    bstack1l1l_opy_ (u"ࠪࡸ࡮ࡳࡥࡴࡶࡤࡱࡵ࠭஢"): datetime.datetime.strftime(datetime.datetime.now(), bstack1l1l_opy_ (u"ࠫࠪࡪ࠯ࠦ࡯࠲ࠩ࡞ࠦࠥࡉ࠼ࠨࡑ࠿ࠫࡓࠨண")),
-    bstack1l1l_opy_ (u"ࠬࡹࡤ࡬ࡡࡹࡩࡷࡹࡩࡰࡰࠪத"): str(__version__)
...
-  bstack1ll1lll11_opy_[md5_hash] = bstack1lll1l1ll_opy_
-  with open(bstack1ll11ll1l_opy_, bstack1l1l_opy_ (u"ࠢࡸ࠭ࠥ஦")) as outfile:
...
+def bstack1llll1ll1_opy_(self):
   return
-def bstack11ll111_opy_(self):
+def bstack11llll_opy_(self):
   from selenium.webdriver.remote.webdriver import WebDriver
   WebDriver.quit(self)
-def bstack111lll_opy_(self, command_executor,
...
-  CONFIG[bstack1l1l_opy_ (u"ࠨࡤࡵࡳࡼࡹࡥࡳࡵࡷࡥࡨࡱࡓࡅࡍࠪ஧")] = str(bstack1l1ll1l1_opy_) + str(__version__)
-  command_executor = bstack1lll1l111_opy_()
-  logger.debug(bstack1l1l11_opy_.format(command_executor))
-  proxy = bstack1ll111ll_opy_(CONFIG, proxy)
-  bstack1ll1l1lll_opy_ = 0 if bstack11lll_opy_ < 0 else bstack11lll_opy_
-  if bstack11l1l1l1_opy_ is True:
-    bstack1ll1l1lll_opy_ = int(threading.current_thread().getName())
-  bstack111l1111_opy_ = bstack1ll1l1ll_opy_(CONFIG, bstack1ll1l1lll_opy_)
-  logger.debug(bstack1l1l11111_opy_.format(str(bstack111l1111_opy_)))
-  if CONFIG[bstack1l1l_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ࡫ࡍࡱࡦࡥࡱ࠭ந")]:
-    bstack1l111111_opy_(bstack111l1111_opy_)
...
-    bstack1l1lll1ll_opy_ = bstack11l1l1_opy_(desired_capabilities)
-    bstack1l1lll1ll_opy_[bstack1l1l_opy_ (u"ࠪࡹࡸ࡫ࡗ࠴ࡅࠪன")] = bstack1l1l1ll_opy_(CONFIG)
-    bstack1llll1ll1_opy_ = bstack1ll1l1ll_opy_(bstack1l1lll1ll_opy_)
-    if bstack1llll1ll1_opy_:
-      bstack111l1111_opy_ = update(bstack1llll1ll1_opy_, bstack111l1111_opy_)
...
+      bstack1lllllll1_opy_ = update(bstack1lllll1l1_opy_, bstack1lllllll1_opy_)
   ...
   if options:
-    bstack111l1ll_opy_(options, bstack111l1111_opy_)
+    bstack1lll111ll_opy_(options, bstack1lllllll1_opy_)
   if not options:
-    options = bstack1lll1ll1_opy_(bstack111l1111_opy_)
-  if options and bstack1l1ll11_opy_() >= version.parse(bstack1l1l_opy_ (u"ࠫ࠸࠴࠸࠯࠲ࠪப")):
...
-      bstack1l1ll11_opy_() < version.parse(bstack1l1l_opy_ (u"ࠬ࠹࠮࠹࠰࠳ࠫ஫")) and not desired_capabilities
+      bstack11l111l_opy_() < version.parse(bstack111_opy_ (u"ࠧ࠴࠰࠻࠲࠵࠭஭")) and not desired_capabilities
   ):
     desired_capabilities = {}
-    desired_capabilities.update(bstack111l1111_opy_)
-  logger.info(bstack1l111ll_opy_)
-  if bstack1l1ll11_opy_() >= version.parse(bstack1l1l_opy_ (u"࠭࠳࠯࠺࠱࠴ࠬ஬")):
...
-  elif bstack1l1ll11_opy_() >= version.parse(bstack1l1l_opy_ (u"ࠧ࠳࠰࠸࠷࠳࠶ࠧ஭")):
-    bstack1l1ll11l_opy_(self, command_executor=command_executor,
...
-  bstack1lll11_opy_ = self.session_id
-  if bstack1l1l_opy_ (u"ࠨࡲ࡯ࡥࡹ࡬࡯ࡳ࡯ࡶࠫம") in CONFIG and bstack1l1l_opy_ (u"ࠩࡶࡩࡸࡹࡩࡰࡰࡑࡥࡲ࡫ࠧய") in CONFIG[bstack1l1l_opy_ (u"ࠪࡴࡱࡧࡴࡧࡱࡵࡱࡸ࠭ர")][bstack1ll1l1lll_opy_]:
-    bstack1l1lll1l1_opy_ = CONFIG[bstack1l1l_opy_ (u"ࠫࡵࡲࡡࡵࡨࡲࡶࡲࡹࠧற")][bstack1ll1l1lll_opy_][bstack1l1l_opy_ (u"ࠬࡹࡥࡴࡵ࡬ࡳࡳࡔࡡ࡮ࡧࠪல")]
-  logger.debug(bstack1111ll11_opy_.format(bstack1lll11_opy_))
...
-    def bstack1111l1l1_opy_(self, args, bufsize=-1, executable=None,
+    def bstack111ll1l_opy_(self, args, bufsize=-1, executable=None,
       ...
       global CONFIG
-      if(bstack1l1l_opy_ (u"ࠨࡩ࡯ࡦࡨࡼ࠳ࡰࡳࠣள") in args[1]):
-        with open(os.path.join(os.path.expanduser(bstack1l1l_opy_ (u"ࠧࡿࠩழ")), bstack1l1l_opy_ (u"ࠨ࠰ࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ࡫ࠨவ"), bstack1l1l_opy_ (u"ࠩ࠱ࡷࡪࡹࡳࡪࡱࡱ࡭ࡩࡹ࠮ࡵࡺࡷࠫஶ")), bstack1l1l_opy_ (u"ࠪࡻࠬஷ")) as fp:
-          fp.write(bstack1l1l_opy_ (u"ࠦࠧஸ"))
-        if(not os.path.exists(os.path.join(os.path.dirname(args[1]), bstack1l1l_opy_ (u"ࠧ࡯࡮ࡥࡧࡻࡣࡧࡹࡴࡢࡥ࡮࠲࡯ࡹࠢஹ")))):
-          with open(args[1], bstack1l1l_opy_ (u"࠭ࡲࠨ஺")) as f:
...
+          with open(args[1], bstack111_opy_ (u"ࠨࡴࠪ஼")) as f:
             lines = f.readlines()
-            index = next((i for i, line in enumerate(lines) if bstack1l1l_opy_ (u"ࠧࡢࡵࡼࡲࡨࠦࡦࡶࡰࡦࡸ࡮ࡵ࡮ࠡࡡࡱࡩࡼࡖࡡࡨࡧࠫࡧࡴࡴࡴࡦࡺࡷ࠰ࠥࡶࡡࡨࡧࠣࡁࠥࡼ࡯ࡪࡦࠣ࠴࠮࠭஻") in line), None)
...
-                lines.insert(index+2, bstack11lll1l1_opy_)
-            lines.insert(1, bstack11111ll_opy_)
+                lines.insert(index+2, bstack1ll11111l_opy_)
+            lines.insert(1, bstack1l1lllll1_opy_)
             f.seek(0)
-            with open(os.path.join(os.path.dirname(args[1]), bstack1l1l_opy_ (u"ࠣ࡫ࡱࡨࡪࡾ࡟ࡣࡵࡷࡥࡨࡱ࠮࡫ࡵࠥ஼")), bstack1l1l_opy_ (u"ࠩࡺࠫ஽")) as bstack1l1ll_opy_:
-              bstack1l1ll_opy_.writelines(lines)
-        CONFIG[bstack1l1l_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵࡷࡹࡧࡣ࡬ࡕࡇࡏࠬா")] = str(bstack1l1ll1l1_opy_) + str(__version__)
-        bstack1ll1l1lll_opy_ = 0 if bstack11lll_opy_ < 0 else bstack11lll_opy_
-        if bstack11l1l1l1_opy_ is True:
-          bstack1ll1l1lll_opy_ = int(threading.current_thread().getName())
-        CONFIG[bstack1l1l_opy_ (u"ࠦࡺࡹࡥࡘ࠵ࡆࠦி")] = False
-        bstack111l1111_opy_ = bstack1ll1l1ll_opy_(CONFIG, bstack1ll1l1lll_opy_)
-        logger.debug(bstack1l1l11111_opy_.format(str(bstack111l1111_opy_)))
-        if bstack1ll1l11_opy_(CONFIG):
-          bstack1l111111_opy_(bstack111l1111_opy_)
-        if bstack1l1l_opy_ (u"ࠬࡶ࡬ࡢࡶࡩࡳࡷࡳࡳࠨீ") in CONFIG and bstack1l1l_opy_ (u"࠭ࡳࡦࡵࡶ࡭ࡴࡴࡎࡢ࡯ࡨࠫு") in CONFIG[bstack1l1l_opy_ (u"ࠧࡱ࡮ࡤࡸ࡫ࡵࡲ࡮ࡵࠪூ")][bstack1ll1l1lll_opy_]:
-          bstack1l1lll1l1_opy_ = CONFIG[bstack1l1l_opy_ (u"ࠨࡲ࡯ࡥࡹ࡬࡯ࡳ࡯ࡶࠫ௃")][bstack1ll1l1lll_opy_][bstack1l1l_opy_ (u"ࠩࡶࡩࡸࡹࡩࡰࡰࡑࡥࡲ࡫ࠧ௄")]
-        args.append(os.path.join(os.path.expanduser(bstack1l1l_opy_ (u"ࠪࢂࠬ௅")), bstack1l1l_opy_ (u"ࠫ࠳ࡨࡲࡰࡹࡶࡩࡷࡹࡴࡢࡥ࡮ࠫெ"), bstack1l1l_opy_ (u"ࠬ࠴ࡳࡦࡵࡶ࡭ࡴࡴࡩࡥࡵ࠱ࡸࡽࡺࠧே")))
...
-        args.append(json.dumps(bstack111l1111_opy_))
-        args[1] = os.path.join(os.path.dirname(args[1]), bstack1l1l_opy_ (u"ࠨࡩ࡯ࡦࡨࡼࡤࡨࡳࡵࡣࡦ࡯࠳ࡰࡳࠣை"))
-      return bstack11ll11l1_opy_(self, args, bufsize=bufsize, executable=executable,
...
-    logger.debug(bstack1lllll111_opy_ + str(e))
...
-    global bstack1l1ll1l1_opy_
-    global bstack1l1ll11l_opy_
-    CONFIG[bstack1l1l_opy_ (u"ࠧࡣࡴࡲࡻࡸ࡫ࡲࡴࡶࡤࡧࡰ࡙ࡄࡌࠩ௉")] = str(bstack1l1ll1l1_opy_) + str(__version__)
-    bstack1ll1l1lll_opy_ = 0 if bstack11lll_opy_ < 0 else bstack11lll_opy_
-    if bstack11l1l1l1_opy_ is True:
-      bstack1ll1l1lll_opy_ = int(threading.current_thread().getName())
-    CONFIG[bstack1l1l_opy_ (u"ࠣࡷࡶࡩ࡜࠹ࡃࠣொ")] = False
-    bstack111l1111_opy_ = bstack1ll1l1ll_opy_(CONFIG, bstack1ll1l1lll_opy_)
-    logger.debug(bstack1l1l11111_opy_.format(str(bstack111l1111_opy_)))
-    if bstack1ll1l11_opy_(CONFIG):
-      bstack1l111111_opy_(bstack111l1111_opy_)
-    if bstack1l1l_opy_ (u"ࠩࡳࡰࡦࡺࡦࡰࡴࡰࡷࠬோ") in CONFIG and bstack1l1l_opy_ (u"ࠪࡷࡪࡹࡳࡪࡱࡱࡒࡦࡳࡥࠨௌ") in CONFIG[bstack1l1l_opy_ (u"ࠫࡵࡲࡡࡵࡨࡲࡶࡲࡹ்ࠧ")][bstack1ll1l1lll_opy_]:
-      bstack1l1lll1l1_opy_ = CONFIG[bstack1l1l_opy_ (u"ࠬࡶ࡬ࡢࡶࡩࡳࡷࡳࡳࠨ௎")][bstack1ll1l1lll_opy_][bstack1l1l_opy_ (u"࠭ࡳࡦࡵࡶ࡭ࡴࡴࡎࡢ࡯ࡨࠫ௏")]
+    global bstack1l11ll_opy_
+    global bstack11llll1_opy_
+    global bstack1l11111l_opy_
+    global bstack1l1l1l1l1_opy_
...
+      bstack1l11111l_opy_ = CONFIG[bstack111_opy_ (u"ࠩࡳࡰࡦࡺࡦࡰࡴࡰࡷࠬ௒")][bstack1ll1l11_opy_][bstack111_opy_ (u"ࠪࡷࡪࡹࡳࡪࡱࡱࡒࡦࡳࡥࠨ௓")]
     import urllib
     import json
-    bstack11111111_opy_ = bstack1l1l_opy_ (u"ࠧࡸࡵࡶ࠾࠴࠵ࡣࡥࡲ࠱ࡦࡷࡵࡷࡴࡧࡵࡷࡹࡧࡣ࡬࠰ࡦࡳࡲ࠵ࡰ࡭ࡣࡼࡻࡷ࡯ࡧࡩࡶࡂࡧࡦࡶࡳ࠾ࠩௐ") + urllib.parse.quote(json.dumps(bstack111l1111_opy_))
-    browser = self.connect(bstack11111111_opy_)
...
-        BrowserType.launch = bstack1llllllll_opy_
...
+        logger.debug(bstack1l11lll1l_opy_ + str(e))
     try:
       import Browser
       from subprocess import Popen
-      Popen.__init__ = bstack1111l1l1_opy_
+      Popen.__init__ = bstack111ll1l_opy_
     except Exception as e:
-      logger.debug(bstack1lllll111_opy_ + str(e))
-def bstack1lll111ll_opy_(context, bstack1l1lllll_opy_):
+      logger.debug(bstack1l11lll1l_opy_ + str(e))
+def bstack11ll1lll_opy_(context, bstack1ll11l11_opy_):
   try:
-    context.page.evaluate(bstack1l1l_opy_ (u"ࠣࡡࠣࡁࡃࠦࡻࡾࠤ௑"), bstack1l1l_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ࡫ࡠࡧࡻࡩࡨࡻࡴࡰࡴ࠽ࠤࢀࠨࡡࡤࡶ࡬ࡳࡳࠨ࠺ࠡࠤࡶࡩࡹ࡙ࡥࡴࡵ࡬ࡳࡳࡔࡡ࡮ࡧࠥ࠰ࠥࠨࡡࡳࡩࡸࡱࡪࡴࡴࡴࠤ࠽ࠤࢀࠨ࡮ࡢ࡯ࡨࠦ࠿࠭௒")+ json.dumps(bstack1l1lllll_opy_) + bstack1l1l_opy_ (u"ࠥࢁࢂࠨ௓"))
...
-    logger.debug(bstack1l1l_opy_ (u"ࠦࡪࡾࡣࡦࡲࡷ࡭ࡴࡴࠠࡪࡰࠣࡴࡱࡧࡹࡸࡴ࡬࡫࡭ࡺࠠࡴࡧࡶࡷ࡮ࡵ࡮ࠡࡰࡤࡱࡪࠦࡻࡾࠤ௔"), e)
-def bstack11ll1_opy_(context, message, level):
+    logger.debug(bstack111_opy_ (u"ࠣࡧࡻࡧࡪࡶࡴࡪࡱࡱࠤ࡮ࡴࠠࡱ࡮ࡤࡽࡼࡸࡩࡨࡪࡷࠤࡸ࡫ࡳࡴ࡫ࡲࡲࠥࡴࡡ࡮ࡧࠣࡿࢂࠨ௘"), e)
+def bstack11111lll_opy_(context, message, level):
   try:
-    context.page.evaluate(bstack1l1l_opy_ (u"ࠧࡥࠠ࠾ࡀࠣࡿࢂࠨ௕"), bstack1l1l_opy_ (u"࠭ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯ࡤ࡫ࡸࡦࡥࡸࡸࡴࡸ࠺ࠡࡽࠥࡥࡨࡺࡩࡰࡰࠥ࠾ࠥࠨࡡ࡯ࡰࡲࡸࡦࡺࡥࠣ࠮ࠣࠦࡦࡸࡧࡶ࡯ࡨࡲࡹࡹࠢ࠻ࠢࡾࠦࡩࡧࡴࡢࠤ࠽ࠫ௖") + json.dumps(message) + bstack1l1l_opy_ (u"ࠧ࠭ࠤ࡯ࡩࡻ࡫࡬ࠣ࠼ࠪௗ") + json.dumps(level) + bstack1l1l_opy_ (u"ࠨࡿࢀࠫ௘"))
...
-    logger.debug(bstack1l1l_opy_ (u"ࠤࡨࡼࡨ࡫ࡰࡵ࡫ࡲࡲࠥ࡯࡮ࠡࡲ࡯ࡥࡾࡽࡲࡪࡩ࡫ࡸࠥࡧ࡮࡯ࡱࡷࡥࡹ࡯࡯࡯ࠢࡾࢁࠧ௙"), e)
-def bstack1l1l11l1_opy_(context, status, message = bstack1l1l_opy_ (u"ࠥࠦ௚")):
...
+def bstack1l1l11111_opy_(context, status, message = bstack111_opy_ (u"ࠢࠣ௞")):
   try:
-    if(status == bstack1l1l_opy_ (u"ࠦ࡫ࡧࡩ࡭ࡧࡧࠦ௛")):
-      context.page.evaluate(bstack1l1l_opy_ (u"ࠧࡥࠠ࠾ࡀࠣࡿࢂࠨ௜"), bstack1l1l_opy_ (u"࠭ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯ࡤ࡫ࡸࡦࡥࡸࡸࡴࡸ࠺ࠡࡽࠥࡥࡨࡺࡩࡰࡰࠥ࠾ࠥࠨࡳࡦࡶࡖࡩࡸࡹࡩࡰࡰࡖࡸࡦࡺࡵࡴࠤ࠯ࠤࠧࡧࡲࡨࡷࡰࡩࡳࡺࡳࠣ࠼ࠣࡿࠧࡸࡥࡢࡵࡲࡲࠧࡀࠧ௝") + json.dumps(bstack1l1l_opy_ (u"ࠢࡔࡥࡨࡲࡦࡸࡩࡰࠢࡩࡥ࡮ࡲࡥࡥࠢࡺ࡭ࡹ࡮࠺ࠡࠤ௞") + str(message)) + bstack1l1l_opy_ (u"ࠨ࠮ࠥࡷࡹࡧࡴࡶࡵࠥ࠾ࠬ௟") + json.dumps(status) + bstack1l1l_opy_ (u"ࠤࢀࢁࠧ௠"))
...
-      context.page.evaluate(bstack1l1l_opy_ (u"ࠥࡣࠥࡃ࠾ࠡࡽࢀࠦ௡"), bstack1l1l_opy_ (u"ࠫࡧࡸ࡯ࡸࡵࡨࡶࡸࡺࡡࡤ࡭ࡢࡩࡽ࡫ࡣࡶࡶࡲࡶ࠿ࠦࡻࠣࡣࡦࡸ࡮ࡵ࡮ࠣ࠼ࠣࠦࡸ࡫ࡴࡔࡧࡶࡷ࡮ࡵ࡮ࡔࡶࡤࡸࡺࡹࠢ࠭ࠢࠥࡥࡷ࡭ࡵ࡮ࡧࡱࡸࡸࠨ࠺ࠡࡽࠥࡷࡹࡧࡴࡶࡵࠥ࠾ࠬ௢") + json.dumps(status) + bstack1l1l_opy_ (u"ࠧࢃࡽࠣ௣"))
...
-    logger.debug(bstack1l1l_opy_ (u"ࠨࡥࡹࡥࡨࡴࡹ࡯࡯࡯ࠢ࡬ࡲࠥࡶ࡬ࡢࡻࡺࡶ࡮࡭ࡨࡵࠢࡶࡩࡹࠦࡳࡦࡵࡶ࡭ࡴࡴࠠࡴࡶࡤࡸࡺࡹࠠࡼࡿࠥ௤"), e)
-def bstack1lll1l_opy_(self, url):
...
+  global bstack111l111l_opy_
   try:
-    bstack1l1l11l1l_opy_(url)
+    bstack1l1ll11l1_opy_(url)
   except Exception as err:
-    logger.debug(bstack1l11lll_opy_.format(str(err)))
-  bstack1ll11l1_opy_(self, url)
-def bstack11l1ll_opy_(self, test):
...
+  global bstack1l1l11ll_opy_
   try:
-    if not bstack1lll11_opy_:
-      with open(os.path.join(os.path.expanduser(bstack1l1l_opy_ (u"ࠧࡿࠩ௥")), bstack1l1l_opy_ (u"ࠨ࠰ࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ࡫ࠨ௦"), bstack1l1l_opy_ (u"ࠩ࠱ࡷࡪࡹࡳࡪࡱࡱ࡭ࡩࡹ࠮ࡵࡺࡷࠫ௧"))) as f:
-        bstack1llll1l1l_opy_ = json.loads(bstack1l1l_opy_ (u"ࠥࡿࠧ௨") + f.read().strip() + bstack1l1l_opy_ (u"ࠫࠧࡾࠢ࠻ࠢࠥࡽࠧ࠭௩") + bstack1l1l_opy_ (u"ࠧࢃࠢ௪"))
-        bstack1lll11_opy_ = bstack1llll1l1l_opy_[str(threading.get_ident())]
...
+      bstack1lll11lll_opy_ = None
       if test:
-        bstack1ll11ll_opy_ = str(test.data)
-      if bstack1ll11ll_opy_ and not bstack1l1lll1l1_opy_:
-        data[bstack1l1l_opy_ (u"࠭࡮ࡢ࡯ࡨࠫ௫")] = bstack1ll11ll_opy_
-      if bstack11l1l1ll_opy_:
-        if bstack11l1l1ll_opy_.status == bstack1l1l_opy_ (u"ࠧࡑࡃࡖࡗࠬ௬"):
-          data[bstack1l1l_opy_ (u"ࠨࡵࡷࡥࡹࡻࡳࠨ௭")] = bstack1l1l_opy_ (u"ࠩࡳࡥࡸࡹࡥࡥࠩ௮")
-        elif bstack11l1l1ll_opy_.status == bstack1l1l_opy_ (u"ࠪࡊࡆࡏࡌࠨ௯"):
-          data[bstack1l1l_opy_ (u"ࠫࡸࡺࡡࡵࡷࡶࠫ௰")] = bstack1l1l_opy_ (u"ࠬ࡬ࡡࡪ࡮ࡨࡨࠬ௱")
-          if bstack11l1l1ll_opy_.message:
-            data[bstack1l1l_opy_ (u"࠭ࡲࡦࡣࡶࡳࡳ࠭௲")] = str(bstack11l1l1ll_opy_.message)
-      user = CONFIG[bstack1l1l_opy_ (u"ࠧࡶࡵࡨࡶࡓࡧ࡭ࡦࠩ௳")]
-      key = CONFIG[bstack1l1l_opy_ (u"ࠨࡣࡦࡧࡪࡹࡳࡌࡧࡼࠫ௴")]
-      url = bstack1l1l_opy_ (u"ࠩ࡫ࡸࡹࡶࡳ࠻࠱࠲ࡿࢂࡀࡻࡾࡂࡤࡴ࡮࠴ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯࠳ࡩ࡯࡮࠱ࡤࡹࡹࡵ࡭ࡢࡶࡨ࠳ࡸ࡫ࡳࡴ࡫ࡲࡲࡸ࠵ࡻࡾ࠰࡭ࡷࡴࡴࠧ௵").format(user, key, bstack1lll11_opy_)
...
+      url = bstack111_opy_ (u"ࠩ࡫ࡸࡹࡶࡳ࠻࠱࠲ࡿࢂࡀࡻࡾࡂࡤࡴ࡮࠴ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯࠳ࡩ࡯࡮࠱ࡤࡹࡹࡵ࡭ࡢࡶࡨ࠳ࡸ࡫ࡳࡴ࡫ࡲࡲࡸ࠵ࡻࡾ࠰࡭ࡷࡴࡴࠧ௼").format(user, key, bstack1l11ll_opy_)
       headers = {
-        bstack1l1l_opy_ (u"ࠪࡇࡴࡴࡴࡦࡰࡷ࠱ࡹࡿࡰࡦࠩ௶"): bstack1l1l_opy_ (u"ࠫࡦࡶࡰ࡭࡫ࡦࡥࡹ࡯࡯࡯࠱࡭ࡷࡴࡴࠧ௷"),
...
-  bstack11l11ll1_opy_(self, test)
-def bstack11ll1l1_opy_(self, parent, test, skip_on_failure=None, rpa=False):
-  global bstack1lll11l_opy_
-  bstack1lll11l_opy_(self, parent, test, skip_on_failure=skip_on_failure, rpa=rpa)
-  global bstack11l1l1ll_opy_
-  bstack11l1l1ll_opy_ = self._test
-def bstack1l1llll1l_opy_(outs_dir, options, tests_root_name, stats, copied_artifacts, outputfile=None):
...
-  outputfile = outputfile or options.get(bstack1l1l_opy_ (u"ࠧࡵࡵࡵࡲࡸࡸࠧ௸"), bstack1l1l_opy_ (u"ࠨ࡯ࡶࡶࡳࡹࡹ࠴ࡸ࡮࡮ࠥ௹"))
+  outputfile = outputfile or options.get(bstack111_opy_ (u"ࠧࡵࡵࡵࡲࡸࡸࠧ௿"), bstack111_opy_ (u"ࠨ࡯ࡶࡶࡳࡹࡹ࠴ࡸ࡮࡮ࠥఀ"))
   output_path = os.path.abspath(
-    os.path.join(options.get(bstack1l1l_opy_ (u"ࠢࡰࡷࡷࡴࡺࡺࡤࡪࡴࠥ௺"), bstack1l1l_opy_ (u"ࠣ࠰ࠥ௻")), outputfile)
+    os.path.join(options.get(bstack111_opy_ (u"ࠢࡰࡷࡷࡴࡺࡺࡤࡪࡴࠥఁ"), bstack111_opy_ (u"ࠣ࠰ࠥం")), outputfile)
   )
-  files = sorted(pabot.glob(os.path.join(pabot._glob_escape(outs_dir), bstack1l1l_opy_ (u"ࠤ࠭࠲ࡽࡳ࡬ࠣ௼"))))
+  files = sorted(pabot.glob(os.path.join(pabot._glob_escape(outs_dir), bstack111_opy_ (u"ࠤ࠭࠲ࡽࡳ࡬ࠣః"))))
   if not files:
-    pabot._write(bstack1l1l_opy_ (u"࡛ࠪࡆࡘࡎ࠻ࠢࡑࡳࠥࡵࡵࡵࡲࡸࡸࠥ࡬ࡩ࡭ࡧࡶࠤ࡮ࡴࠠࠣࠧࡶࠦࠬ௽") % outs_dir, pabot.Color.YELLOW)
-    return bstack1l1l_opy_ (u"ࠦࠧ௾")
...
+    return bstack111_opy_ (u"ࠦࠧఅ")
   ...
   return output_path
-def bstack1l1llllll_opy_(outs_dir, pabot_args, options, start_time_string, tests_root_name):
+def bstack11lll11_opy_(outs_dir, pabot_args, options, start_time_string, tests_root_name):
   from pabot import pabot
   from robot import __version__ as ROBOT_VERSION
   from robot import rebot
-  if bstack1l1l_opy_ (u"ࠧࡶࡹࡵࡪࡲࡲࡵࡧࡴࡩࠤ௿") in options:
-    del options[bstack1l1l_opy_ (u"ࠨࡰࡺࡶ࡫ࡳࡳࡶࡡࡵࡪࠥఀ")]
-  if ROBOT_VERSION < bstack1l1l_opy_ (u"ࠢ࠵࠰࠳ࠦఁ"):
...
+  if ROBOT_VERSION < bstack111_opy_ (u"ࠢ࠵࠰࠳ࠦఈ"):
     stats = {
-      bstack1l1l_opy_ (u"ࠣࡥࡵ࡭ࡹ࡯ࡣࡢ࡮ࠥం"): {bstack1l1l_opy_ (u"ࠤࡷࡳࡹࡧ࡬ࠣః"): 0, bstack1l1l_opy_ (u"ࠥࡴࡦࡹࡳࡦࡦࠥఄ"): 0, bstack1l1l_opy_ (u"ࠦ࡫ࡧࡩ࡭ࡧࡧࠦఅ"): 0},
-      bstack1l1l_opy_ (u"ࠧࡧ࡬࡭ࠤఆ"): {bstack1l1l_opy_ (u"ࠨࡴࡰࡶࡤࡰࠧఇ"): 0, bstack1l1l_opy_ (u"ࠢࡱࡣࡶࡷࡪࡪࠢఈ"): 0, bstack1l1l_opy_ (u"ࠣࡨࡤ࡭ࡱ࡫ࡤࠣఉ"): 0},
...
+          os.path.join(outs_dir, str(index)+ bstack111_opy_ (u"ࠥ࠳ࠧఙ")),
           ...
           stats,
           copied_artifacts,
-          outputfile=os.path.join(bstack1l1l_opy_ (u"ࠦࡵࡧࡢࡰࡶࡢࡶࡪࡹࡵ࡭ࡶࡶࠦఓ"), bstack1l1l_opy_ (u"ࠧࡵࡵࡵࡲࡸࡸࠪࡹ࠮ࡹ࡯࡯ࠦఔ") % index),
+          outputfile=os.path.join(bstack111_opy_ (u"ࠦࡵࡧࡢࡰࡶࡢࡶࡪࡹࡵ࡭ࡶࡶࠦచ"), bstack111_opy_ (u"ࠧࡵࡵࡵࡲࡸࡸࠪࡹ࠮ࡹ࡯࡯ࠦఛ") % index),
         )
       ]
-    if bstack1l1l_opy_ (u"ࠨ࡯ࡶࡶࡳࡹࡹࠨక") not in options:
-      options[bstack1l1l_opy_ (u"ࠢࡰࡷࡷࡴࡺࡺࠢఖ")] = bstack1l1l_opy_ (u"ࠣࡱࡸࡸࡵࡻࡴ࠯ࡺࡰࡰࠧగ")
...
-def bstack111ll1ll_opy_(self, ff_profile_dir):
-  global bstack1ll1l1111_opy_
+def bstack11lll1_opy_(self, ff_profile_dir):
+  global bstack1l1ll1l11_opy_
   if not ff_profile_dir:
     return None
-  return bstack1ll1l1111_opy_(self, ff_profile_dir)
-def bstack11l1ll11_opy_(datasources, opts_for_run, outs_dir, pabot_args, suite_group):
...
-  global bstack1111llll_opy_
-  bstack1ll1l1l_opy_ = []
-  if bstack1l1l_opy_ (u"ࠩࡳࡰࡦࡺࡦࡰࡴࡰࡷࠬఘ") in CONFIG:
-    bstack1ll1l1l_opy_ = CONFIG[bstack1l1l_opy_ (u"ࠪࡴࡱࡧࡴࡧࡱࡵࡱࡸ࠭ఙ")]
-  bstack1111l111_opy_ = len(suite_group) * len(pabot_args[bstack1l1l_opy_ (u"ࠦࡦࡸࡧࡶ࡯ࡨࡲࡹ࡬ࡩ࡭ࡧࡶࠦచ")] or [(bstack1l1l_opy_ (u"ࠧࠨఛ"), None)]) * len(bstack1ll1l1l_opy_)
-  pabot_args[bstack1l1l_opy_ (u"ࠨࡂࡔࡖࡄࡇࡐࡥࡐࡂࡔࡄࡐࡑࡋࡌࡠࡔࡘࡒࠧజ")] = []
-  for q in range(bstack1111l111_opy_):
-    pabot_args[bstack1l1l_opy_ (u"ࠢࡃࡕࡗࡅࡈࡑ࡟ࡑࡃࡕࡅࡑࡒࡅࡍࡡࡕ࡙ࡓࠨఝ")].append(str(q))
+  global bstack1llll1l11_opy_
+  bstack1l1ll11l_opy_ = []
...
+    pabot_args[bstack111_opy_ (u"ࠢࡃࡕࡗࡅࡈࡑ࡟ࡑࡃࡕࡅࡑࡒࡅࡍࡡࡕ࡙ࡓࠨత")].append(str(q))
   return [
     QueueItem(
       ...
       opts_for_run,
       suite,
-      pabot_args[bstack1l1l_opy_ (u"ࠣࡥࡲࡱࡲࡧ࡮ࡥࠤఞ")],
-      pabot_args[bstack1l1l_opy_ (u"ࠤࡹࡩࡷࡨ࡯ࡴࡧࠥట")],
+      pabot_args[bstack111_opy_ (u"ࠣࡥࡲࡱࡲࡧ࡮ࡥࠤథ")],
+      pabot_args[bstack111_opy_ (u"ࠤࡹࡩࡷࡨ࡯ࡴࡧࠥద")],
       argfile,
-      pabot_args.get(bstack1l1l_opy_ (u"ࠥ࡬࡮ࡼࡥࠣఠ")),
-      pabot_args[bstack1l1l_opy_ (u"ࠦࡵࡸ࡯ࡤࡧࡶࡷࡪࡹࠢడ")],
...
-    for argfile in pabot_args[bstack1l1l_opy_ (u"ࠧࡧࡲࡨࡷࡰࡩࡳࡺࡦࡪ࡮ࡨࡷࠧఢ")] or [(bstack1l1l_opy_ (u"ࠨࠢణ"), None)]
-    for platform in enumerate(bstack1ll1l1l_opy_)
...
-def bstack1llll1l1_opy_(self, datasources, outs_dir, options,
+def bstack1l1ll1111_opy_(self, datasources, outs_dir, options,
   execution_item, command, verbose, argfile,
-  hive=None, processes=0,platform_index=0,bstack1ll11l11l_opy_=bstack1l1l_opy_ (u"ࠧࠨత")):
-  global bstack1l1111l_opy_
+  hive=None, processes=0,platform_index=0,bstack1ll11l111_opy_=bstack111_opy_ (u"ࠧࠨఫ")):
+  global bstack1ll1ll1_opy_
   self.platform_index = platform_index
-  self.bstack11111l1_opy_ = bstack1ll11l11l_opy_
...
-def bstack11l111l1_opy_(caller_id, datasources, is_last, item, outs_dir):
-  global bstack11l1l111_opy_
-  global bstack1l1ll1ll_opy_
-  if not bstack1l1l_opy_ (u"ࠨࡸࡤࡶ࡮ࡧࡢ࡭ࡧࠪథ") in item.options:
-    item.options[bstack1l1l_opy_ (u"ࠩࡹࡥࡷ࡯ࡡࡣ࡮ࡨࠫద")] = []
-  for v in item.options[bstack1l1l_opy_ (u"ࠪࡺࡦࡸࡩࡢࡤ࡯ࡩࠬధ")]:
-    if bstack1l1l_opy_ (u"ࠫࡇ࡙ࡔࡂࡅࡎࡔࡑࡇࡔࡇࡑࡕࡑࡎࡔࡄࡆ࡚ࠪన") in v:
-      item.options[bstack1l1l_opy_ (u"ࠬࡼࡡࡳ࡫ࡤࡦࡱ࡫ࠧ఩")].remove(v)
-    if bstack1l1l_opy_ (u"࠭ࡂࡔࡖࡄࡇࡐࡉࡌࡊࡃࡕࡋࡘ࠭ప") in v:
-      item.options[bstack1l1l_opy_ (u"ࠧࡷࡣࡵ࡭ࡦࡨ࡬ࡦࠩఫ")].remove(v)
-  item.options[bstack1l1l_opy_ (u"ࠨࡸࡤࡶ࡮ࡧࡢ࡭ࡧࠪబ")].insert(0, bstack1l1l_opy_ (u"ࠩࡅࡗ࡙ࡇࡃࡌࡒࡏࡅ࡙ࡌࡏࡓࡏࡌࡒࡉࡋࡘ࠻ࡽࢀࠫభ").format(item.platform_index))
-  item.options[bstack1l1l_opy_ (u"ࠪࡺࡦࡸࡩࡢࡤ࡯ࡩࠬమ")].insert(0, bstack1l1l_opy_ (u"ࠫࡇ࡙ࡔࡂࡅࡎࡈࡊࡌࡌࡐࡅࡄࡐࡎࡊࡅࡏࡖࡌࡊࡎࡋࡒ࠻ࡽࢀࠫయ").format(item.bstack11111l1_opy_))
-  if bstack1l1ll1ll_opy_:
-    item.options[bstack1l1l_opy_ (u"ࠬࡼࡡࡳ࡫ࡤࡦࡱ࡫ࠧర")].insert(0, bstack1l1l_opy_ (u"࠭ࡂࡔࡖࡄࡇࡐࡉࡌࡊࡃࡕࡋࡘࡀࡻࡾࠩఱ").format(bstack1l1ll1ll_opy_))
-  return bstack11l1l111_opy_(caller_id, datasources, is_last, item, outs_dir)
-def bstack11l1lll1_opy_(command):
-  global bstack1l1ll1ll_opy_
-  if bstack1l1ll1ll_opy_:
-    command[0] = command[0].replace(bstack1l1l_opy_ (u"ࠧࡳࡱࡥࡳࡹ࠭ల"), bstack1l1l_opy_ (u"ࠨࡤࡵࡳࡼࡹࡥࡳࡵࡷࡥࡨࡱ࠭ࡴࡦ࡮ࠤࡷࡵࡢࡰࡶ࠰࡭ࡳࡺࡥࡳࡰࡤࡰࠥ࠭ళ") + bstack1l1ll1ll_opy_, 1)
...
-    command[0] = command[0].replace(bstack1l1l_opy_ (u"ࠩࡵࡳࡧࡵࡴࠨఴ"), bstack1l1l_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵࡷࡹࡧࡣ࡬࠯ࡶࡨࡰࠦࡲࡰࡤࡲࡸ࠲࡯࡮ࡵࡧࡵࡲࡦࡲࠧవ"), 1)
-def bstack1l1l1111_opy_(command, stderr, stdout, item_name, verbose, pool_id, item_index):
-  global bstack1ll11111l_opy_
-  bstack11l1lll1_opy_(command)
-  return bstack1ll11111l_opy_(command, stderr, stdout, item_name, verbose, pool_id, item_index)
-def bstack111l1l11_opy_(command, stderr, stdout, item_name, verbose, pool_id, item_index, outs_dir):
-  global bstack1ll11111l_opy_
-  bstack11l1lll1_opy_(command)
-  return bstack1ll11111l_opy_(command, stderr, stdout, item_name, verbose, pool_id, item_index, outs_dir)
-def bstack1l11111_opy_(self, runner, quiet=False, capture=True):
-  global bstack1ll1lll1l_opy_
-  bstack111l_opy_ = bstack1ll1lll1l_opy_(self, runner, quiet=False, capture=True)
...
+  bstack11l11l1_opy_ = bstack1llll1lll_opy_(self, runner, quiet=False, capture=True)
   if self.exception:
-    if not hasattr(runner, bstack1l1l_opy_ (u"ࠫࡪࡾࡣࡦࡲࡷ࡭ࡴࡴ࡟ࡢࡴࡵࠫశ")):
+    if not hasattr(runner, bstack111_opy_ (u"ࠫࡪࡾࡣࡦࡲࡷ࡭ࡴࡴ࡟ࡢࡴࡵࠫఽ")):
       runner.exception_arr = []
-    if not hasattr(runner, bstack1l1l_opy_ (u"ࠬ࡫ࡸࡤࡡࡷࡶࡦࡩࡥࡣࡣࡦ࡯ࡤࡧࡲࡳࠩష")):
...
-def bstack11ll1lll_opy_(self, name, context, *args):
-  global bstack1lllll1l1_opy_
-  if name in [bstack1l1l_opy_ (u"࠭ࡢࡦࡨࡲࡶࡪࡥࡦࡦࡣࡷࡹࡷ࡫ࠧస"), bstack1l1l_opy_ (u"ࠧࡣࡧࡩࡳࡷ࡫࡟ࡴࡥࡨࡲࡦࡸࡩࡰࠩహ")]:
-    bstack1lllll1l1_opy_(self, name, context, *args)
-  if name == bstack1l1l_opy_ (u"ࠨࡤࡨࡪࡴࡸࡥࡠࡨࡨࡥࡹࡻࡲࡦࠩ఺"):
-    try:
-      bstack1l1lllll_opy_ = str(self.feature.name)
-      bstack1lll111ll_opy_(context, bstack1l1lllll_opy_)
-      context.browser.execute_script(bstack1l1l_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ࡫ࡠࡧࡻࡩࡨࡻࡴࡰࡴ࠽ࠤࢀࠨࡡࡤࡶ࡬ࡳࡳࠨ࠺ࠡࠤࡶࡩࡹ࡙ࡥࡴࡵ࡬ࡳࡳࡔࡡ࡮ࡧࠥ࠰ࠥࠨࡡࡳࡩࡸࡱࡪࡴࡴࡴࠤ࠽ࠤࢀࠨ࡮ࡢ࡯ࡨࠦ࠿ࠦࠧ఻") + json.dumps(bstack1l1lllll_opy_) + bstack1l1l_opy_ (u"ࠪࢁࢂ఼࠭"))
...
-      logger.debug(bstack1l1l_opy_ (u"ࠫࡋࡧࡩ࡭ࡧࡧࠤࡹࡵࠠࡴࡧࡷࠤࡸ࡫ࡳࡴ࡫ࡲࡲࠥࡴࡡ࡮ࡧࠣ࡭ࡳࠦࡢࡦࡨࡲࡶࡪࠦࡦࡦࡣࡷࡹࡷ࡫࠺ࠡࡽࢀࠫఽ").format(str(e)))
-  if name == bstack1l1l_opy_ (u"ࠬࡨࡥࡧࡱࡵࡩࡤࡹࡣࡦࡰࡤࡶ࡮ࡵࠧా"):
...
+  if name == bstack111_opy_ (u"ࠬࡨࡥࡧࡱࡵࡩࡤࡹࡣࡦࡰࡤࡶ࡮ࡵࠧ౅"):
     try:
-      if not hasattr(self, bstack1l1l_opy_ (u"࠭ࡤࡳ࡫ࡹࡩࡷࡥࡢࡦࡨࡲࡶࡪࡥࡳࡤࡧࡱࡥࡷ࡯࡯ࠨి")):
+      if not hasattr(self, bstack111_opy_ (u"࠭ࡤࡳ࡫ࡹࡩࡷࡥࡢࡦࡨࡲࡶࡪࡥࡳࡤࡧࡱࡥࡷ࡯࡯ࠨె")):
         self.driver_before_scenario = True
-      bstack1ll11ll11_opy_ = args[0].name
-      bstack1l1l111l_opy_ = bstack1l1lllll_opy_ = str(self.feature.name)
-      bstack1l1lllll_opy_ = bstack1l1l111l_opy_ + bstack1l1l_opy_ (u"ࠧࠡ࠯ࠣࠫీ") + bstack1ll11ll11_opy_
...
-        bstack1lll111ll_opy_(context, bstack1l1lllll_opy_)
-        context.browser.execute_script(bstack1l1l_opy_ (u"ࠨࡤࡵࡳࡼࡹࡥࡳࡵࡷࡥࡨࡱ࡟ࡦࡺࡨࡧࡺࡺ࡯ࡳ࠼ࠣࡿࠧࡧࡣࡵ࡫ࡲࡲࠧࡀࠠࠣࡵࡨࡸࡘ࡫ࡳࡴ࡫ࡲࡲࡓࡧ࡭ࡦࠤ࠯ࠤࠧࡧࡲࡨࡷࡰࡩࡳࡺࡳࠣ࠼ࠣࡿࠧࡴࡡ࡮ࡧࠥ࠾ࠥ࠭ు") + json.dumps(bstack1l1lllll_opy_) + bstack1l1l_opy_ (u"ࠩࢀࢁࠬూ"))
+        bstack11ll1lll_opy_(context, bstack1ll11l11_opy_)
...
-      logger.debug(bstack1l1l_opy_ (u"ࠪࡊࡦ࡯࡬ࡦࡦࠣࡸࡴࠦࡳࡦࡶࠣࡷࡪࡹࡳࡪࡱࡱࠤࡳࡧ࡭ࡦࠢ࡬ࡲࠥࡨࡥࡧࡱࡵࡩࠥࡹࡣࡦࡰࡤࡶ࡮ࡵ࠺ࠡࡽࢀࠫృ").format(str(e)))
-  if name == bstack1l1l_opy_ (u"ࠫࡦ࡬ࡴࡦࡴࡢࡷࡨ࡫࡮ࡢࡴ࡬ࡳࠬౄ"):
...
+  if name == bstack111_opy_ (u"ࠫࡦ࡬ࡴࡦࡴࡢࡷࡨ࡫࡮ࡢࡴ࡬ࡳࠬో"):
     try:
-      bstack1lll1l1l1_opy_ = args[0].status.name
-      if str(bstack1lll1l1l1_opy_).lower() == bstack1l1l_opy_ (u"ࠬ࡬ࡡࡪ࡮ࡨࡨࠬ౅"):
-        bstack1lll11l1l_opy_ = bstack1l1l_opy_ (u"࠭ࠧె")
-        bstack11lll11_opy_ = bstack1l1l_opy_ (u"ࠧࠨే")
-        bstack111ll111_opy_ = bstack1l1l_opy_ (u"ࠨࠩై")
...
+        bstack1lll1ll1l_opy_ = bstack111_opy_ (u"ࠨࠩ౏")
         try:
           import traceback
-          bstack1lll11l1l_opy_ = self.exception.__class__.__name__
-          bstack1ll11ll1_opy_ = traceback.format_tb(self.exc_traceback)
-          bstack11lll11_opy_ = bstack1l1l_opy_ (u"ࠩࠣࠫ౉").join(bstack1ll11ll1_opy_)
-          bstack111ll111_opy_ = bstack1ll11ll1_opy_[-1]
...
-          logger.debug(bstack1l1l1_opy_.format(str(e)))
-        bstack1lll11l1l_opy_ += bstack111ll111_opy_
-        bstack11ll1_opy_(context, json.dumps(str(args[0].name) + bstack1l1l_opy_ (u"ࠥࠤ࠲ࠦࡆࡢ࡫࡯ࡩࡩࠧ࡜࡯ࠤొ") + str(bstack11lll11_opy_)), bstack1l1l_opy_ (u"ࠦࡪࡸࡲࡰࡴࠥో"))
...
+        bstack11111lll_opy_(context, json.dumps(str(args[0].name) + bstack111_opy_ (u"ࠥࠤ࠲ࠦࡆࡢ࡫࡯ࡩࡩࠧ࡜࡯ࠤ౑") + str(bstack1ll1l1l11_opy_)), bstack111_opy_ (u"ࠦࡪࡸࡲࡰࡴࠥ౒"))
         if self.driver_before_scenario:
-          bstack1l1l11l1_opy_(context, bstack1l1l_opy_ (u"ࠧ࡬ࡡࡪ࡮ࡨࡨࠧౌ"), bstack1lll11l1l_opy_)
-        context.browser.execute_script(bstack1l1l_opy_ (u"࠭ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯ࡤ࡫ࡸࡦࡥࡸࡸࡴࡸ࠺ࠡࡽࠥࡥࡨࡺࡩࡰࡰࠥ࠾ࠥࠨࡡ࡯ࡰࡲࡸࡦࡺࡥࠣ࠮ࠣࠦࡦࡸࡧࡶ࡯ࡨࡲࡹࡹࠢ࠻ࠢࡾࠦࡩࡧࡴࡢࠤ࠽్ࠫ") + json.dumps(str(args[0].name) + bstack1l1l_opy_ (u"ࠢࠡ࠯ࠣࡊࡦ࡯࡬ࡦࡦࠤࡠࡳࠨ౎") + str(bstack11lll11_opy_)) + bstack1l1l_opy_ (u"ࠨ࠮ࠣࠦࡱ࡫ࡶࡦ࡮ࠥ࠾ࠥࠨࡥࡳࡴࡲࡶࠧࢃࡽࠨ౏"))
...
+        context.browser.execute_script(bstack111_opy_ (u"࠭ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯ࡤ࡫ࡸࡦࡥࡸࡸࡴࡸ࠺ࠡࡽࠥࡥࡨࡺࡩࡰࡰࠥ࠾ࠥࠨࡡ࡯ࡰࡲࡸࡦࡺࡥࠣ࠮ࠣࠦࡦࡸࡧࡶ࡯ࡨࡲࡹࡹࠢ࠻ࠢࡾࠦࡩࡧࡴࡢࠤ࠽ࠫ౔") + json.dumps(str(args[0].name) + bstack111_opy_ (u"ࠢࠡ࠯ࠣࡊࡦ࡯࡬ࡦࡦࠤࡠࡳࠨౕ") + str(bstack1ll1l1l11_opy_)) + bstack111_opy_ (u"ࠨ࠮ࠣࠦࡱ࡫ࡶࡦ࡮ࠥ࠾ࠥࠨࡥࡳࡴࡲࡶࠧࢃࡽࠨౖ"))
         if self.driver_before_scenario:
-          context.browser.execute_script(bstack1l1l_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ�
         if self.driver_before_scenario:
-          context.browser.execute_script(bstack1l1l_opy_ (u"ࠫࡧࡸ࡯ࡸࡵࡨࡶࡸࡺࡡࡤ࡭ࡢࡩࡽ࡫ࡣࡶࡶࡲࡶ࠿ࠦࡻࠣࡣࡦࡸ࡮ࡵ࡮ࠣ࠼ࠣࠦࡸ࡫ࡴࡔࡧࡶࡷ࡮ࡵ࡮ࡔࡶࡤࡸࡺࡹࠢ࠭ࠢࠥࡥࡷ࡭ࡵ࡮ࡧࡱࡸࡸࠨ࠺ࠡࡽࠥࡷࡹࡧࡴࡶࡵࠥ࠾ࠧࡶࡡࡴࡵࡨࡨࠧࢃࡽࠨౙ"))
...
-      logger.debug(bstack1l1l_opy_ (u"ࠬࡌࡡࡪ࡮ࡨࡨࠥࡺ࡯ࠡ࡯ࡤࡶࡰࠦࡳࡦࡵࡶ࡭ࡴࡴࠠࡴࡶࡤࡸࡺࡹࠠࡪࡰࠣࡥ࡫ࡺࡥࡳࠢࡩࡩࡦࡺࡵࡳࡧ࠽ࠤࢀࢃࠧౚ").format(str(e)))
-  if name == bstack1l1l_opy_ (u"࠭ࡡࡧࡶࡨࡶࡤ࡬ࡥࡢࡶࡸࡶࡪ࠭౛"):
...
-        bstack1ll11l_opy_ = bstack1l1l_opy_ (u"ࠧࠨ౜")
+        bstack1l1l1111_opy_ = []
...
-            bstack1l1l1ll11_opy_ = bstack1l1l_opy_ (u"ࠨࠢࠪౝ").join(bstack1ll11ll1_opy_)
-            bstack111ll_opy_.append(bstack1l1l1ll11_opy_)
-            bstack1ll1l1ll1_opy_.append(bstack1ll11ll1_opy_[-1])
...
-          logger.debug(bstack1l1l1_opy_.format(str(e)))
-        bstack1lll11l1l_opy_ = bstack1l1l_opy_ (u"ࠩࠪ౞")
-        for i in range(len(bstack1ll1l11l1_opy_)):
-          bstack1lll11l1l_opy_ += bstack1ll1l11l1_opy_[i] + bstack1ll1l1ll1_opy_[i] + bstack1l1l_opy_ (u"ࠪࡠࡳ࠭౟")
-        bstack1ll11l_opy_ = bstack1l1l_opy_ (u"ࠫࠥ࠭ౠ").join(bstack111ll_opy_)
+          logger.debug(bstack11lll11l_opy_.format(str(e)))
...
-          bstack11ll1_opy_(context, bstack1ll11l_opy_, bstack1l1l_opy_ (u"ࠧ࡫ࡲࡳࡱࡵࠦౡ"))
-          bstack1l1l11l1_opy_(context, bstack1l1l_opy_ (u"ࠨࡦࡢ࡫࡯ࡩࡩࠨౢ"), bstack1lll11l1l_opy_)
opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ࡫ࡠࡧࡻࡩࡨࡻࡴࡰࡴ࠽ࠤࢀࠨࡡࡤࡶ࡬ࡳࡳࠨ࠺ࠡࠤࡤࡲࡳࡵࡴࡢࡶࡨࠦ࠱ࠦࠢࡢࡴࡪࡹࡲ࡫࡮ࡵࡵࠥ࠾ࠥࢁࠢࡥࡣࡷࡥࠧࡀࠧ౬") + json.dumps(bstack1l1l_opy_ (u"ࠥࡊࡪࡧࡴࡶࡴࡨ࠾ࠥࠨ౭") + str(self.feature.name) + bstack1l1l_opy_ (u"ࠦࠥࡶࡡࡴࡵࡨࡨࠦࠨ౮")) + bstack1l1l_opy_ (u"ࠬ࠲ࠠࠣ࡮ࡨࡺࡪࡲࠢ࠻ࠢࠥ࡭ࡳ࡬࡯ࠣࡿࢀࠫ౯"))
-          context.browser.execute_script(bstack1l1l_opy_ (u"࠭ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯ࡤ࡫ࡸࡦࡥࡸࡸࡴࡸ࠺ࠡࡽࠥࡥࡨࡺࡩࡰࡰࠥ࠾ࠥࠨࡳࡦࡶࡖࡩࡸࡹࡩࡰࡰࡖࡸࡦࡺࡵࡴࠤ࠯ࠤࠧࡧࡲࡨࡷࡰࡩࡳࡺࡳࠣ࠼ࠣࡿࠧࡹࡴࡢࡶࡸࡷࠧࡀࠢࡱࡣࡶࡷࡪࡪࠢࡾࡿࠪ౰"))
...
-  if name in [bstack1l1l_opy_ (u"ࠨࡣࡩࡸࡪࡸ࡟ࡧࡧࡤࡸࡺࡸࡥࠨ౲"), bstack1l1l_opy_ (u"ࠩࡤࡪࡹ࡫ࡲࡠࡵࡦࡩࡳࡧࡲࡪࡱࠪ౳")]:
-    bstack1lllll1l1_opy_(self, name, context, *args)
-def bstack11ll11_opy_(bstack1111_opy_):
-  global bstack1l1ll1l1_opy_
-  bstack1l1ll1l1_opy_ = bstack1111_opy_
-  logger.info(bstack1l1l1l1ll_opy_.format(bstack1l1ll1l1_opy_.split(bstack1l1l_opy_ (u"ࠪ࠱ࠬ౴"))[0]))
...
-    logger.warn(bstack1111lll1_opy_ + str(e))
-  Service.start = bstack1lllll11l_opy_
-  Service.stop = bstack1l1lll11l_opy_
-  webdriver.Remote.__init__ = bstack111lll_opy_
-  webdriver.Remote.get = bstack1lll1l_opy_
-  WebDriver.close = bstack11ll111_opy_
-  bstack1llll11l_opy_()
...
-      logger.error(bstack1llllll_opy_.format(str(e)))
-  if (bstack1l1l_opy_ (u"ࠫࡷࡵࡢࡰࡶࠪ౵") in str(bstack1111_opy_).lower()):
...
-        WebDriverCreator._get_ff_profile = bstack111ll1ll_opy_
+        WebDriverCreator._get_ff_profile = bstack11lll1_opy_
       except Exception as e:
-        logger.warn(bstack11lll1l_opy_ + str(e))
+        logger.warn(bstack1l1lll1l_opy_ + str(e))
     except Exception as e:
-      bstack11l1l1l_opy_(e, bstack11lll1l_opy_)
-    Output.end_test = bstack11l1ll_opy_
-    TestStatus.__init__ = bstack11ll1l1_opy_
-    QueueItem.__init__ = bstack1llll1l1_opy_
-    pabot._create_items = bstack11l1ll11_opy_
-    try:
-      from pabot import __version__ as bstack1l11lll1_opy_
-      if version.parse(bstack1l11lll1_opy_) >= version.parse(bstack1l1l_opy_ (u"ࠬ࠸࠮࠲࠵࠱࠴ࠬ౶")):
...
-        pabot._run = bstack1l1l1111_opy_
+        pabot._run = bstack11ll11ll_opy_
     except Exception as e:
-      pabot._run = bstack1l1l1111_opy_
-    pabot._create_command_for_execution = bstack11l111l1_opy_
-    pabot._report_results = bstack1l1llllll_opy_
-  if bstack1l1l_opy_ (u"࠭ࡢࡦࡪࡤࡺࡪ࠭౷") in str(bstack1111_opy_).lower():
+      pabot._run = bstack11ll11ll_opy_
...
-      bstack11l1l1l_opy_(e, bstack1lll11l1_opy_)
-    Runner.run_hook = bstack11ll1lll_opy_
-    Step.run = bstack1l11111_opy_
...
+def bstack1l1ll1l_opy_():
   global CONFIG
-  if bstack1l1l_opy_ (u"ࠧࡱࡣࡵࡥࡱࡲࡥ࡭ࡵࡓࡩࡷࡖ࡬ࡢࡶࡩࡳࡷࡳࠧ౸") in CONFIG and int(CONFIG[bstack1l1l_opy_ (u"ࠨࡲࡤࡶࡦࡲ࡬ࡦ࡮ࡶࡔࡪࡸࡐ࡭ࡣࡷࡪࡴࡸ࡭ࠨ౹")]) > 1:
-    logger.warn(bstack1ll1l11ll_opy_)
-def bstack1l11llll_opy_(bstack11l111ll_opy_, index):
-  bstack11ll11_opy_(bstack111lll1_opy_)
-  exec(open(bstack11l111ll_opy_).read())
-def bstack11ll_opy_(arg):
...
+def bstack11l1l1_opy_(arg):
   global CONFIG
-  bstack11ll11_opy_(bstack11111l11_opy_)
...
-  from _pytest.config import main as bstack1l11111l_opy_
-  bstack1l11111l_opy_(arg)
-def bstack1ll1ll11_opy_(arg):
-  bstack11ll11_opy_(bstack11lll1_opy_)
-  from behave.__main__ import main as bstack1ll1l1_opy_
-  bstack1ll1l1_opy_(arg)
...
-  parser.add_argument(bstack1l1l_opy_ (u"࠭ࡳࡦࡶࡸࡴࠬ౾"), help=bstack1l1l_opy_ (u"ࠧࡈࡧࡱࡩࡷࡧࡴࡦࠢࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ࡫ࠡࡥࡲࡲ࡫࡯ࡧࠨ౿"))
-  parser.add_argument(bstack1l1l_opy_ (u"ࠨ࠯ࡸࠫಀ"), bstack1l1l_opy_ (u"ࠩ࠰࠱ࡺࡹࡥࡳࡰࡤࡱࡪ࠭ಁ"), help=bstack1l1l_opy_ (u"ࠪ࡝ࡴࡻࡲࠡࡤࡵࡳࡼࡹࡥࡳࡵࡷࡥࡨࡱࠠࡶࡵࡨࡶࡳࡧ࡭ࡦࠩಂ"))
-  parser.add_argument(bstack1l1l_opy_ (u"ࠫ࠲ࡱࠧಃ"), bstack1l1l_opy_ (u"ࠬ࠳࠭࡬ࡧࡼࠫ಄"), help=bstack1l1l_opy_ (u"࡙࠭ࡰࡷࡵࠤࡧࡸ࡯ࡸࡵࡨࡶࡸࡺࡡࡤ࡭ࠣࡥࡨࡩࡥࡴࡵࠣ࡯ࡪࡿࠧಅ"))
-  parser.add_argument(bstack1l1l_opy_ (u"ࠧ࠮ࡨࠪಆ"), bstack1l1l_opy_ (u"ࠨ࠯࠰ࡪࡷࡧ࡭ࡦࡹࡲࡶࡰ࠭ಇ"), help=bstack1l1l_opy_ (u"ࠩ࡜ࡳࡺࡸࠠࡵࡧࡶࡸࠥ࡬ࡲࡢ࡯ࡨࡻࡴࡸ࡫ࠨಈ"))
...
+  bstack1l1l111l_opy_ = parser.parse_args()
   try:
-    bstack1ll111l1l_opy_ = bstack1l1l_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵࡷࡹࡧࡣ࡬࠰ࡪࡩࡳ࡫ࡲࡪࡥ࠱ࡽࡲࡲ࠮ࡴࡣࡰࡴࡱ࡫ࠧಉ")
-    if bstack1l1ll1l1l_opy_.framework and bstack1l1ll1l1l_opy_.framework not in (bstack1l1l_opy_ (u"ࠫࡵࡿࡴࡩࡱࡱࠫಊ"), bstack1l1l_opy_ (u"ࠬࡶࡹࡵࡪࡲࡲ࠸࠭ಋ")):
-      bstack1ll111l1l_opy_ = bstack1l1l_opy_ (u"࠭ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯࠳࡬ࡲࡢ࡯ࡨࡻࡴࡸ࡫࠯ࡻࡰࡰ࠳ࡹࡡ࡮ࡲ࡯ࡩࠬಌ")
-    bstack111llll1_opy_ = os.path.join(os.path.dirname(os.path.realpath(__file__)), bstack1ll111l1l_opy_)
-    bstack1l11llll1_opy_ = open(bstack111llll1_opy_, bstack1l1l_opy_ (u"ࠧࡳࠩ಍"))
-    bstack11l1l_opy_ = bstack1l11llll1_opy_.read()
-    bstack1l11llll1_opy_.close()
-    if bstack1l1ll1l1l_opy_.username:
-      bstack11l1l_opy_ = bstack11l1l_opy_.replace(bstack1l1l_opy_ (u"ࠨ࡛ࡒ࡙ࡗࡥࡕࡔࡇࡕࡒࡆࡓࡅࠨಎ"), bstack1l1ll1l1l_opy_.username)
-    if bstack1l1ll1l1l_opy_.key:
-      bstack11l1l_opy_ = bstack11l1l_opy_.replace(bstack1l1l_opy_ (u"ࠩ࡜ࡓ࡚ࡘ࡟ࡂࡅࡆࡉࡘ࡙࡟ࡌࡇ࡜ࠫಏ"), bstack1l1ll1l1l_opy_.key)
-    if bstack1l1ll1l1l_opy_.framework:
-      bstack11l1l_opy_ = bstack11l1l_opy_.replace(bstack1l1l_opy_ (u"ࠪ࡝ࡔ࡛ࡒࡠࡈࡕࡅࡒࡋࡗࡐࡔࡎࠫಐ"), bstack1l1ll1l1l_opy_.framework)
-    file_name = bstack1l1l_opy_ (u"ࠫࡧࡸ࡯ࡸࡵࡨࡶࡸࡺࡡࡤ࡭࠱ࡽࡲࡲࠧ಑")
...
-    bstack1l11l1l1_opy_ = open(file_path, bstack1l1l_opy_ (u"ࠬࡽࠧಒ"))
-    bstack1l11l1l1_opy_.write(bstack11l1l_opy_)
-    bstack1l11l1l1_opy_.close()
-    logger.info(bstack111111ll_opy_)
-    try:
-      os.environ[bstack1l1l_opy_ (u"࠭ࡂࡓࡑ࡚ࡗࡊࡘࡓࡕࡃࡆࡏࡤࡌࡒࡂࡏࡈ࡛ࡔࡘࡋࠨಓ")] = bstack1l1ll1l1l_opy_.framework if bstack1l1ll1l1l_opy_.framework != None else bstack1l1l_opy_ (u"ࠢࠣಔ")
-      config = yaml.safe_load(bstack11l1l_opy_)
-      config[bstack1l1l_opy_ (u"ࠨࡵࡲࡹࡷࡩࡥࠨಕ")] = bstack1l1l_opy_ (u"ࠩࡳࡽࡹ࡮࡯࡯࠯ࡶࡩࡹࡻࡰࠨಖ")
-      bstack1ll1l1l11_opy_(bstack1ll1111l1_opy_, config)
...
-      logger.debug(bstack11lllll_opy_.format(str(e)))
+      logger.debug(bstack1l1llll1_opy_.format(str(e)))
   except Exception as e:
-    logger.error(bstack1l1llll_opy_.format(str(e)))
-def bstack1ll1l1l11_opy_(bstack1l11lll1l_opy_, config, bstack11ll1l1l_opy_ = {}):
-  global bstack1llll11ll_opy_
...
+  global bstack1ll1l1l1l_opy_
   if not config:
     return
-  bstack11llll11_opy_ = bstack1l11ll_opy_ if not bstack1llll11ll_opy_ else ( bstack1l1l111_opy_ if bstack1l1l_opy_ (u"ࠪࡥࡵࡶࠧಗ") in config else bstack1l111ll1_opy_ )
+  bstack111lll11_opy_ = bstack1lll1llll_opy_ if not bstack1ll1l1l1l_opy_ else ( bstack1ll1lllll_opy_ if bstack111_opy_ (u"ࠪࡥࡵࡶࠧಞ") in config else bstack1l1l1l1ll_opy_ )
   data = {
-    bstack1l1l_opy_ (u"ࠫࡺࡹࡥࡳࡐࡤࡱࡪ࠭ಘ"): config[bstack1l1l_opy_ (u"ࠬࡻࡳࡦࡴࡑࡥࡲ࡫ࠧಙ")],
-    bstack1l1l_opy_ (u"࠭ࡡࡤࡥࡨࡷࡸࡑࡥࡺࠩಚ"): config[bstack1l1l_opy_ (u"ࠧࡢࡥࡦࡩࡸࡹࡋࡦࡻࠪಛ")],
-    bstack1l1l_opy_ (u"ࠨࡧࡹࡩࡳࡺ࡟ࡵࡻࡳࡩࠬಜ"): bstack1l11lll1l_opy_,
-    bstack1l1l_opy_ (u"ࠩࡨࡺࡪࡴࡴࡠࡲࡵࡳࡵ࡫ࡲࡵ࡫ࡨࡷࠬಝ"): {
-      bstack1l1l_opy_ (u"ࠪࡰࡦࡴࡧࡶࡣࡪࡩࡤ࡬ࡲࡢ࡯ࡨࡻࡴࡸ࡫ࠨಞ"): str(config[bstack1l1l_opy_ (u"ࠫࡸࡵࡵࡳࡥࡨࠫಟ")]) if bstack1l1l_opy_ (u"ࠬࡹ࡯ࡶࡴࡦࡩࠬಠ") in config else bstack1l1l_opy_ (u"ࠨࡵ࡯࡭ࡱࡳࡼࡴࠢಡ"),
-      bstack1l1l_opy_ (u"ࠧࡳࡧࡩࡩࡷࡸࡥࡳࠩಢ"): bstack1l1l11l11_opy_(os.getenv(bstack1l1l_opy_ (u"ࠣࡄࡕࡓ࡜࡙ࡅࡓࡕࡗࡅࡈࡑ࡟ࡇࡔࡄࡑࡊ࡝ࡏࡓࡍࠥಣ"), bstack1l1l_opy_ (u"ࠤࠥತ"))),
-      bstack1l1l_opy_ (u"ࠪࡰࡦࡴࡧࡶࡣࡪࡩࠬಥ"): bstack1l1l_opy_ (u"ࠫࡵࡿࡴࡩࡱࡱࠫದ"),
-      bstack1l1l_opy_ (u"ࠬࡶࡲࡰࡦࡸࡧࡹ࠭ಧ"): bstack11llll11_opy_,
-      bstack1l1l_opy_ (u"࠭ࡢࡶ࡫࡯ࡨࡓࡧ࡭ࡦࠩನ"): config[bstack1l1l_opy_ (u"ࠧࡣࡷ࡬ࡰࡩࡔࡡ࡮ࡧࠪ಩")]if config[bstack1l1l_opy_ (u"ࠨࡤࡸ࡭ࡱࡪࡎࡢ࡯ࡨࠫಪ")] else bstack1l1l_opy_ (u"ࠤࡸࡲࡰࡴ࡯ࡸࡰࠥಫ"),
-      bstack1l1l_opy_ (u"ࠪࡦࡺ࡯࡬ࡥࡋࡧࡩࡳࡺࡩࡧ࡫ࡨࡶࠬಬ"): str(config[bstack1l1l_opy_ (u"ࠫࡧࡻࡩ࡭ࡦࡌࡨࡪࡴࡴࡪࡨ࡬ࡩࡷ࠭ಭ")]) if bstack1l1l_opy_ (u"ࠬࡨࡵࡪ࡮ࡧࡍࡩ࡫࡮ࡵ࡫ࡩ࡭ࡪࡸࠧಮ") in config else bstack1l1l_opy_ (u"ࠨࡵ࡯࡭ࡱࡳࡼࡴࠢಯ"),
-      bstack1l1l_opy_ (u"ࠧࡰࡵࠪರ"): sys.platform,
-      bstack1l1l_opy_ (u"ࠨࡪࡲࡷࡹࡴࡡ࡮ࡧࠪಱ"): socket.gethostname()
...
-  update(data[bstack1l1l_opy_ (u"ࠩࡨࡺࡪࡴࡴࡠࡲࡵࡳࡵ࡫ࡲࡵ࡫ࡨࡷࠬಲ")], bstack11ll1l1l_opy_)
+  update(data[bstack111_opy_ (u"ࠩࡨࡺࡪࡴࡴࡠࡲࡵࡳࡵ࡫ࡲࡵ࡫ࡨࡷࠬಹ")], bstack1111ll11_opy_)
   try:
-    response = bstack11l11l1l_opy_(bstack1l1l_opy_ (u"ࠪࡔࡔ࡙ࡔࠨಳ"), bstack1l1l1l1l_opy_, data, config)
+    response = bstack1l111l_opy_(bstack111_opy_ (u"ࠪࡔࡔ࡙ࡔࠨ಺"), bstack111llll_opy_, data, config)
     if response:
-      logger.debug(bstack11l1llll_opy_.format(bstack1l11lll1l_opy_, str(response.json())))
...
-def bstack11l11l1l_opy_(type, url, data, config):
-  bstack1ll1ll1l1_opy_ = bstack1ll1111_opy_.format(url)
...
+  proxy = bstack1llll1l1l_opy_(config)
   proxies = {}
   response = {}
-  if config.get(bstack1l1l_opy_ (u"ࠫ࡭ࡺࡴࡱࡒࡵࡳࡽࡿࠧ಴")):
+  if config.get(bstack111_opy_ (u"ࠫ࡭ࡺࡴࡱࡒࡵࡳࡽࡿࠧ಻")):
     proxies = {
-      bstack1l1l_opy_ (u"ࠬ࡮ࡴࡵࡲࡶࠫವ"): proxy
+      bstack111_opy_ (u"ࠬ࡮ࡴࡵࡲࡶ಼ࠫ"): proxy
     }
-  if config.get(bstack1l1l_opy_ (u"࠭ࡨࡵࡶࡳࡷࡕࡸ࡯ࡹࡻࠪಶ")):
+  if config.get(bstack111_opy_ (u"࠭ࡨࡵࡶࡳࡷࡕࡸ࡯ࡹࡻࠪಽ")):
     proxies = {
-      bstack1l1l_opy_ (u"ࠧࡩࡶࡷࡴࡸ࠭ಷ"): proxy
+      bstack111_opy_ (u"ࠧࡩࡶࡷࡴࡸ࠭ಾ"): proxy
     }
-  if type == bstack1l1l_opy_ (u"ࠨࡒࡒࡗ࡙࠭ಸ"):
-    response = requests.post(bstack1ll1ll1l1_opy_, json=data,
-                    headers={bstack1l1l_opy_ (u"ࠩࡆࡳࡳࡺࡥ࡯ࡶ࠰ࡘࡾࡶࡥࠨಹ"): bstack1l1l_opy_ (u"ࠪࡥࡵࡶ࡬ࡪࡥࡤࡸ࡮ࡵ࡮࠰࡬ࡶࡳࡳ࠭಺")}, auth=(config[bstack1l1l_opy_ (u"ࠫࡺࡹࡥࡳࡐࡤࡱࡪ࠭಻")], config[bstack1l1l_opy_ (u"ࠬࡧࡣࡤࡧࡶࡷࡐ࡫ࡹࠨ಼")]), proxies=proxies)
...
+                    headers={bstack111_opy_ (u"ࠩࡆࡳࡳࡺࡥ࡯ࡶ࠰ࡘࡾࡶࡥࠨೀ"): bstack111_opy_ (u"ࠪࡥࡵࡶ࡬ࡪࡥࡤࡸ࡮ࡵ࡮࠰࡬ࡶࡳࡳ࠭ು")}, auth=(config[bstack111_opy_ (u"ࠫࡺࡹࡥࡳࡐࡤࡱࡪ࠭ೂ")], config[bstack111_opy_ (u"ࠬࡧࡣࡤࡧࡶࡷࡐ࡫ࡹࠨೃ")]), proxies=proxies)
   return response
-def bstack1l1l11l11_opy_(framework):
-  return bstack1l1l_opy_ (u"ࠨࡻࡾ࠯ࡳࡽࡹ࡮࡯࡯ࡣࡪࡩࡳࡺ࠯ࡼࡿࠥಽ").format(str(framework), __version__) if framework else bstack1l1l_opy_ (u"ࠢࡱࡻࡷ࡬ࡴࡴࡡࡨࡧࡱࡸ࠴ࢁࡽࠣಾ").format(__version__)
...
-  bstack1111ll1_opy_()
-  sys.excepthook = bstack1ll111l11_opy_
-  atexit.register(bstack1lll1ll_opy_)
-  signal.signal(signal.SIGINT, bstack1ll11l1l_opy_)
-  signal.signal(signal.SIGTERM, bstack1ll11l1l_opy_)
-def bstack1ll111l11_opy_(exctype, value, traceback):
-  bstack1l111l_opy_(value)
+  bstack111l1ll1_opy_()
...
-def bstack1l111l_opy_(message = bstack1l1l_opy_ (u"ࠨࠩಿ")):
+def bstack11111l_opy_(message = bstack111_opy_ (u"ࠨࠩೆ")):
   global CONFIG
   try:
     if message:
-      bstack11ll1l1l_opy_ = {
-        bstack1l1l_opy_ (u"ࠩࡨࡶࡷࡵࡲࠨೀ"): str(message)
+      bstack1111ll11_opy_ = {
+        bstack111_opy_ (u"ࠩࡨࡶࡷࡵࡲࠨೇ"): str(message)
       }
-      bstack1ll1l1l11_opy_(bstack1l11ll1l_opy_, CONFIG, bstack11ll1l1l_opy_)
+      bstack11111l1_opy_(bstack1lll11l1l_opy_, CONFIG, bstack1111ll11_opy_)
     else:
-      bstack1ll1l1l11_opy_(bstack1l11ll1l_opy_, CONFIG)
+      bstack11111l1_opy_(bstack1lll11l1l_opy_, CONFIG)
   except Exception as e:
-    logger.debug(bstack1l1l1ll1_opy_.format(str(e)))
-def bstack1llll1l11_opy_(bstack1ll111ll1_opy_, size):
-  bstack11ll1111_opy_ = []
-  while len(bstack1ll111ll1_opy_) > size:
-    bstack111ll1_opy_ = bstack1ll111ll1_opy_[:size]
-    bstack11ll1111_opy_.append(bstack111ll1_opy_)
-    bstack1ll111ll1_opy_   = bstack1ll111ll1_opy_[size:]
-  bstack11ll1111_opy_.append(bstack1ll111ll1_opy_)
...
+  return bstack1l1lll1_opy_
 def run_on_browserstack():
   if len(sys.argv) <= 1:
-    logger.critical(bstack111l11l_opy_)
+    logger.critical(bstack1ll1llll_opy_)
     return
-  if sys.argv[1] == bstack1l1l_opy_ (u"ࠪ࠱࠲ࡼࡥࡳࡵ࡬ࡳࡳ࠭ು")  or sys.argv[1] == bstack1l1l_opy_ (u"ࠫ࠲ࡼࠧೂ"):
-    logger.info(bstack1l1l_opy_ (u"ࠬࡈࡲࡰࡹࡶࡩࡷࡹࡴࡢࡥ࡮ࠤࡕࡿࡴࡩࡱࡱࠤࡘࡊࡋࠡࡸࡾࢁࠬೃ").format(__version__))
...
+    logger.info(bstack111_opy_ (u"ࠬࡈࡲࡰࡹࡶࡩࡷࡹࡴࡢࡥ࡮ࠤࡕࡿࡴࡩࡱࡱࠤࡘࡊࡋࠡࡸࡾࢁࠬೊ").format(__version__))
     return
-  if sys.argv[1] == bstack1l1l_opy_ (u"࠭ࡳࡦࡶࡸࡴࠬೄ"):
-    bstack111lll1l_opy_()
...
-  global bstack1111llll_opy_
-  global bstack1l1ll1ll_opy_
-  bstack1l11l_opy_ = bstack1l1l_opy_ (u"ࠧࠨ೅")
-  if args[1] == bstack1l1l_opy_ (u"ࠨࡲࡼࡸ࡭ࡵ࡮ࠨೆ") or args[1] == bstack1l1l_opy_ (u"ࠩࡳࡽࡹ࡮࡯࡯࠵ࠪೇ"):
-    bstack1l11l_opy_ = bstack1l1l_opy_ (u"ࠪࡴࡾࡺࡨࡰࡰࠪೈ")
+  global bstack1ll1ll11_opy_
+  global bstack1l1l1l1l1_opy_
+  global bstack11llll1_opy_
+  global bstack1llll1l11_opy_
...
+    bstack11111l1l_opy_ = bstack111_opy_ (u"ࠪࡴࡾࡺࡨࡰࡰࠪ೏")
     args = args[2:]
-  elif args[1] == bstack1l1l_opy_ (u"ࠫࡷࡵࡢࡰࡶࠪ೉"):
-    bstack1l11l_opy_ = bstack1l1l_opy_ (u"ࠬࡸ࡯ࡣࡱࡷࠫೊ")
+  elif args[1] == bstack111_opy_ (u"ࠫࡷࡵࡢࡰࡶࠪ೐"):
+    bstack11111l1l_opy_ = bstack111_opy_ (u"ࠬࡸ࡯ࡣࡱࡷࠫ೑")
     args = args[2:]
-  elif args[1] == bstack1l1l_opy_ (u"࠭ࡰࡢࡤࡲࡸࠬೋ"):
-    bstack1l11l_opy_ = bstack1l1l_opy_ (u"ࠧࡱࡣࡥࡳࡹ࠭ೌ")
+  elif args[1] == bstack111_opy_ (u"࠭ࡰࡢࡤࡲࡸࠬ೒"):
+    bstack11111l1l_opy_ = bstack111_opy_ (u"ࠧࡱࡣࡥࡳࡹ࠭೓")
     args = args[2:]
-  elif args[1] == bstack1l1l_opy_ (u"ࠨࡴࡲࡦࡴࡺ࠭ࡪࡰࡷࡩࡷࡴࡡ࡭್ࠩ"):
-    bstack1l11l_opy_ = bstack1l1l_opy_ (u"ࠩࡵࡳࡧࡵࡴ࠮࡫ࡱࡸࡪࡸ࡮ࡢ࡮ࠪ೎")
...
-    bstack1l11l_opy_ = bstack1l1l_opy_ (u"ࠫࡵࡿࡴࡦࡵࡷࠫ೐")
...
-    bstack1l11l_opy_ = bstack1l1l_opy_ (u"࠭ࡢࡦࡪࡤࡺࡪ࠭೒")
+  elif args[1] == bstack111_opy_ (u"ࠬࡨࡥࡩࡣࡹࡩࠬ೘"):
+    bstack11111l1l_opy_ = bstack111_opy_ (u"࠭ࡢࡦࡪࡤࡺࡪ࠭೙")
     args = args[2:]
   else:
-    if not bstack1l1l_opy_ (u"ࠧࡧࡴࡤࡱࡪࡽ࡯ࡳ࡭ࠪ೓") in CONFIG or str(CONFIG[bstack1l1l_opy_ (u"ࠨࡨࡵࡥࡲ࡫ࡷࡰࡴ࡮ࠫ೔")]).lower() in [bstack1l1l_opy_ (u"ࠩࡳࡽࡹ࡮࡯࡯ࠩೕ"), bstack1l1l_opy_ (u"ࠪࡴࡾࡺࡨࡰࡰ࠶ࠫೖ")]:
-      bstack1l11l_opy_ = bstack1l1l_opy_ (u"ࠫࡵࡿࡴࡩࡱࡱࠫ೗")
...
+      bstack11111l1l_opy_ = bstack111_opy_ (u"ࠫࡵࡿࡴࡩࡱࡱࠫೞ")
       args = args[1:]
-    elif str(CONFIG[bstack1l1l_opy_ (u"ࠬ࡬ࡲࡢ࡯ࡨࡻࡴࡸ࡫ࠨ೘")]).lower() == bstack1l1l_opy_ (u"࠭ࡲࡰࡤࡲࡸࠬ೙"):
-      bstack1l11l_opy_ = bstack1l1l_opy_ (u"ࠧࡳࡱࡥࡳࡹ࠭೚")
...
-      bstack1l11l_opy_ = bstack1l1l_opy_ (u"ࠪࡴࡦࡨ࡯ࡵࠩೝ")
...
+      bstack11111l1l_opy_ = bstack111_opy_ (u"ࠪࡴࡦࡨ࡯ࡵࠩ೤")
       args = args[1:]
-    elif str(CONFIG[bstack1l1l_opy_ (u"ࠫ࡫ࡸࡡ࡮ࡧࡺࡳࡷࡱࠧೞ")]).lower() == bstack1l1l_opy_ (u"ࠬࡶࡹࡵࡧࡶࡸࠬ೟"):
-      bstack1l11l_opy_ = bstack1l1l_opy_ (u"࠭ࡰࡺࡶࡨࡷࡹ࠭ೠ")
...
+      bstack11111l1l_opy_ = bstack111_opy_ (u"࠭ࡰࡺࡶࡨࡷࡹ࠭೧")
       args = args[1:]
-    elif str(CONFIG[bstack1l1l_opy_ (u"ࠧࡧࡴࡤࡱࡪࡽ࡯ࡳ࡭ࠪೡ")]).lower() == bstack1l1l_opy_ (u"ࠨࡤࡨ࡬ࡦࡼࡥࠨೢ"):
-      bstack1l11l_opy_ = bstack1l1l_opy_ (u"ࠩࡥࡩ࡭ࡧࡶࡦࠩೣ")
...
-      os.environ[bstack1l1l_opy_ (u"ࠪࡆࡗࡕࡗࡔࡇࡕࡗ࡙ࡇࡃࡌࡡࡉࡖࡆࡓࡅࡘࡑࡕࡏࠬ೤")] = bstack1l11l_opy_
-      bstack1llll1_opy_(bstack1l11ll11_opy_)
...
+  global bstack1111l1_opy_
   try:
-    os.environ[bstack1l1l_opy_ (u"ࠫࡇࡘࡏࡘࡕࡈࡖࡘ࡚ࡁࡄࡍࡢࡊࡗࡇࡍࡆ࡙ࡒࡖࡐ࠭೥")] = bstack1l11l_opy_
-    bstack1ll1l1l11_opy_(bstack111l1l1_opy_, CONFIG)
...
-  bstack1ll1l_opy_ = WebDriver.close
+    logger.warn(bstack1ll11l1l_opy_ + str(e))
...
+  bstack1l1ll11_opy_ = WebDriver.close
   try:
     import Browser
     from subprocess import Popen
-    bstack11ll11l1_opy_ = Popen.__init__
+    bstack1111l1_opy_ = Popen.__init__
   except Exception as e:
-    logger.debug(bstack1lllll111_opy_ + str(e))
-  bstack1ll11l1_opy_ = WebDriver.get
-  if bstack1l1l1l11l_opy_():
-    if bstack1l1ll11_opy_() < version.parse(bstack1l111l1l_opy_):
-      logger.error(bstack1ll11l11_opy_.format(bstack1l1ll11_opy_()))
+    logger.debug(bstack1l11lll1l_opy_ + str(e))
...
+      logger.error(bstack1ll1l_opy_.format(bstack11l111l_opy_()))
       ...
       try:
         from selenium.webdriver.remote.remote_connection import RemoteConnection
-        bstack1lll1ll1l_opy_ = RemoteConnection._get_proxy_url
+        bstack1l1ll111_opy_ = RemoteConnection._get_proxy_url
       except Exception as e:
-        logger.error(bstack1llllll_opy_.format(str(e)))
-  if (bstack1l11l_opy_ in [bstack1l1l_opy_ (u"ࠬࡶࡡࡣࡱࡷࠫ೦"), bstack1l1l_opy_ (u"࠭ࡲࡰࡤࡲࡸࠬ೧"), bstack1l1l_opy_ (u"ࠧࡳࡱࡥࡳࡹ࠳ࡩ࡯ࡶࡨࡶࡳࡧ࡬ࠨ೨")]):
+        logger.error(bstack1lllll_opy_.format(str(e)))
...
-      bstack11l1l1l_opy_(e, bstack11lll1l_opy_)
-    bstack11l11ll1_opy_ = Output.end_test
-    bstack1lll11l_opy_ = TestStatus.__init__
-    bstack1ll11111l_opy_ = pabot._run
-    bstack1l1111l_opy_ = QueueItem.__init__
-    bstack11l1l111_opy_ = pabot._create_command_for_execution
-  if bstack1l11l_opy_ == bstack1l1l_opy_ (u"ࠨࡤࡨ࡬ࡦࡼࡥࠨ೩"):
+      bstack1llll111l_opy_(e, bstack1l1lll1l_opy_)
...
-      bstack11l1l1l_opy_(e, bstack1lll11l1_opy_)
-    bstack1lllll1l1_opy_ = Runner.run_hook
-    bstack1ll1lll1l_opy_ = Step.run
-  if bstack1l11l_opy_ == bstack1l1l_opy_ (u"ࠩࡳࡽࡹ࡮࡯࡯ࠩ೪"):
-    bstack1ll1111ll_opy_()
-    bstack1l1111l1_opy_()
-    if bstack1l1l_opy_ (u"ࠪࡴࡱࡧࡴࡧࡱࡵࡱࡸ࠭೫") in CONFIG:
-      bstack11l1l1l1_opy_ = True
-      bstack1111l1l_opy_ = []
-      for index, platform in enumerate(CONFIG[bstack1l1l_opy_ (u"ࠫࡵࡲࡡࡵࡨࡲࡶࡲࡹࠧ೬")]):
-        bstack1111l1l_opy_.append(threading.Thread(name=str(index),
-                                      target=bstack1l11llll_opy_, args=(args[0], index)))
-      for t in bstack1111l1l_opy_:
+      bstack1llll111l_opy_(e, bstack1llllll11_opy_)
...
-  elif bstack1l11l_opy_ == bstack1l1l_opy_ (u"ࠬࡶࡡࡣࡱࡷࠫ೭") or bstack1l11l_opy_ == bstack1l1l_opy_ (u"࠭ࡲࡰࡤࡲࡸࠬ೮"):
...
-      bstack11l1l1l_opy_(e, bstack11lll1l_opy_)
-    bstack1ll1111ll_opy_()
-    bstack11ll11_opy_(bstack11l1lll_opy_)
-    if bstack1l1l_opy_ (u"ࠧ࠮࠯ࡳࡶࡴࡩࡥࡴࡵࡨࡷࠬ೯") in args:
-      i = args.index(bstack1l1l_opy_ (u"ࠨ࠯࠰ࡴࡷࡵࡣࡦࡵࡶࡩࡸ࠭೰"))
+      bstack1llll111l_opy_(e, bstack1l1lll1l_opy_)
+    bstack1l1l1l1_opy_()
...
+      i = args.index(bstack111_opy_ (u"ࠨ࠯࠰ࡴࡷࡵࡣࡦࡵࡶࡩࡸ࠭೷"))
       args.pop(i)
       args.pop(i)
-    args.insert(0, str(bstack1llllll11_opy_))
-    args.insert(0, str(bstack1l1l_opy_ (u"ࠩ࠰࠱ࡵࡸ࡯ࡤࡧࡶࡷࡪࡹࠧೱ")))
+    args.insert(0, str(bstack1ll1ll11_opy_))
+    args.insert(0, str(bstack111_opy_ (u"ࠩ࠰࠱ࡵࡸ࡯ࡤࡧࡶࡷࡪࡹࠧ೸")))
     pabot.main(args)
-  elif bstack1l11l_opy_ == bstack1l1l_opy_ (u"ࠪࡶࡴࡨ࡯ࡵ࠯࡬ࡲࡹ࡫ࡲ࡯ࡣ࡯ࠫೲ"):
...
+      bstack1llll111l_opy_(e, bstack1l1lll1l_opy_)
     for a in args:
-      if bstack1l1l_opy_ (u"ࠫࡇ࡙ࡔࡂࡅࡎࡔࡑࡇࡔࡇࡑࡕࡑࡎࡔࡄࡆ࡚ࠪೳ") in a:
-        bstack11lll_opy_ = int(a.split(bstack1l1l_opy_ (u"ࠬࡀࠧ೴"))[1])
-      if bstack1l1l_opy_ (u"࠭ࡂࡔࡖࡄࡇࡐࡊࡅࡇࡎࡒࡇࡆࡒࡉࡅࡇࡑࡘࡎࡌࡉࡆࡔࠪ೵") in a:
-        bstack1111llll_opy_ = str(a.split(bstack1l1l_opy_ (u"ࠧ࠻ࠩ೶"))[1])
-      if bstack1l1l_opy_ (u"ࠨࡄࡖࡘࡆࡉࡋࡄࡎࡌࡅࡗࡍࡓࠨ೷") in a:
-        bstack1l1ll1ll_opy_ = str(a.split(bstack1l1l_opy_ (u"ࠩ࠽ࠫ೸"))[1])
-    bstack11ll11_opy_(bstack11l1lll_opy_)
...
+    bstack1l1ll1l1l_opy_(bstack1l1lll_opy_)
     run_cli(args)
-  elif bstack1l11l_opy_ == bstack1l1l_opy_ (u"ࠪࡴࡾࡺࡥࡴࡶࠪ೹"):
+  elif bstack11111l1l_opy_ == bstack111_opy_ (u"ࠪࡴࡾࡺࡥࡴࡶࠪഀ"):
     try:
       from _pytest.config import _prepareconfig
       import importlib
-      bstack1ll1l11l_opy_ = importlib.find_loader(bstack1l1l_opy_ (u"ࠫࡵࡿࡴࡦࡵࡷࡣࡸ࡫࡬ࡦࡰ࡬ࡹࡲ࠭೺"))
-      if bstack1ll1l11l_opy_ is None:
-        bstack11l1l1l_opy_(e, bstack1llll11l1_opy_)
...
+    bstack1l1l1l1_opy_()
     try:
-      if bstack1l1l_opy_ (u"ࠬ࠳࠭ࡥࡴ࡬ࡺࡪࡸࠧ೻") in args:
-        i = args.index(bstack1l1l_opy_ (u"࠭࠭࠮ࡦࡵ࡭ࡻ࡫ࡲࠨ೼"))
+      if bstack111_opy_ (u"ࠬ࠳࠭ࡥࡴ࡬ࡺࡪࡸࠧം") in args:
+        i = args.index(bstack111_opy_ (u"࠭࠭࠮ࡦࡵ࡭ࡻ࡫ࡲࠨഃ"))
         args.pop(i+1)
         args.pop(i)
-      if bstack1l1l_opy_ (u"ࠧ࠮࠯ࡳࡰࡺ࡭ࡩ࡯ࡵࠪ೽") in args:
-        i = args.index(bstack1l1l_opy_ (u"ࠨ࠯࠰ࡴࡱࡻࡧࡪࡰࡶࠫ೾"))
+      if bstack111_opy_ (u"ࠧ࠮࠯ࡳࡰࡺ࡭ࡩ࡯ࡵࠪഄ") in args:
+        i = args.index(bstack111_opy_ (u"ࠨ࠯࠰ࡴࡱࡻࡧࡪࡰࡶࠫഅ"))
         args.pop(i+1)
         args.pop(i)
-      if bstack1l1l_opy_ (u"ࠩ࠰ࡴࠬ೿") in args:
-        i = args.index(bstack1l1l_opy_ (u"ࠪ࠱ࡵ࠭ഀ"))
+      if bstack111_opy_ (u"ࠩ࠰ࡴࠬആ") in args:
+        i = args.index(bstack111_opy_ (u"ࠪ࠱ࡵ࠭ഇ"))
         args.pop(i+1)
         args.pop(i)
-      if bstack1l1l_opy_ (u"ࠫ࠲࠳࡮ࡶ࡯ࡳࡶࡴࡩࡥࡴࡵࡨࡷࠬഁ") in args:
-        i = args.index(bstack1l1l_opy_ (u"ࠬ࠳࠭࡯ࡷࡰࡴࡷࡵࡣࡦࡵࡶࡩࡸ࠭ം"))
+      if bstack111_opy_ (u"ࠫ࠲࠳࡮ࡶ࡯ࡳࡶࡴࡩࡥࡴࡵࡨࡷࠬഈ") in args:
+        i = args.index(bstack111_opy_ (u"ࠬ࠳࠭࡯ࡷࡰࡴࡷࡵࡣࡦࡵࡶࡩࡸ࠭ഉ"))
         args.pop(i+1)
         args.pop(i)
-      if bstack1l1l_opy_ (u"࠭࠭࡯ࠩഃ") in args:
-        i = args.index(bstack1l1l_opy_ (u"ࠧ࠮ࡰࠪഄ"))
...
-    bstack1l1lll111_opy_ = config.invocation_params.args
-    bstack1l1lll111_opy_ = list(bstack1l1lll111_opy_)
-    bstack1lll11ll1_opy_ = []
-    for arg in bstack1l1lll111_opy_:
...
-          bstack1lll11ll1_opy_.append(arg)
+          bstack1l1l111ll_opy_.append(arg)
     import platform as pf
-    if pf.system().lower() == bstack1l1l_opy_ (u"ࠨࡹ࡬ࡲࡩࡵࡷࡴࠩഅ"):
+    if pf.system().lower() == bstack111_opy_ (u"ࠨࡹ࡬ࡲࡩࡵࡷࡴࠩഌ"):
       from pathlib import PureWindowsPath, PurePosixPath
-      bstack1l111l11_opy_ = [str(PurePosixPath(PureWindowsPath(bstack1lll1lll_opy_)))
-                    for bstack1lll1lll_opy_ in bstack1l111l11_opy_]
-    bstack1lll11ll1_opy_.append(bstack1l1l_opy_ (u"ࠩ࠰ࡴࠬആ"))
-    bstack1lll11ll1_opy_.append(bstack1l1l_opy_ (u"ࠪࡴࡾࡺࡥࡴࡶࡢࡦࡷࡵࡷࡴࡧࡵࡷࡹࡧࡣ࡬ࡲ࡯ࡹ࡬࡯࡮ࠨഇ"))
-    bstack1lll11ll1_opy_.append(bstack1l1l_opy_ (u"ࠫ࠲࠳ࡤࡳ࡫ࡹࡩࡷ࠭ഈ"))
-    bstack1lll11ll1_opy_.append(bstack1l1l_opy_ (u"ࠬࡩࡨࡳࡱࡰࡩࠬഉ"))
-    bstack1lll111_opy_ = []
-    for spec in bstack1l111l11_opy_:
-      bstack1ll1lll1_opy_ = []
-      bstack1ll1lll1_opy_.append(spec)
-      bstack1ll1lll1_opy_ += bstack1lll11ll1_opy_
-      bstack1lll111_opy_.append(bstack1ll1lll1_opy_)
-    bstack11l1l1l1_opy_ = True
-    bstack1lll111l_opy_ = 1
-    if bstack1l1l_opy_ (u"࠭ࡰࡢࡴࡤࡰࡱ࡫࡬ࡴࡒࡨࡶࡕࡲࡡࡵࡨࡲࡶࡲ࠭ഊ") in CONFIG:
-      bstack1lll111l_opy_ = CONFIG[bstack1l1l_opy_ (u"ࠧࡱࡣࡵࡥࡱࡲࡥ࡭ࡵࡓࡩࡷࡖ࡬ࡢࡶࡩࡳࡷࡳࠧഋ")]
-    bstack1ll1llll_opy_ = int(bstack1lll111l_opy_)*int(len(CONFIG[bstack1l1l_opy_ (u"ࠨࡲ࡯ࡥࡹ࡬࡯ࡳ࡯ࡶࠫഌ")]))
...
-      for bstack1ll1lll1_opy_ in bstack1lll111_opy_:
+    for index, _ in enumerate(CONFIG[bstack111_opy_ (u"ࠩࡳࡰࡦࡺࡦࡰࡴࡰࡷࠬഔ")]):
+      for bstack1llll1_opy_ in bstack11l11_opy_:
         item = {}
-        item[bstack1l1l_opy_ (u"ࠪࡥࡷ࡭ࠧഎ")] = bstack1ll1lll1_opy_
-        item[bstack1l1l_opy_ (u"ࠫ࡮ࡴࡤࡦࡺࠪഏ")] = index
+        item[bstack111_opy_ (u"ࠪࡥࡷ࡭ࠧക")] = bstack1llll1_opy_
+        item[bstack111_opy_ (u"ࠫ࡮ࡴࡤࡦࡺࠪഖ")] = index
         execution_items.append(item)
-    bstack111llll_opy_ = bstack1llll1l11_opy_(execution_items, bstack1ll1llll_opy_)
-    for execution_item in bstack111llll_opy_:
-      bstack1111l1l_opy_ = []
...
-        bstack1111l1l_opy_.append(threading.Thread(name=str(item[bstack1l1l_opy_ (u"ࠬ࡯࡮ࡥࡧࡻࠫഐ")]),
-                                            target=bstack11ll_opy_,
-                                            args=(item[bstack1l1l_opy_ (u"࠭ࡡࡳࡩࠪ഑")],)))
-      for t in bstack1111l1l_opy_:
...
+      for t in bstack1l1111_opy_:
         t.join()
-  elif bstack1l11l_opy_ == bstack1l1l_opy_ (u"ࠧࡣࡧ࡫ࡥࡻ࡫ࠧഒ"):
...
-    bstack11l1l1l1_opy_ = True
-    bstack1lll111l_opy_ = 1
-    if bstack1l1l_opy_ (u"ࠨࡲࡤࡶࡦࡲ࡬ࡦ࡮ࡶࡔࡪࡸࡐ࡭ࡣࡷࡪࡴࡸ࡭ࠨഓ") in CONFIG:
-      bstack1lll111l_opy_ = CONFIG[bstack1l1l_opy_ (u"ࠩࡳࡥࡷࡧ࡬࡭ࡧ࡯ࡷࡕ࡫ࡲࡑ࡮ࡤࡸ࡫ࡵࡲ࡮ࠩഔ")]
-    bstack1ll1llll_opy_ = int(bstack1lll111l_opy_)*int(len(CONFIG[bstack1l1l_opy_ (u"ࠪࡴࡱࡧࡴࡧࡱࡵࡱࡸ࠭ക")]))
+      bstack1llll111l_opy_(e, bstack1llllll11_opy_)
+    bstack1l1l1l1_opy_()
+    bstack1l1l1l1l1_opy_ = True
+    bstack111l11l1_opy_ = 1
...
-    bstack1l111l11_opy_ = config.paths
-    bstack1111111_opy_ = []
+    bstack1lll11l11_opy_ = config.paths
+    bstack11l1111_opy_ = []
     for arg in args:
-      if os.path.normpath(arg) not in bstack1l111l11_opy_:
-        bstack1111111_opy_.append(arg)
+      if os.path.normpath(arg) not in bstack1lll11l11_opy_:
+        bstack11l1111_opy_.append(arg)
     import platform as pf
-    if pf.system().lower() == bstack1l1l_opy_ (u"ࠫࡼ࡯࡮ࡥࡱࡺࡷࠬഖ"):
...
-    for spec in bstack1l111l11_opy_:
-      bstack1ll1lll1_opy_ = []
-      bstack1ll1lll1_opy_ += bstack1111111_opy_
-      bstack1ll1lll1_opy_.append(spec)
-      bstack1lll111_opy_.append(bstack1ll1lll1_opy_)
+      bstack1lll11l11_opy_ = [str(PurePosixPath(PureWindowsPath(bstack1l1l1lll1_opy_)))
+                    for bstack1l1l1lll1_opy_ in bstack1lll11l11_opy_]
...
+      bstack11l11_opy_.append(bstack1llll1_opy_)
     execution_items = []
-    for index, _ in enumerate(CONFIG[bstack1l1l_opy_ (u"ࠬࡶ࡬ࡢࡶࡩࡳࡷࡳࡳࠨഗ")]):
-      for bstack1ll1lll1_opy_ in bstack1lll111_opy_:
+    for index, _ in enumerate(CONFIG[bstack111_opy_ (u"ࠬࡶ࡬ࡢࡶࡩࡳࡷࡳࡳࠨഞ")]):
+      for bstack1llll1_opy_ in bstack11l11_opy_:
         item = {}
-        item[bstack1l1l_opy_ (u"࠭ࡡࡳࡩࠪഘ")] = bstack1l1l_opy_ (u"ࠧࠡࠩങ").join(bstack1ll1lll1_opy_)
-        item[bstack1l1l_opy_ (u"ࠨ࡫ࡱࡨࡪࡾࠧച")] = index
...
+      bstack1l1111_opy_ = []
       for item in execution_item:
-        bstack1111l1l_opy_.append(threading.Thread(name=str(item[bstack1l1l_opy_ (u"ࠩ࡬ࡲࡩ࡫ࡸࠨഛ")]),
-                                            target=bstack1ll1ll11_opy_,
-                                            args=(item[bstack1l1l_opy_ (u"ࠪࡥࡷ࡭ࠧജ")],)))
-      for t in bstack1111l1l_opy_:
...
+def bstack1l1ll11ll_opy_():
   global CONFIG
   try:
-    if bstack1l1l_opy_ (u"ࠫࡧࡻࡩ࡭ࡦࡑࡥࡲ࡫ࠧഝ") in CONFIG:
-      host = bstack1l1l_opy_ (u"ࠬࡧࡰࡪ࠯ࡦࡰࡴࡻࡤࠨഞ") if bstack1l1l_opy_ (u"࠭ࡡࡱࡲࠪട") in CONFIG else bstack1l1l_opy_ (u"ࠧࡢࡲ࡬ࠫഠ")
-      user = CONFIG[bstack1l1l_opy_ (u"ࠨࡷࡶࡩࡷࡔࡡ࡮ࡧࠪഡ")]
-      key = CONFIG[bstack1l1l_opy_ (u"ࠩࡤࡧࡨ࡫ࡳࡴࡍࡨࡽࠬഢ")]
-      bstack1ll111l1_opy_ = bstack1l1l_opy_ (u"ࠪࡥࡵࡶ࠭ࡢࡷࡷࡳࡲࡧࡴࡦࠩണ") if bstack1l1l_opy_ (u"ࠫࡦࡶࡰࠨത") in CONFIG else bstack1l1l_opy_ (u"ࠬࡧࡵࡵࡱࡰࡥࡹ࡫ࠧഥ")
-      url = bstack1l1l_opy_ (u"࠭ࡨࡵࡶࡳࡷ࠿࠵࠯ࡼࡿ࠽ࡿࢂࡆࡻࡾ࠰ࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ࡫࠯ࡥࡲࡱ࠴ࢁࡽ࠰ࡤࡸ࡭ࡱࡪࡳ࠯࡬ࡶࡳࡳ࠭ദ").format(user, key, host, bstack1ll111l1_opy_)
...
+      url = bstack111_opy_ (u"࠭ࡨࡵࡶࡳࡷ࠿࠵࠯ࡼࡿ࠽ࡿࢂࡆࡻࡾ࠰ࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ࡫࠯ࡥࡲࡱ࠴ࢁࡽ࠰ࡤࡸ࡭ࡱࡪࡳ࠯࡬ࡶࡳࡳ࠭ഭ").format(user, key, host, bstack11l1l1l_opy_)
       headers = {
-        bstack1l1l_opy_ (u"ࠧࡄࡱࡱࡸࡪࡴࡴ࠮ࡶࡼࡴࡪ࠭ധ"): bstack1l1l_opy_ (u"ࠨࡣࡳࡴࡱ࡯ࡣࡢࡶ࡬ࡳࡳ࠵ࡪࡴࡱࡱࠫന"),
+        bstack111_opy_ (u"ࠧࡄࡱࡱࡸࡪࡴࡴ࠮ࡶࡼࡴࡪ࠭മ"): bstack111_opy_ (u"ࠨࡣࡳࡴࡱ࡯ࡣࡢࡶ࡬ࡳࡳ࠵ࡪࡴࡱࡱࠫയ"),
       }
-      if bstack1l1l_opy_ (u"ࠩࡥࡹ࡮ࡲࡤࡊࡦࡨࡲࡹ࡯ࡦࡪࡧࡵࠫഩ") in CONFIG:
-        params = {bstack1l1l_opy_ (u"ࠪࡲࡦࡳࡥࠨപ"):CONFIG[bstack1l1l_opy_ (u"ࠫࡧࡻࡩ࡭ࡦࡑࡥࡲ࡫ࠧഫ")], bstack1l1l_opy_ (u"ࠬࡨࡵࡪ࡮ࡧࡣ࡮ࡪࡥ࡯ࡶ࡬ࡪ࡮࡫ࡲࠨബ"):CONFIG[bstack1l1l_opy_ (u"࠭ࡢࡶ࡫࡯ࡨࡎࡪࡥ࡯ࡶ࡬ࡪ࡮࡫ࡲࠨഭ")]}
...
-        params = {bstack1l1l_opy_ (u"ࠧ࡯ࡣࡰࡩࠬമ"):CONFIG[bstack1l1l_opy_ (u"ࠨࡤࡸ࡭ࡱࡪࡎࡢ࡯ࡨࠫയ")]}
+        params = {bstack111_opy_ (u"ࠧ࡯ࡣࡰࡩࠬവ"):CONFIG[bstack111_opy_ (u"ࠨࡤࡸ࡭ࡱࡪࡎࡢ࡯ࡨࠫശ")]}
       response = requests.get(url, params=params, headers=headers)
       if response.json():
-        bstack1l1111ll_opy_ = response.json()[0][bstack1l1l_opy_ (u"ࠩࡤࡹࡹࡵ࡭ࡢࡶ࡬ࡳࡳࡥࡢࡶ࡫࡯ࡨࠬര")]
-        if bstack1l1111ll_opy_:
-          bstack1lllll_opy_ = bstack1l1111ll_opy_[bstack1l1l_opy_ (u"ࠪࡴࡺࡨ࡬ࡪࡥࡢࡹࡷࡲࠧറ")].split(bstack1l1l_opy_ (u"ࠫࡵࡻࡢ࡭࡫ࡦ࠱ࡧࡻࡩ࡭ࡦࠪല"))[0] + bstack1l1l_opy_ (u"ࠬࡨࡵࡪ࡮ࡧࡷ࠴࠭ള") + bstack1l1111ll_opy_[bstack1l1l_opy_ (u"࠭ࡨࡢࡵ࡫ࡩࡩࡥࡩࡥࠩഴ")]
-          logger.info(bstack1l1l11ll1_opy_.format(bstack1lllll_opy_))
-          bstack1lll111l1_opy_ = CONFIG[bstack1l1l_opy_ (u"ࠧࡣࡷ࡬ࡰࡩࡔࡡ࡮ࡧࠪവ")]
-          if bstack1l1l_opy_ (u"ࠨࡤࡸ࡭ࡱࡪࡉࡥࡧࡱࡸ࡮࡬ࡩࡦࡴࠪശ") in CONFIG:
-            bstack1lll111l1_opy_ += bstack1l1l_opy_ (u"ࠩࠣࠫഷ") + CONFIG[bstack1l1l_opy_ (u"ࠪࡦࡺ࡯࡬ࡥࡋࡧࡩࡳࡺࡩࡧ࡫ࡨࡶࠬസ")]
-          if bstack1lll111l1_opy_!= bstack1l1111ll_opy_[bstack1l1l_opy_ (u"ࠫࡳࡧ࡭ࡦࠩഹ")]:
-            logger.debug(bstack1llll11_opy_.format(bstack1l1111ll_opy_[bstack1l1l_opy_ (u"ࠬࡴࡡ࡮ࡧࠪഺ")], bstack1lll111l1_opy_))
...
-    hostname = bstack1lllll1l_opy_(url)
-    is_private = bstack1ll111111_opy_(hostname)
-    if not CONFIG[bstack1l1l_opy_ (u"࠭ࡢࡳࡱࡺࡷࡪࡸࡳࡵࡣࡦ࡯ࡑࡵࡣࡢ࡮഻ࠪ")] and is_private:
-      bstack11l111l_opy_ = hostname
-def bstack1lllll1l_opy_(url):
+  global bstack11l1l1l1_opy_
...
-def bstack1ll111111_opy_(hostname):
-  for bstack1l1l1l11_opy_ in bstack1lllllll_opy_:
-    regex = re.compile(bstack1l1l1l11_opy_)
...
### Comparing `browserstack_sdk-1.6.0/browserstack_sdk/browserstack.framework.yml.sample` & `browserstack_sdk-1.7.0/browserstack_sdk/browserstack.framework.yml.sample`

 * *Files identical despite different names*

### Comparing `browserstack_sdk-1.6.0/browserstack_sdk/browserstack.generic.yml.sample` & `browserstack_sdk-1.7.0/browserstack_sdk/browserstack.generic.yml.sample`

 * *Files identical despite different names*

### Comparing `browserstack_sdk-1.6.0/browserstack_sdk.egg-info/PKG-INFO` & `browserstack_sdk-1.7.0/browserstack_sdk.egg-info/PKG-INFO`
...
### Comparing `browserstack_sdk-1.6.0/pytest_browserstackplugin/plugin.py` & `browserstack_sdk-1.7.0/pytest_browserstackplugin/plugin.py`
...
-bstack1ll_opy_ = 2048
-bstack1l1_opy_ = 7
-def bstack1_opy_ (bstack11l_opy_):
-    global bstack11ll_opy_
-    stringNr = ord (bstack11l_opy_ [-1])
-    bstack111l_opy_ = bstack11l_opy_ [:-1]
-    bstack1lll1_opy_ = stringNr % len (bstack111l_opy_)
-    bstack1llll_opy_ = bstack111l_opy_ [:bstack1lll1_opy_] + bstack111l_opy_ [bstack1lll1_opy_:]
-    if bstack1l1l_opy_:
-        bstackl_opy_ = unicode () .join ([unichr (ord (char) - bstack1ll_opy_ - (bstack1l_opy_ + stringNr) % bstack1l1_opy_) for bstack1l_opy_, char in enumerate (bstack1llll_opy_)])
...
-        bstackl_opy_ = str () .join ([chr (ord (char) - bstack1ll_opy_ - (bstack1l_opy_ + stringNr) % bstack1l1_opy_) for bstack1l_opy_, char in enumerate (bstack1llll_opy_)])
...
+    return eval (bstack1_opy_)
 ...
 try:
     ...
     pass
 import json
-def bstack11_opy_(page, bstack1l11_opy_):
+def bstack1l1_opy_(page, bstack1l11_opy_):
   try:
-    page.evaluate(bstack1_opy_ (u"ࠦࡤࠦ࠽࠿ࠢࡾࢁࠧࠀ"), bstack1_opy_ (u"ࠬࡨࡲࡰࡹࡶࡩࡷࡹࡴࡢࡥ࡮ࡣࡪࡾࡥࡤࡷࡷࡳࡷࡀࠠࡼࠤࡤࡧࡹ࡯࡯࡯ࠤ࠽ࠤࠧࡹࡥࡵࡕࡨࡷࡸ࡯࡯࡯ࡐࡤࡱࡪࠨࠬࠡࠤࡤࡶ࡬ࡻ࡭ࡦࡰࡷࡷࠧࡀࠠࡼࠤࡱࡥࡲ࡫ࠢ࠻ࠩࠁ")+ json.dumps(bstack1l11_opy_) + bstack1_opy_ (u"ࠨࡽࡾࠤࠂ"))
...
-    print(bstack1_opy_ (u"ࠢࡦࡺࡦࡩࡵࡺࡩࡰࡰࠣ࡭ࡳࠦࡰ࡭ࡣࡼࡻࡷ࡯ࡧࡩࡶࠣࡷࡪࡹࡳࡪࡱࡱࠤࡳࡧ࡭ࡦࠢࡾࢁࠧࠃ"), e)
...
+def bstack11l_opy_(page, message, level):
   try:
-    page.evaluate(bstack1_opy_ (u"ࠣࡡࠣࡁࡃࠦࡻࡾࠤࠄ"), bstack1_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ࡫ࡠࡧࡻࡩࡨࡻࡴࡰࡴ࠽ࠤࢀࠨࡡࡤࡶ࡬ࡳࡳࠨ࠺ࠡࠤࡤࡲࡳࡵࡴࡢࡶࡨࠦ࠱ࠦࠢࡢࡴࡪࡹࡲ࡫࡮ࡵࡵࠥ࠾ࠥࢁࠢࡥࡣࡷࡥࠧࡀࠧࠅ") + json.dumps(message) + bstack1_opy_ (u"ࠪ࠰ࠧࡲࡥࡷࡧ࡯ࠦ࠿࠭ࠆ") + json.dumps(level) + bstack1_opy_ (u"ࠫࢂࢃࠧࠇ"))
...
-    print(bstack1_opy_ (u"ࠧ࡫ࡸࡤࡧࡳࡸ࡮ࡵ࡮ࠡ࡫ࡱࠤࡵࡲࡡࡺࡹࡵ࡭࡬࡮ࡴࠡࡣࡱࡲࡴࡺࡡࡵ࡫ࡲࡲࠥࢁࡽࠣࠈ"), e)
-def bstack1111_opy_(page, status, message = bstack1_opy_ (u"ࠨࠢࠉ")):
...
+def bstack11_opy_(page, status, message = bstack1l1l_opy_ (u"ࠨࠢࠉ")):
   try:
-    if(status == bstack1_opy_ (u"ࠢࡧࡣ࡬ࡰࡪࡪࠢࠊ")):
-      page.evaluate(bstack1_opy_ (u"ࠣࡡࠣࡁࡃࠦࡻࡾࠤࠋ"), bstack1_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ࡫ࡠࡧࡻࡩࡨࡻࡴࡰࡴ࠽ࠤࢀࠨࡡࡤࡶ࡬ࡳࡳࠨ࠺ࠡࠤࡶࡩࡹ࡙ࡥࡴࡵ࡬ࡳࡳ࡙ࡴࡢࡶࡸࡷࠧ࠲ࠠࠣࡣࡵ࡫ࡺࡳࡥ࡯ࡶࡶࠦ࠿ࠦࡻࠣࡴࡨࡥࡸࡵ࡮ࠣ࠼ࠪࠌ") + json.dumps(bstack1_opy_ (u"ࠥࡗࡨ࡫࡮ࡢࡴ࡬ࡳࠥ࡬ࡡࡪ࡮ࡨࡨࠥࡽࡩࡵࡪ࠽ࠤࠧࠍ") + str(message)) + bstack1_opy_ (u"ࠫ࠱ࠨࡳࡵࡣࡷࡹࡸࠨ࠺ࠨࠎ") + json.dumps(status) + bstack1_opy_ (u"ࠧࢃࡽࠣࠏ"))
...
-      page.evaluate(bstack1_opy_ (u"ࠨ࡟ࠡ࠿ࡁࠤࢀࢃࠢࠐ"), bstack1_opy_ (u"ࠧࡣࡴࡲࡻࡸ࡫ࡲࡴࡶࡤࡧࡰࡥࡥࡹࡧࡦࡹࡹࡵࡲ࠻ࠢࡾࠦࡦࡩࡴࡪࡱࡱࠦ࠿ࠦࠢࡴࡧࡷࡗࡪࡹࡳࡪࡱࡱࡗࡹࡧࡴࡶࡵࠥ࠰ࠥࠨࡡࡳࡩࡸࡱࡪࡴࡴࡴࠤ࠽ࠤࢀࠨࡳࡵࡣࡷࡹࡸࠨ࠺ࠨࠑ") + json.dumps(status) + bstack1_opy_ (u"ࠣࡿࢀࠦࠒ"))
...
-    print(bstack1_opy_ (u"ࠤࡨࡼࡨ࡫ࡰࡵ࡫ࡲࡲࠥ࡯࡮ࠡࡲ࡯ࡥࡾࡽࡲࡪࡩ࡫ࡸࠥࡹࡥࡵࠢࡶࡩࡸࡹࡩࡰࡰࠣࡷࡹࡧࡴࡶࡵࠣࡿࢂࠨࠓ"), e)
+    print(bstack1l1l_opy_ (u"ࠤࡨࡼࡨ࡫ࡰࡵ࡫ࡲࡲࠥ࡯࡮ࠡࡲ࡯ࡥࡾࡽࡲࡪࡩ࡫ࡸࠥࡹࡥࡵࠢࡶࡩࡸࡹࡩࡰࡰࠣࡷࡹࡧࡴࡶࡵࠣࡿࢂࠨࠓ"), e)
 @pytest.mark.hookwrapper
 def pytest_runtest_makereport(item, call):
     outcome = yield
-    plugins = item.config.getoption(bstack1_opy_ (u"ࠥࡴࡱࡻࡧࡪࡰࡶࠦࠔ"))
-    if(bstack1_opy_ (u"ࠦࡵࡿࡴࡦࡵࡷࡣࡧࡸ࡯ࡸࡵࡨࡶࡸࡺࡡࡤ࡭ࡳࡰࡺ࡭ࡩ࡯ࠤࠕ") not in plugins):
...
+    if(bstack1l1l_opy_ (u"ࠦࡵࡿࡴࡦࡵࡷࡣࡧࡸ࡯ࡸࡵࡨࡶࡸࡺࡡࡤ࡭ࡳࡰࡺ࡭ࡩ࡯ࠤࠕ") not in plugins):
     ...
     summary = []
-    driver = getattr(item, bstack1_opy_ (u"ࠧࡥࡤࡳ࡫ࡹࡩࡷࠨࠖ"), None)
-    page = getattr(item, bstack1_opy_ (u"ࠨ࡟ࡱࡣࡪࡩࠧࠗ"), None)
+    driver = getattr(item, bstack1l1l_opy_ (u"ࠧࡥࡤࡳ࡫ࡹࡩࡷࠨࠖ"), None)
+    page = getattr(item, bstack1l1l_opy_ (u"ࠨ࡟ࡱࡣࡪࡩࠧࠗ"), None)
     if(driver is not None):
-        bstack1ll1_opy_(item, report, summary)
-    if(page is not None):
         bstack11l1_opy_(item, report, summary)
-def bstack1ll1_opy_(item, report, summary):
-    if report.when in [bstack1_opy_ (u"ࠢࡴࡧࡷࡹࡵࠨ࠘"), bstack1_opy_ (u"ࠣࡶࡨࡥࡷࡪ࡯ࡸࡰࠥ࠙")]:
+    if(page is not None):
...
+    if report.when in [bstack1l1l_opy_ (u"ࠢࡴࡧࡷࡹࡵࠨ࠘"), bstack1l1l_opy_ (u"ࠣࡶࡨࡥࡷࡪ࡯ࡸࡰࠥ࠙")]:
             return
-    item._driver.execute_script(bstack1_opy_ (u"ࠩࡥࡶࡴࡽࡳࡦࡴࡶࡸࡦࡩ࡫ࡠࡧࡻࡩࡨࡻࡴࡰࡴ࠽ࠤࢀࠨࡡࡤࡶ࡬ࡳࡳࠨ࠺ࠡࠤࡶࡩࡹ࡙ࡥࡴࡵ࡬ࡳࡳࡔࡡ࡮ࡧࠥ࠰ࠥࠨࡡࡳࡩࡸࡱࡪࡴࡴࡴࠤ࠽ࠤࢀࠨ࡮ࡢ࡯ࡨࠦ࠿ࠦࠧࠚ") + json.dumps(report.nodeid) + bstack1_opy_ (u"ࠪࢁࢂ࠭ࠛ"))
-    passed = report.passed or (report.failed and hasattr(report, bstack1_opy_ (u"ࠦࡼࡧࡳࡹࡨࡤ࡭ࡱࠨࠜ")))
-    bstack111_opy_ = bstack1_opy_ (u"ࠧࠨࠝ")
...
+    bstack11ll_opy_ = bstack1l1l_opy_ (u"ࠧࠨࠝ")
     if not passed:
         try:
-            bstack111_opy_ = report.longrepr.reprcrash
+            bstack11ll_opy_ = report.longrepr.reprcrash
         except Exception as e:
             summary.append(
-                bstack1_opy_ (u"ࠨࡗࡂࡔࡑࡍࡓࡍ࠺ࠡࡈࡤ࡭ࡱ࡫ࡤࠡࡶࡲࠤࡩ࡫ࡴࡦࡴࡰ࡭ࡳ࡫ࠠࡧࡣ࡬ࡰࡺࡸࡥࠡࡴࡨࡥࡸࡵ࡮࠻ࠢࡾ࠴ࢂࠨࠞ").format(e)
+                bstack1l1l_opy_ (u"ࠨࡗࡂࡔࡑࡍࡓࡍ࠺ࠡࡈࡤ࡭ࡱ࡫ࡤࠡࡶࡲࠤࡩ࡫ࡴࡦࡴࡰ࡭ࡳ࡫ࠠࡧࡣ࡬ࡰࡺࡸࡥࠡࡴࡨࡥࡸࡵ࡮࠻ࠢࡾ࠴ࢂࠨࠞ").format(e)
             )
     try:
         if passed:
             item._driver.execute_script(
-                bstack1_opy_ (u"ࠧࡣࡴࡲࡻࡸ࡫ࡲࡴࡶࡤࡧࡰࡥࡥࡹࡧࡦࡹࡹࡵࡲ࠻ࠢࡾࠤࡡࠐࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠨࡡࡤࡶ࡬ࡳࡳࠨ࠺ࠡࠤࡶࡩࡹ࡙ࡥࡴࡵ࡬ࡳࡳ࡙ࡴࡢࡶࡸࡷࠧ࠲ࠠ࡝ࠌࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠤࡤࡶ࡬ࡻ࡭ࡦࡰࡷࡷࠧࡀࠠࡼࠢࠥࡷࡹࡧࡴࡶࡵࠥ࠾ࠧࡶࡡࡴࡵࡨࡨࠧࠦࡽࠡ࡞ࠍࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࢃࠧࠟ")
...
+            if bstack11ll_opy_:
                 item._driver.execute_script(
-                    bstack1_opy_ (u"ࠨࡤࡵࡳࡼࡹࡥࡳࡵࡷࡥࡨࡱ࡟ࡦࡺࡨࡧࡺࡺ࡯ࡳ࠼ࠣࡿࡡࠐࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠥࡥࡨࡺࡩࡰࡰࠥ࠾ࠥࠨࡡ࡯ࡰࡲࡸࡦࡺࡥࠣ࠮ࠣࡠࠏࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠤࡤࡶ࡬ࡻ࡭ࡦࡰࡷࡷࠧࡀࠠࡼ࡞ࠍࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠦࡱ࡫ࡶࡦ࡮ࠥ࠾ࠥࠨࡥࡳࡴࡲࡶࠧ࠲ࠠ࡝ࠌࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠥࡨࡦࡺࡡࠣ࠼ࠣࠫࠠ")
-                    + json.dumps(str(bstack111_opy_))
-                    + bstack1_opy_ (u"ࠤ࡟ࠎࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࡾ࡞ࠍࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࢀࠦࠡ")
...
+                    + bstack1l1l_opy_ (u"ࠤ࡟ࠎࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࡾ࡞ࠍࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࢀࠦࠡ")
                 ...
                 item._driver.execute_script(
-                    bstack1_opy_ (u"ࠪࡦࡷࡵࡷࡴࡧࡵࡷࡹࡧࡣ࡬ࡡࡨࡼࡪࡩࡵࡵࡱࡵ࠾ࠥࢁ࡜ࠋࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠧࡧࡣࡵ࡫ࡲࡲࠧࡀࠠࠣࡵࡨࡸࡘ࡫ࡳࡴ࡫ࡲࡲࡘࡺࡡࡵࡷࡶࠦ࠱ࠦ࡜ࠋࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠧࡧࡲࡨࡷࡰࡩࡳࡺࡳࠣ࠼ࠣࡿࡡࠐࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠢࡴࡶࡤࡸࡺࡹࠢ࠻ࠢࠥࡪࡦ࡯࡬ࡦࡦࠥ࠰ࠥࡢࠊࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠣࡴࡨࡥࡸࡵ࡮ࠣ࠼ࠣࠫࠢ")
-                    + json.dumps(str(bstack111_opy_))
-                    + bstack1_opy_ (u"ࠦࡡࠐࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࢀࡠࠏࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࢂࠨࠣ")
...
+                    + bstack1l1l_opy_ (u"ࠦࡡࠐࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࢀࡠࠏࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࢂࠨࠣ")
                 ...
                 item._driver.execute_script(
-                    bstack1_opy_ (u"ࠬࡨࡲࡰࡹࡶࡩࡷࡹࡴࡢࡥ࡮ࡣࡪࡾࡥࡤࡷࡷࡳࡷࡀࠠࡼࠢ࡟ࠎࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠣࡣࡦࡸ࡮ࡵ࡮ࠣ࠼ࠣࠦࡸ࡫ࡴࡔࡧࡶࡷ࡮ࡵ࡮ࡔࡶࡤࡸࡺࡹࠢ࠭ࠢ࡟ࠎࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠣࡣࡵ࡫ࡺࡳࡥ࡯ࡶࡶࠦ࠿ࠦࡻࠡࠤࡶࡸࡦࡺࡵࡴࠤ࠽ࠦ࡫ࡧࡩ࡭ࡧࡧࠦࠥࢃࠠ࡝ࠌࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࡿࠪࠤ")
...
-        summary.append(bstack1_opy_ (u"ࠨࡗࡂࡔࡑࡍࡓࡍ࠺ࠡࡈࡤ࡭ࡱ࡫ࡤࠡࡶࡲࠤࡺࡶࡤࡢࡶࡨࠤࡸ࡫ࡳࡴ࡫ࡲࡲࠥࡹࡴࡢࡶࡸࡷ࠿ࠦࡻ࠱ࡿࠥࠥ").format(e))
-def bstack11l1_opy_(item, report, summary):
-    if report.when in [bstack1_opy_ (u"ࠢࡴࡧࡷࡹࡵࠨࠦ"), bstack1_opy_ (u"ࠣࡶࡨࡥࡷࡪ࡯ࡸࡰࠥࠧ")]:
...
+    if report.when in [bstack1l1l_opy_ (u"ࠢࡴࡧࡷࡹࡵࠨࠦ"), bstack1l1l_opy_ (u"ࠣࡶࡨࡥࡷࡪ࡯ࡸࡰࠥࠧ")]:
             return
-    bstack11_opy_(item._page, report.nodeid)
-    passed = report.passed or (report.failed and hasattr(report, bstack1_opy_ (u"ࠤࡺࡥࡸࡾࡦࡢ࡫࡯ࠦࠨ")))
-    bstack111_opy_ = bstack1_opy_ (u"ࠥࠦࠩ")
...
+            bstack11ll_opy_ = report.longrepr.reprcrash
             ...
             summary.append(
-                bstack1_opy_ (u"ࠦ࡜ࡇࡒࡏࡋࡑࡋ࠿ࠦࡆࡢ࡫࡯ࡩࡩࠦࡴࡰࠢࡧࡩࡹ࡫ࡲ࡮࡫ࡱࡩࠥ࡬ࡡࡪ࡮ࡸࡶࡪࠦࡲࡦࡣࡶࡳࡳࡀࠠࡼ࠲ࢀࠦࠪ").format(e)
+                bstack1l1l_opy_ (u"ࠦ࡜ࡇࡒࡏࡋࡑࡋ࠿ࠦࡆࡢ࡫࡯ࡩࡩࠦࡴࡰࠢࡧࡩࡹ࡫ࡲ࡮࡫ࡱࡩࠥ࡬ࡡࡪ࡮ࡸࡶࡪࠦࡲࡦࡣࡶࡳࡳࡀࠠࡼ࠲ࢀࠦࠪ").format(e)
             )
     try:
         if passed:
-            bstack1111_opy_(item._page, bstack1_opy_ (u"ࠧࡶࡡࡴࡵࡨࡨࠧࠫ"))
+            bstack11_opy_(item._page, bstack1l1l_opy_ (u"ࠧࡶࡡࡴࡵࡨࡨࠧࠫ"))
         else:
-            if bstack111_opy_:
-                bstack1lll_opy_(item._page, str(bstack111_opy_), bstack1_opy_ (u"ࠨࡥࡳࡴࡲࡶࠧࠬ"))
-                bstack1111_opy_(item._page, bstack1_opy_ (u"ࠢࡧࡣ࡬ࡰࡪࡪࠢ࠭"), str(bstack111_opy_))
+            if bstack11ll_opy_:
...
-                bstack1111_opy_(item._page, bstack1_opy_ (u"ࠣࡨࡤ࡭ࡱ࡫ࡤࠣ࠮"))
+                bstack11_opy_(item._page, bstack1l1l_opy_ (u"ࠣࡨࡤ࡭ࡱ࡫ࡤࠣ࠮"))
     except Exception as e:
-        summary.append(bstack1_opy_ (u"ࠤ࡚ࡅࡗࡔࡉࡏࡉ࠽ࠤࡋࡧࡩ࡭ࡧࡧࠤࡹࡵࠠࡶࡲࡧࡥࡹ࡫ࠠࡴࡧࡶࡷ࡮ࡵ࡮ࠡࡵࡷࡥࡹࡻࡳ࠻ࠢࡾ࠴ࢂࠨ࠯").format(e))
...
-        parser.addoption(bstack1_opy_ (u"ࠥ࠱࠲ࡪࡲࡪࡸࡨࡶࠧ࠰"), action=bstack1_opy_ (u"ࠦࡸࡺ࡯ࡳࡧࠥ࠱"), default=bstack1_opy_ (u"ࠧࡩࡨࡳࡱࡰࡩࠧ࠲"),
-                        help=bstack1_opy_ (u"ࠨࡄࡳ࡫ࡹࡩࡷࠦࡴࡰࠢࡵࡹࡳࠦࡴࡦࡵࡷࡷࠧ࠳"))
...
### Comparing `browserstack_sdk-1.6.0/setup.py` & `browserstack_sdk-1.7.0/setup.py`
