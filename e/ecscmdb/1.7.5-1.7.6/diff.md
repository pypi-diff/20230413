# Comparing `tmp/ecscmdb-1.7.5.tar.gz` & `tmp/ecscmdb-1.7.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "ecscmdb-1.7.5.tar", max compression
+gzip compressed data, was "ecscmdb-1.7.6.tar", max compression
```

## Comparing `ecscmdb-1.7.5.tar` & `ecscmdb-1.7.6.tar`

### file list

```diff
@@ -1,13 +1,13 @@
--rw-r--r--   0        0        0    23960 2023-03-23 22:14:40.750876 ecscmdb-1.7.5/ChangeLog
--rw-r--r--   0        0        0     1075 2020-11-06 03:38:26.304234 ecscmdb-1.7.5/LICENSE.txt
--rw-r--r--   0        0        0    21667 2023-03-23 18:57:58.650594 ecscmdb-1.7.5/README.md
--rw-r--r--   0        0        0     1961 2023-03-31 16:58:52.999052 ecscmdb-1.7.5/pyproject.toml
--rw-r--r--   0        0        0      767 2023-01-19 22:49:05.887313 ecscmdb-1.7.5/src/ecscmdb/__init__.py
--rw-r--r--   0        0        0     8146 2023-02-20 21:18:27.407821 ecscmdb-1.7.5/src/ecscmdb/api.py
--rw-r--r--   0        0        0    22998 2023-03-16 21:38:14.128543 ecscmdb-1.7.5/src/ecscmdb/cmdb.py
--rw-r--r--   0        0        0    18320 2023-03-16 21:38:14.128543 ecscmdb-1.7.5/src/ecscmdb/cmdbdiff.py
--rw-r--r--   0        0        0     7543 2023-03-23 22:14:40.750876 ecscmdb-1.7.5/src/ecscmdb/finddifferences.py
--rw-r--r--   0        0        0     9055 2023-03-16 21:38:14.128543 ecscmdb-1.7.5/src/ecscmdb/initcheck.py
--rw-r--r--   0        0        0     4432 2023-03-04 03:40:16.010718 ecscmdb-1.7.5/src/ecscmdb/updatecells.py
--rw-r--r--   0        0        0    23588 1970-01-01 00:00:00.000000 ecscmdb-1.7.5/setup.py
--rw-r--r--   0        0        0    23612 1970-01-01 00:00:00.000000 ecscmdb-1.7.5/PKG-INFO
+-rw-r--r--   0        0        0    24234 2023-04-13 20:42:38.830385 ecscmdb-1.7.6/ChangeLog
+-rw-r--r--   0        0        0     1075 2020-11-06 03:38:26.304234 ecscmdb-1.7.6/LICENSE.txt
+-rw-r--r--   0        0        0    21667 2023-03-23 18:57:58.650594 ecscmdb-1.7.6/README.md
+-rw-r--r--   0        0        0     1961 2023-04-13 20:42:38.830385 ecscmdb-1.7.6/pyproject.toml
+-rw-r--r--   0        0        0      767 2023-01-19 22:49:05.887313 ecscmdb-1.7.6/src/ecscmdb/__init__.py
+-rw-r--r--   0        0        0     8431 2023-04-13 20:42:38.830385 ecscmdb-1.7.6/src/ecscmdb/api.py
+-rw-r--r--   0        0        0    22980 2023-04-13 20:42:38.830385 ecscmdb-1.7.6/src/ecscmdb/cmdb.py
+-rw-r--r--   0        0        0    18320 2023-03-16 21:38:14.128543 ecscmdb-1.7.6/src/ecscmdb/cmdbdiff.py
+-rw-r--r--   0        0        0     7543 2023-03-23 22:14:40.750876 ecscmdb-1.7.6/src/ecscmdb/finddifferences.py
+-rw-r--r--   0        0        0     9055 2023-03-16 21:38:14.128543 ecscmdb-1.7.6/src/ecscmdb/initcheck.py
+-rw-r--r--   0        0        0     4432 2023-03-04 03:40:16.010718 ecscmdb-1.7.6/src/ecscmdb/updatecells.py
+-rw-r--r--   0        0        0    23588 1970-01-01 00:00:00.000000 ecscmdb-1.7.6/setup.py
+-rw-r--r--   0        0        0    23612 1970-01-01 00:00:00.000000 ecscmdb-1.7.6/PKG-INFO
```

### Comparing `ecscmdb-1.7.5/ChangeLog` & `ecscmdb-1.7.6/ChangeLog`
...
+
+	* pyproject.toml: Update ECScmdb version to v1.7.6.  Update
+	ECSpylibs version to v1.1.31.
+
+	* src/ecscmdb/cmdb.py (main): Fix typo in logger output.
+
+	* src/ecscmdb/api.py: Add time stats to get_inventory_details.
+
 2023-03-23  Thomas R. Stevenson  <tom@tom.cc.wayne.edu>
 	...
 	* src/ecscmdb/finddifferences.py
 	(FindDifferences.find_differences): Comment out code that adds a
```

### Comparing `ecscmdb-1.7.5/LICENSE.txt` & `ecscmdb-1.7.6/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `ecscmdb-1.7.5/README.md` & `ecscmdb-1.7.6/README.md`

 * *Files identical despite different names*

### Comparing `ecscmdb-1.7.5/pyproject.toml` & `ecscmdb-1.7.6/pyproject.toml`
...
@@ -1,21 +1,21 @@
 ...
 #
-# Last Changed:  $Date: Thu Mar 23 18:14:14 2023 -0400 $
...
### Comparing `ecscmdb-1.7.5/src/ecscmdb/__init__.py` & `ecscmdb-1.7.6/src/ecscmdb/__init__.py`

 * *Files identical despite different names*

### Comparing `ecscmdb-1.7.5/src/ecscmdb/api.py` & `ecscmdb-1.7.6/src/ecscmdb/api.py`
...
### Comparing `ecscmdb-1.7.5/src/ecscmdb/cmdb.py` & `ecscmdb-1.7.6/src/ecscmdb/cmdb.py`
...
@@ -2,15 +2,15 @@
 ...
 # Author:        $Id: Thomas R. Stevenson <aa0026@wayne.edu> $
 #
-# Last Changed:  $Date: Wed Mar 8 10:48:34 2023 -0500 $
+# Last Changed:  $Date: Thu Apr 13 16:42:12 2023 -0400 $
 #
 # URL to git source: $URL: git@git.wayne.edu:ECS_Projects/ECScmdb.git $
 #
...
-    logger.debug(f"Calling Parallel(ome_api.getInventoryDetails, process_pool=True, pool_size={pool_size})")
...
### Comparing `ecscmdb-1.7.5/src/ecscmdb/cmdbdiff.py` & `ecscmdb-1.7.6/src/ecscmdb/cmdbdiff.py`

 * *Files identical despite different names*

### Comparing `ecscmdb-1.7.5/src/ecscmdb/finddifferences.py` & `ecscmdb-1.7.6/src/ecscmdb/finddifferences.py`

 * *Files identical despite different names*

### Comparing `ecscmdb-1.7.5/src/ecscmdb/initcheck.py` & `ecscmdb-1.7.6/src/ecscmdb/initcheck.py`

 * *Files identical despite different names*

### Comparing `ecscmdb-1.7.5/src/ecscmdb/updatecells.py` & `ecscmdb-1.7.6/src/ecscmdb/updatecells.py`

 * *Files identical despite different names*

### Comparing `ecscmdb-1.7.5/setup.py` & `ecscmdb-1.7.6/setup.py`
...
@@ -14,15 +14,15 @@
 ['Autologging>=1.3.2,<2.0.0',
  ...
  'docopt>=0.6.2,<0.7.0',
- 'ecspylibs>=v1.1.30,<2.0.0',
+ 'ecspylibs>=v1.1.31,<2.0.0',
  'idna>=3.4,<4.0',
  'numpy==1.19.1',
  'pandas==1.0.5',
...
### Comparing `ecscmdb-1.7.5/PKG-INFO` & `ecscmdb-1.7.6/PKG-INFO`
...
-Requires-Dist: ecspylibs (>=v1.1.30,<2.0.0)
+Requires-Dist: ecspylibs (>=v1.1.31,<2.0.0)
