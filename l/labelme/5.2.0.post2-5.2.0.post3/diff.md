# Comparing `tmp/labelme-5.2.0.post2.tar.gz` & `tmp/labelme-5.2.0.post3.tar.gz`
...
### Comparing `labelme-5.2.0.post2/labelme/widgets/zoom_widget.py` & `labelme-5.2.0.post3/labelme/widgets/zoom_widget.py`
