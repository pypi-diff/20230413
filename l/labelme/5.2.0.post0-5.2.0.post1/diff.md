# Comparing `tmp/labelme-5.2.0.post0.tar.gz` & `tmp/labelme-5.2.0.post1.tar.gz`
...
### Comparing `labelme-5.2.0.post0/labelme/widgets/zoom_widget.py` & `labelme-5.2.0.post1/labelme/widgets/zoom_widget.py`
