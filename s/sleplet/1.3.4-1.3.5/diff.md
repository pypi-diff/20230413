# Comparing `tmp/sleplet-1.3.4.tar.gz` & `tmp/sleplet-1.3.5.tar.gz`
...
### Comparing `sleplet-1.3.4/.github/ISSUE_TEMPLATE/bug_report.md` & `sleplet-1.3.5/.github/ISSUE_TEMPLATE/bug_report.md`
...
### Comparing `sleplet-1.3.4/examples/arbitrary/_slepian_wavelet_covariance.py` & `sleplet-1.3.5/examples/arbitrary/_slepian_wavelet_covariance.py`
...
### Comparing `sleplet-1.3.4/examples/misc/denoising_axisym_south_america.py` & `sleplet-1.3.5/examples/misc/denoising_axisym_south_america.py`
...
### Comparing `sleplet-1.3.4/examples/wavelets/axisymmetric_tiling.py` & `sleplet-1.3.5/examples/wavelets/axisymmetric_tiling.py`
...
### Comparing `sleplet-1.3.4/pyproject.toml` & `sleplet-1.3.5/pyproject.toml`
...
### Comparing `sleplet-1.3.4/src/sleplet/_mesh_methods.py` & `sleplet-1.3.5/src/sleplet/_mesh_methods.py`
...
### Comparing `sleplet-1.3.4/src/sleplet/_slepian_arbitrary_methods.py` & `sleplet-1.3.5/src/sleplet/_slepian_arbitrary_methods.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/_smoothing.py` & `sleplet-1.3.5/src/sleplet/_smoothing.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/_string_methods.py` & `sleplet-1.3.5/src/sleplet/_string_methods.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/__init__.py` & `sleplet-1.3.5/src/sleplet/functions/__init__.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/africa.py` & `sleplet-1.3.5/src/sleplet/functions/africa.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/axisymmetric_wavelet_coefficients_africa.py` & `sleplet-1.3.5/src/sleplet/functions/axisymmetric_wavelet_coefficients_africa.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/axisymmetric_wavelet_coefficients_earth.py` & `sleplet-1.3.5/src/sleplet/functions/axisymmetric_wavelet_coefficients_earth.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/axisymmetric_wavelet_coefficients_south_america.py` & `sleplet-1.3.5/src/sleplet/functions/axisymmetric_wavelet_coefficients_south_america.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/axisymmetric_wavelets.py` & `sleplet-1.3.5/src/sleplet/functions/axisymmetric_wavelets.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/coefficients.py` & `sleplet-1.3.5/src/sleplet/functions/coefficients.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/dirac_delta.py` & `sleplet-1.3.5/src/sleplet/functions/dirac_delta.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/directional_spin_wavelets.py` & `sleplet-1.3.5/src/sleplet/functions/directional_spin_wavelets.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/earth.py` & `sleplet-1.3.5/src/sleplet/functions/earth.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/elongated_gaussian.py` & `sleplet-1.3.5/src/sleplet/functions/elongated_gaussian.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/flm.py` & `sleplet-1.3.5/src/sleplet/functions/flm.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/fp.py` & `sleplet-1.3.5/src/sleplet/functions/fp.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/gaussian.py` & `sleplet-1.3.5/src/sleplet/functions/gaussian.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/harmonic_gaussian.py` & `sleplet-1.3.5/src/sleplet/functions/harmonic_gaussian.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/identity.py` & `sleplet-1.3.5/src/sleplet/functions/identity.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/noise_earth.py` & `sleplet-1.3.5/src/sleplet/functions/noise_earth.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/ridgelets.py` & `sleplet-1.3.5/src/sleplet/functions/ridgelets.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/slepian.py` & `sleplet-1.3.5/src/sleplet/functions/slepian.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/slepian_africa.py` & `sleplet-1.3.5/src/sleplet/functions/slepian_africa.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/slepian_dirac_delta.py` & `sleplet-1.3.5/src/sleplet/functions/slepian_dirac_delta.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/slepian_identity.py` & `sleplet-1.3.5/src/sleplet/functions/slepian_identity.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/slepian_noise_africa.py` & `sleplet-1.3.5/src/sleplet/functions/slepian_noise_africa.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/slepian_noise_south_america.py` & `sleplet-1.3.5/src/sleplet/functions/slepian_noise_south_america.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/slepian_south_america.py` & `sleplet-1.3.5/src/sleplet/functions/slepian_south_america.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/slepian_wavelet_coefficients_africa.py` & `sleplet-1.3.5/src/sleplet/functions/slepian_wavelet_coefficients_africa.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/slepian_wavelet_coefficients_south_america.py` & `sleplet-1.3.5/src/sleplet/functions/slepian_wavelet_coefficients_south_america.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/slepian_wavelets.py` & `sleplet-1.3.5/src/sleplet/functions/slepian_wavelets.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/south_america.py` & `sleplet-1.3.5/src/sleplet/functions/south_america.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/spherical_harmonic.py` & `sleplet-1.3.5/src/sleplet/functions/spherical_harmonic.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/squashed_gaussian.py` & `sleplet-1.3.5/src/sleplet/functions/squashed_gaussian.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/functions/wmap.py` & `sleplet-1.3.5/src/sleplet/functions/wmap.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/harmonic_methods.py` & `sleplet-1.3.5/src/sleplet/harmonic_methods.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/__init__.py` & `sleplet-1.3.5/src/sleplet/meshes/__init__.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/_mesh_slepian_decomposition.py` & `sleplet-1.3.5/src/sleplet/meshes/_mesh_slepian_decomposition.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh_basis_functions.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh_basis_functions.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh_coefficients.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh_coefficients.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh_field.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh_field.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh_harmonic_coefficients.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh_harmonic_coefficients.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh_noise_field.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh_noise_field.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh_slepian.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh_slepian.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh_slepian_coefficients.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh_slepian_coefficients.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh_slepian_field.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh_slepian_field.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh_slepian_functions.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh_slepian_functions.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh_slepian_noise_field.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh_slepian_noise_field.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh_slepian_wavelet_coefficients.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh_slepian_wavelet_coefficients.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/meshes/mesh_slepian_wavelets.py` & `sleplet-1.3.5/src/sleplet/meshes/mesh_slepian_wavelets.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/noise.py` & `sleplet-1.3.5/src/sleplet/noise.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/plot_methods.py` & `sleplet-1.3.5/src/sleplet/plot_methods.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/plotting/_create_plot_mesh.py` & `sleplet-1.3.5/src/sleplet/plotting/_create_plot_mesh.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/plotting/_create_plot_sphere.py` & `sleplet-1.3.5/src/sleplet/plotting/_create_plot_sphere.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/slepian/_slepian_decomposition.py` & `sleplet-1.3.5/src/sleplet/slepian/_slepian_decomposition.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/slepian/region.py` & `sleplet-1.3.5/src/sleplet/slepian/region.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/slepian/slepian_arbitrary.py` & `sleplet-1.3.5/src/sleplet/slepian/slepian_arbitrary.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/slepian/slepian_functions.py` & `sleplet-1.3.5/src/sleplet/slepian/slepian_functions.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/slepian/slepian_limit_lat_lon.py` & `sleplet-1.3.5/src/sleplet/slepian/slepian_limit_lat_lon.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/slepian/slepian_polar_cap.py` & `sleplet-1.3.5/src/sleplet/slepian/slepian_polar_cap.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/slepian_methods.py` & `sleplet-1.3.5/src/sleplet/slepian_methods.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet/wavelet_methods.py` & `sleplet-1.3.5/src/sleplet/wavelet_methods.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/src/sleplet.egg-info/PKG-INFO` & `sleplet-1.3.5/src/sleplet.egg-info/PKG-INFO`
...
### Comparing `sleplet-1.3.4/src/sleplet.egg-info/SOURCES.txt` & `sleplet-1.3.5/src/sleplet.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/conftest.py` & `sleplet-1.3.5/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_arbitrary_region.py` & `sleplet-1.3.5/tests/test_arbitrary_region.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_arrays.py` & `sleplet-1.3.5/tests/test_arrays.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_bool.py` & `sleplet-1.3.5/tests/test_bool.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_convolution.py` & `sleplet-1.3.5/tests/test_convolution.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_decomposition.py` & `sleplet-1.3.5/tests/test_decomposition.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_harmonic.py` & `sleplet-1.3.5/tests/test_harmonic.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_loading_pooch.py` & `sleplet-1.3.5/tests/test_loading_pooch.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_mesh.py` & `sleplet-1.3.5/tests/test_mesh.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_plot.py` & `sleplet-1.3.5/tests/test_plot.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_region.py` & `sleplet-1.3.5/tests/test_region.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_slepian_mesh.py` & `sleplet-1.3.5/tests/test_slepian_mesh.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_strings.py` & `sleplet-1.3.5/tests/test_strings.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_translation.py` & `sleplet-1.3.5/tests/test_translation.py`

 * *Files identical despite different names*

### Comparing `sleplet-1.3.4/tests/test_wavelets.py` & `sleplet-1.3.5/tests/test_wavelets.py`
