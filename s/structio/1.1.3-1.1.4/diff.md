# Comparing `tmp/structio-1.1.3.tar.gz` & `tmp/structio-1.1.4.tar.gz`
...
## Comparing `structio-1.1.3.tar` & `structio-1.1.4.tar`
...
### Comparing `structio-1.1.3/PKG-INFO` & `structio-1.1.4/PKG-INFO`
...
### Comparing `structio-1.1.3/README.md` & `structio-1.1.4/structio.egg-info/PKG-INFO`
...
### Comparing `structio-1.1.3/structio.py` & `structio-1.1.4/structio.py`
