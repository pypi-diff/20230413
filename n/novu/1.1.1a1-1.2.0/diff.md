# Comparing `tmp/novu-1.1.1a1.tar.gz` & `tmp/novu-1.2.0.tar.gz`
...
### Comparing `novu-1.1.1a1/LICENSE` & `novu-1.2.0/LICENSE`
...
### Comparing `novu-1.1.1a1/PKG-INFO` & `novu-1.2.0/PKG-INFO`
