# Comparing `tmp/tencentcloud-sdk-python-cds-3.0.871.tar.gz` & `tmp/tencentcloud-sdk-python-cds-3.0.872.tar.gz`
...
## Comparing `tencentcloud-sdk-python-cds-3.0.871.tar` & `tencentcloud-sdk-python-cds-3.0.872.tar`
...
### Comparing `tencentcloud-sdk-python-cds-3.0.871/PKG-INFO` & `tencentcloud-sdk-python-cds-3.0.872/tencentcloud_sdk_python_cds.egg-info/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-cds-3.0.871/tencentcloud/cds/v20180420/models.py` & `tencentcloud-sdk-python-cds-3.0.872/tencentcloud/cds/v20180420/models.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-cds-3.0.871/tencentcloud/cds/v20180420/cds_client.py` & `tencentcloud-sdk-python-cds-3.0.872/tencentcloud/cds/v20180420/cds_client.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-cds-3.0.871/tencentcloud/cds/v20180420/errorcodes.py` & `tencentcloud-sdk-python-cds-3.0.872/tencentcloud/cds/v20180420/errorcodes.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-cds-3.0.871/tencentcloud/__init__.py` & `tencentcloud-sdk-python-cds-3.0.872/tencentcloud/__init__.py`
...
### Comparing `tencentcloud-sdk-python-cds-3.0.871/tencentcloud_sdk_python_cds.egg-info/PKG-INFO` & `tencentcloud-sdk-python-cds-3.0.872/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-cds-3.0.871/README.rst` & `tencentcloud-sdk-python-cds-3.0.872/README.rst`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-cds-3.0.871/setup.py` & `tencentcloud-sdk-python-cds-3.0.872/setup.py`
