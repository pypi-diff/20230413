# Comparing `tmp/datayoga-1.80.0.tar.gz` & `tmp/datayoga-1.9.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "datayoga-1.80.0.tar", max compression
+gzip compressed data, was "datayoga-1.9.0.tar", max compression
```

## Comparing `datayoga-1.80.0.tar` & `datayoga-1.9.0.tar`

### file list

```diff
@@ -1,6 +1,7 @@
--rw-r--r--   0        0        0      633 2023-04-13 12:46:34.102352 datayoga-1.80.0/README.md
--rw-r--r--   0        0        0     1284 2023-04-13 12:46:56.799848 datayoga-1.80.0/pyproject.toml
--rw-r--r--   0        0        0        0 2023-04-13 12:46:34.102352 datayoga-1.80.0/src/datayoga/__init__.py
--rw-r--r--   0        0        0     5300 2023-04-13 12:46:34.102352 datayoga-1.80.0/src/datayoga/__main__.py
--rw-r--r--   0        0        0     3280 2023-04-13 12:46:34.102352 datayoga-1.80.0/src/datayoga/cli_helpers.py
--rw-r--r--   0        0        0     2082 1970-01-01 00:00:00.000000 datayoga-1.80.0/PKG-INFO
...
### Comparing `datayoga-1.80.0/pyproject.toml` & `datayoga-1.9.0/pyproject.toml`
...
### Comparing `datayoga-1.80.0/src/datayoga/__main__.py` & `datayoga-1.9.0/src/datayoga/__main__.py`
...
### Comparing `datayoga-1.80.0/PKG-INFO` & `datayoga-1.9.0/PKG-INFO`
