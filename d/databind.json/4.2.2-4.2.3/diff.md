# Comparing `tmp/databind.json-4.2.2.tar.gz` & `tmp/databind.json-4.2.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "databind.json-4.2.2.tar", max compression
+gzip compressed data, was "databind.json-4.2.3.tar", max compression
```

## Comparing `databind.json-4.2.2.tar` & `databind.json-4.2.3.tar`

### file list

```diff
@@ -1,9 +1,9 @@
--rw-r--r--   0        0        0     1600 2022-11-30 15:24:22.313944 databind.json-4.2.2/pyproject.toml
--rw-r--r--   0        0        0     3339 2022-11-21 14:37:01.200350 databind.json-4.2.2/readme.md
--rw-r--r--   0        0        0     2358 2022-11-30 15:24:22.317944 databind.json-4.2.2/src/databind/json/__init__.py
--rw-r--r--   0        0        0    33037 2022-11-30 15:24:15.341984 databind.json-4.2.2/src/databind/json/converters.py
--rw-r--r--   0        0        0     2706 2022-11-21 14:51:10.447657 databind.json-4.2.2/src/databind/json/module.py
--rw-r--r--   0        0        0        0 2022-11-07 01:00:21.858603 databind.json-4.2.2/src/databind/json/py.typed
--rw-r--r--   0        0        0     1364 2022-11-07 01:00:21.858603 databind.json-4.2.2/src/databind/json/settings.py
--rw-r--r--   0        0        0     4232 2022-11-30 15:25:09.571637 databind.json-4.2.2/setup.py
--rw-r--r--   0        0        0     4368 2022-11-30 15:25:09.572287 databind.json-4.2.2/PKG-INFO
+-rw-r--r--   0        0        0     1600 2023-04-12 21:58:45.391794 databind.json-4.2.3/pyproject.toml
+-rw-r--r--   0        0        0     3339 2023-03-01 15:01:37.487224 databind.json-4.2.3/readme.md
+-rw-r--r--   0        0        0     2358 2023-04-12 21:58:45.391794 databind.json-4.2.3/src/databind/json/__init__.py
+-rw-r--r--   0        0        0    33037 2023-03-01 15:01:37.487224 databind.json-4.2.3/src/databind/json/converters.py
+-rw-r--r--   0        0        0     2706 2023-03-01 15:01:37.487224 databind.json-4.2.3/src/databind/json/module.py
+-rw-r--r--   0        0        0        0 2023-03-01 15:01:37.487224 databind.json-4.2.3/src/databind/json/py.typed
+-rw-r--r--   0        0        0     1364 2023-03-01 15:01:37.487224 databind.json-4.2.3/src/databind/json/settings.py
+-rw-r--r--   0        0        0     4232 2023-04-12 21:58:59.137369 databind.json-4.2.3/setup.py
+-rw-r--r--   0        0        0     4368 2023-04-12 21:58:59.137793 databind.json-4.2.3/PKG-INFO
```

### Comparing `databind.json-4.2.2/pyproject.toml` & `databind.json-4.2.3/pyproject.toml`
...
### Comparing `databind.json-4.2.2/readme.md` & `databind.json-4.2.3/readme.md`

 * *Files identical despite different names*

### Comparing `databind.json-4.2.2/src/databind/json/__init__.py` & `databind.json-4.2.3/src/databind/json/__init__.py`
...
### Comparing `databind.json-4.2.2/src/databind/json/converters.py` & `databind.json-4.2.3/src/databind/json/converters.py`

 * *Files identical despite different names*

### Comparing `databind.json-4.2.2/src/databind/json/module.py` & `databind.json-4.2.3/src/databind/json/module.py`

 * *Files identical despite different names*

### Comparing `databind.json-4.2.2/src/databind/json/settings.py` & `databind.json-4.2.3/src/databind/json/settings.py`

 * *Files identical despite different names*

### Comparing `databind.json-4.2.2/setup.py` & `databind.json-4.2.3/setup.py`
...
@@ -7,22 +7,22 @@
 ...
 install_requires = \
-['databind.core>=4.2.2,<5.0.0',
+['databind.core>=4.2.3,<5.0.0',
  'nr-date>=2.0.0,<3.0.0',
  'typeapi>=1.2.1,<2.0.0',
  'typing-extensions>=3.10.0']
...
### Comparing `databind.json-4.2.2/PKG-INFO` & `databind.json-4.2.3/PKG-INFO`
...
-Requires-Dist: databind.core (>=4.2.2,<5.0.0)
+Requires-Dist: databind.core (>=4.2.3,<5.0.0)
