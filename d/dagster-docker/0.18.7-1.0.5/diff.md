# Comparing `tmp/dagster-docker-0.18.7.tar.gz` & `tmp/dagster-docker-1.0.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dagster-docker-0.18.7.tar", last modified: Thu Apr 13 15:15:37 2023, max compression
+gzip compressed data, was "dagster-docker-1.0.5.tar", last modified: Fri Aug 26 13:44:58 2022, max compression
```

## Comparing `dagster-docker-0.18.7.tar` & `dagster-docker-1.0.5.tar`

### file list

```diff
@@ -1,25 +1,22 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-13 15:15:37.081815 dagster-docker-0.18.7/
--rw-r--r--   0 root         (0) root         (0)    11344 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/LICENSE
--rw-r--r--   0 root         (0) root         (0)       48 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/MANIFEST.in
--rw-r--r--   0 root         (0) root         (0)      656 2023-04-13 15:15:37.081815 dagster-docker-0.18.7/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      128 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/README.md
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-13 15:15:37.077815 dagster-docker-0.18.7/dagster_docker/
--rw-r--r--   0 root         (0) root         (0)      420 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/dagster_docker/__init__.py
--rw-r--r--   0 root         (0) root         (0)     6484 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/dagster_docker/container_context.py
--rw-r--r--   0 root         (0) root         (0)    11763 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/dagster_docker/docker_executor.py
--rw-r--r--   0 root         (0) root         (0)     7462 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/dagster_docker/docker_run_launcher.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-13 15:15:37.081815 dagster-docker-0.18.7/dagster_docker/ops/
--rw-r--r--   0 root         (0) root         (0)      143 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/dagster_docker/ops/__init__.py
--rw-r--r--   0 root         (0) root         (0)     6366 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/dagster_docker/ops/docker_container_op.py
--rw-r--r--   0 root         (0) root         (0)        8 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/dagster_docker/py.typed
--rw-r--r--   0 root         (0) root         (0)     1892 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/dagster_docker/utils.py
--rw-r--r--   0 root         (0) root         (0)       23 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/dagster_docker/version.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-13 15:15:37.081815 dagster-docker-0.18.7/dagster_docker.egg-info/
--rw-r--r--   0 root         (0) root         (0)      656 2023-04-13 15:15:37.000000 dagster-docker-0.18.7/dagster_docker.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      556 2023-04-13 15:15:37.000000 dagster-docker-0.18.7/dagster_docker.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-04-13 15:15:37.000000 dagster-docker-0.18.7/dagster_docker.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-04-13 15:15:37.000000 dagster-docker-0.18.7/dagster_docker.egg-info/not-zip-safe
--rw-r--r--   0 root         (0) root         (0)       38 2023-04-13 15:15:37.000000 dagster-docker-0.18.7/dagster_docker.egg-info/requires.txt
--rw-r--r--   0 root         (0) root         (0)       15 2023-04-13 15:15:37.000000 dagster-docker-0.18.7/dagster_docker.egg-info/top_level.txt
--rw-r--r--   0 root         (0) root         (0)      125 2023-04-13 15:15:37.081815 dagster-docker-0.18.7/setup.cfg
--rw-r--r--   0 root         (0) root         (0)     1265 2023-04-13 15:03:07.000000 dagster-docker-0.18.7/setup.py
...
### Comparing `dagster-docker-0.18.7/LICENSE` & `dagster-docker-1.0.5/LICENSE`
...
### Comparing `dagster-docker-0.18.7/dagster_docker/container_context.py` & `dagster-docker-1.0.5/dagster_docker/container_context.py`
...
### Comparing `dagster-docker-0.18.7/dagster_docker/docker_executor.py` & `dagster-docker-1.0.5/dagster_docker/docker_executor.py`
...
### Comparing `dagster-docker-0.18.7/dagster_docker/docker_run_launcher.py` & `dagster-docker-1.0.5/dagster_docker/docker_run_launcher.py`
...
### Comparing `dagster-docker-0.18.7/dagster_docker/utils.py` & `dagster-docker-1.0.5/dagster_docker/utils.py`
...
### Comparing `dagster-docker-0.18.7/setup.py` & `dagster-docker-1.0.5/setup.py`
...
-    install_requires=["dagster==1.2.7", "docker", "docker-image-py"],
-    zip_safe=False,
-)
