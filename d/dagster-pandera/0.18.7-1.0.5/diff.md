# Comparing `tmp/dagster-pandera-0.18.7.tar.gz` & `tmp/dagster-pandera-1.0.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dagster-pandera-0.18.7.tar", last modified: Thu Apr 13 15:13:06 2023, max compression
+gzip compressed data, was "dagster-pandera-1.0.5.tar", last modified: Fri Aug 26 13:44:34 2022, max compression
```

## Comparing `dagster-pandera-0.18.7.tar` & `dagster-pandera-1.0.5.tar`

### file list

```diff
@@ -1,17 +1,17 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-13 15:13:06.441555 dagster-pandera-0.18.7/
--rw-r--r--   0 root         (0) root         (0)    11344 2023-04-13 15:03:07.000000 dagster-pandera-0.18.7/LICENSE
--rw-r--r--   0 root         (0) root         (0)       67 2023-04-13 15:03:07.000000 dagster-pandera-0.18.7/MANIFEST.in
--rw-r--r--   0 root         (0) root         (0)      636 2023-04-13 15:13:06.441555 dagster-pandera-0.18.7/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      131 2023-04-13 15:03:07.000000 dagster-pandera-0.18.7/README.md
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-13 15:13:06.441555 dagster-pandera-0.18.7/dagster_pandera/
--rw-r--r--   0 root         (0) root         (0)     9262 2023-04-13 15:03:07.000000 dagster-pandera-0.18.7/dagster_pandera/__init__.py
--rw-r--r--   0 root         (0) root         (0)        8 2023-04-13 15:03:07.000000 dagster-pandera-0.18.7/dagster_pandera/py.typed
--rw-r--r--   0 root         (0) root         (0)       23 2023-04-13 15:03:07.000000 dagster-pandera-0.18.7/dagster_pandera/version.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-13 15:13:06.441555 dagster-pandera-0.18.7/dagster_pandera.egg-info/
--rw-r--r--   0 root         (0) root         (0)      636 2023-04-13 15:13:06.000000 dagster-pandera-0.18.7/dagster_pandera.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      322 2023-04-13 15:13:06.000000 dagster-pandera-0.18.7/dagster_pandera.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-04-13 15:13:06.000000 dagster-pandera-0.18.7/dagster_pandera.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)       53 2023-04-13 15:13:06.000000 dagster-pandera-0.18.7/dagster_pandera.egg-info/requires.txt
--rw-r--r--   0 root         (0) root         (0)       16 2023-04-13 15:13:06.000000 dagster-pandera-0.18.7/dagster_pandera.egg-info/top_level.txt
--rw-r--r--   0 root         (0) root         (0)      150 2023-04-13 15:13:06.441555 dagster-pandera-0.18.7/setup.cfg
--rw-r--r--   0 root         (0) root         (0)     1316 2023-04-13 15:03:07.000000 dagster-pandera-0.18.7/setup.py
...
### Comparing `dagster-pandera-0.18.7/LICENSE` & `dagster-pandera-1.0.5/LICENSE`
...
### Comparing `dagster-pandera-0.18.7/PKG-INFO` & `dagster-pandera-1.0.5/PKG-INFO`
...
### Comparing `dagster-pandera-0.18.7/dagster_pandera/__init__.py` & `dagster-pandera-1.0.5/dagster_pandera/__init__.py`
...
### Comparing `dagster-pandera-0.18.7/dagster_pandera.egg-info/PKG-INFO` & `dagster-pandera-1.0.5/dagster_pandera.egg-info/PKG-INFO`
...
### Comparing `dagster-pandera-0.18.7/setup.py` & `dagster-pandera-1.0.5/setup.py`
...
-    install_requires=["dagster==1.2.7", "pandas", "pandera>=0.14.2"],
-    extras_require={
-        "test": [
-            "pytest",
