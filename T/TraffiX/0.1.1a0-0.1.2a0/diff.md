# Comparing `tmp/TraffiX-0.1.1a0.tar.gz` & `tmp/TraffiX-0.1.2a0.tar.gz`
...
## Comparing `TraffiX-0.1.1a0.tar` & `TraffiX-0.1.2a0.tar`
...
### Comparing `TraffiX-0.1.1a0/LICENSE` & `TraffiX-0.1.2a0/LICENSE`

 * *Files identical despite different names*

### Comparing `TraffiX-0.1.1a0/PKG-INFO` & `TraffiX-0.1.2a0/PKG-INFO`
...
### Comparing `TraffiX-0.1.1a0/README.md` & `TraffiX-0.1.2a0/README.md`

 * *Files identical despite different names*

### Comparing `TraffiX-0.1.1a0/TraffiX/TraffiX.egg-info/PKG-INFO` & `TraffiX-0.1.2a0/TraffiX/TraffiX.egg-info/PKG-INFO`
...
### Comparing `TraffiX-0.1.1a0/setup.py` & `TraffiX-0.1.2a0/setup.py`
